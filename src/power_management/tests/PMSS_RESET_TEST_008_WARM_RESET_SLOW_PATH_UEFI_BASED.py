...
CASE_DESC = [
    'The objective of this test case is used to WARM RESET SLOW PATH - UEFI BASED',
...
def test_steps(sut, my_os):
    ...
    Case.step('CHANGE BIOS KNOBS --> Disnable AttemptFastBoot and AttemptFastBootCold')

...
CASE_DESC = [
    "To verify the platform stability with Cold Reset flow through BMC (FAST BOOT)"
]
...
def test_steps(sut, my_os):
    ...
    for i in range(1, 3):
        ...
        sut.execute_com_cmd('ipmitool power cycle')
        Case.sleep(30)
        ...
        Case.expect('subBootMode = ColdBootFast', knob_line_in_bios_log == 'subBootMode = ColdBootFast')

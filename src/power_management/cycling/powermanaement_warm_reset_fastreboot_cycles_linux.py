...
class PowerManagementWarmResetFastReboot(ResetBaseTest):
    """
    Testcase_id : H82186-PI_Warm_Reset_Fastboot_Enabled_L
    This TestCase is Used to Perform Warm Reset for given Number of Cycles and verify is if sut is booted to Os Level
    in all the Warm reset Cycles by Enabling Bios Knob AttemptFastBoot.
    """
    BIOS_CONFIG_FILE = "fast_reboot_enabled_bios_knobs.cfg"
    TEST_CASE_ID = ["H82186", "PI_Warm_Reset_Fastboot_Enabled_L"]

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new PowerManagementWarmResetFastReboot object
        ...
        super(PowerManagementWarmResetFastReboot, self).__init__(test_log, arguments, cfg_opts, self.bios_config_file)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(PowerManagementWarmResetFastReboot, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PowerManagementWarmResetFastReboot.main() else Framework.TEST_RESULT_FAIL)

...
class PwCyclingS4OSCycles(ResetBaseTest):
    """
    HPQC ID : H82181
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(PwCyclingS4OSCycles, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(PwCyclingS4OSCycles, self).prepare()
    ...
    def execute(self):
        ...
        for cycle_number in range(1, warm_reset_cycles + 1):
            ...
            with ProviderFactory.create(self.cng_cfg, self._log) as self.cng_log:
                ...
                cycle_status = self.perform_s4_cycle()
                end_time = time.time()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PwCyclingS4OSCycles.main()

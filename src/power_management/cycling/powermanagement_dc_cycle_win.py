...
class PowerManagementDcCyclesWin(ResetBaseTest):
    """
    Testcase_id : H65956
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new PowerManagementDcCyclesWin object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(PowerManagementDcCyclesWin, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(PowerManagementDcCyclesWin, self).prepare()
    ...
    def execute(self):
        ...
        self._log.info("Sut is booted back to OS in all the '{}' DC Cycles and there are no Machine Check "
                       "Errors Logged".format(self._common_content_configuration.get_num_of_dc_cycles()))
        return True


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PowerManagementDcCyclesWin.main() else Framework.TEST_RESULT_FAIL)

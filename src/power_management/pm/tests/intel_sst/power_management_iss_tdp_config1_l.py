...
class PowermanagementISSTDPConfig1(IntelSSTCommon):
    """
    This test case is used for Intel speed select feature validation with TDP Config1.
    HPALM ID : H81632
    """
    TEST_CASE_ID = ["H81632", "PI_Powermanagement_ISS_TDP_Config1_L"]
    REGEX_SST_PP = r"Intel.*SST-PP.*is\ssupported"
    TDP_CONFIG = IntelSSTConfig.Config1
    TDP_LEVEL = '3'
    _BIOS_CONFIG_FILE = "power_management_iss_tdp_config1.cfg"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PowermanagementISSTDPConfig1, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(PowermanagementISSTDPConfig1, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PowermanagementISSTDPConfig1, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PowermanagementISSTDPConfig1.main() else Framework.TEST_RESULT_FAIL)

...
class RasStressTestMemorycorrectableErrorInjectionDlbWorkload(HqmBaseTest, QatBaseTest):

    ACC_CONFIG_FILE = "../accelerator_config.cfg"
    WHEA_CONFIG_FILE = "../whea_error_injection_config.cfg"

    TEST_CASE_ID = ["16013106490-Ras_Stress_Test_Memory_correctable_Error_Injection_Dlb_Workload"]
    ...
    step_data_dict = {1: {'step_details': 'Boot the SUT and enable the WHEA Error Injection Support in Bios option.',
                      ...
                      4: {'step_details': 'Run fisher tool for injecting Memory Correctable error with DLB workload.',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(RasStressTestMemorycorrectableErrorInjectionDlbWorkload, self).__init__(test_log, arguments, cfg_opts, self.BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        super(RasStressTestMemorycorrectableErrorInjectionDlbWorkload, self).prepare()
    ...
    def execute(self):
        ...
        self._accelerator_lib.run_fisher_tool_on_host(type_of_error="correctable", workload="DLB")
    ...
    def cleanup(self, return_status):
        ...
        super(RasStressTestMemorycorrectableErrorInjectionDlbWorkload, self).cleanup(return_status)

if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if RasStressTestMemorycorrectableErrorInjectionDlbWorkload.main() else Framework.TEST_RESULT_FAIL)
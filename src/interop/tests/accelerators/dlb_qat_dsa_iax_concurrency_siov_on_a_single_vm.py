...
class DlbQatDsaIaxConcurrencySiovOnASingleVm(HqmBaseTest, QatBaseTest):  # Modify
    NUMBER_OF_VMS = 1
    VM = [VMs.CENTOS] * 1
    ...
    TEST_CASE_ID = ["16014303383-DLB+QAT+DSA+IAX  Concurrency - SIOV on a single VM"]  # Modify
    ...
    STEP_DATA_DICT = {1: {'step_details': 'Set the BIOS knobs',
                      ...
                      5: {'step_details': 'Launch single VMs with QAT,DLB,DSA,IAX Mdevs',
                          'expected_results': 'Launched single VMs with QAT,DLB,DSA,IAX Mdevs'},
                      6: {'step_details': 'Launch a VM with all 4 MDEV devices of QAT, DLB, DSA and IAX accelerators and run workloads for 2 hours',
                          'expected_results': 'Launched VM with all 4 MDEV devices of QAT, DLB, DSA and IAX accelerators and run workload for 2 hours'}
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(DlbQatDsaIaxConcurrencySiovOnASingleVm, self).__init__(test_log, arguments, cfg_opts,
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(DlbQatDsaIaxConcurrencySiovOnASingleVm, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if DlbQatDsaIaxConcurrencySiovOnASingleVm.main() else Framework.TEST_RESULT_FAIL)

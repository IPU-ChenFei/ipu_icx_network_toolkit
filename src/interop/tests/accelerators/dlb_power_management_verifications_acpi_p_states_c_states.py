...
class DlbPowerManagementVerificationsAcpiPstatesCstatesL(HqmBaseTest, QatBaseTest):
    
    ACC_CONFIG_FILE = "../accelerator_config.cfg"

    INTEL_IOMMU_ON_STR = "intel_iommu=on,sm_on iommu=on"

    TEST_CASE_ID = ["16013140986-DLB_Power_Management_Verifications_of_ACPI_P_States_C_States_CentOS"]
    ...
    step_data_dict = {1: {'step_details': 'Enable VT-d & C State Control Support in Bios option. Boot to OS',
                      ...
                      6: {'step_details': 'Run Dlb workload',
                          'expected_results': 'Dlb workload executed succesfully'},
                      ...
                      10: {'step_details': 'C state with Dlb workload Interrupt',
                          'expected_results': 'Dlb workload stopped proccessing successfully.'},
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(DlbPowerManagementVerificationsAcpiPstatesCstatesL, self).__init__(test_log, arguments, cfg_opts,
                                                                              self.acc_bios_knobs)
    ...
    def prepare(self):
        ...
        super(DlbPowerManagementVerificationsAcpiPstatesCstatesL, self).prepare()
    ...
    def execute(self):
        ...
        self._accelerator_lib.run_workload_with_interrupt_on_host(workload='DLB')
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if DlbPowerManagementVerificationsAcpiPstatesCstatesL.main() else Framework.TEST_RESULT_FAIL)
...
class RasStressTestMemoryCorrectableErrorInjectionQatWorkload(HqmBaseTest, QatBaseTest):
    
    ACC_CONFIG_FILE = "../accelerator_config.cfg"
    WHEA_CONFIG_FILE = "../whea_error_injection_config.cfg"

    TEST_CASE_ID = ["16013106539-RAS_Stress_Test_Memory_Correctable_Error_Injection_with_QAT_Workload"]
    ...
    step_data_dict = {1: {'step_details': 'Boot the SUT, enable the WHEA Error Injection Support in Bios option & disable VT-d',
                      ...
                      3: {'step_details': 'Run fisher tool for injecting Memory correctable error with QAT workload.',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(RasStressTestMemoryCorrectableErrorInjectionQatWorkload, self).__init__(test_log, arguments, cfg_opts, self.BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        super(RasStressTestMemoryCorrectableErrorInjectionQatWorkload, self).prepare()
    ...
    def execute(self):
        ...
        self._log.info("Run fisher tool for injecting Memory correctable error with QAT workload.")
        self._test_content_logger.start_step_logger(3)
        self._accelerator_lib.run_fisher_tool_on_host(type_of_error="correctable", workload = "QAT")
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if RasStressTestMemoryCorrectableErrorInjectionQatWorkload.main() else Framework.TEST_RESULT_FAIL)
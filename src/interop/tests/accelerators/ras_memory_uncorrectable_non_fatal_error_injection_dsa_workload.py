...
class RasMemoryUncorrectableNonFatalErrorInjectionDsaWorkload(HqmBaseTest, QatBaseTest):
    ...
    TEST_CASE_ID = ["16014266880-RAS_Memory_Uncorrectable_Non_Fatal_Error_Injection_with_DSA_Workload"]
    ...
    step_data_dict = {1: {'step_details': 'Enable VT-d & WHEA Error Injection Support in Bios option. Boot to OS',
                      ...
                      4: {'step_details': 'Run fisher tool for injecting Memory uncorrectable non-fatal error with DSA workload.',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(RasMemoryUncorrectableNonFatalErrorInjectionDsaWorkload, self).__init__(test_log, arguments, cfg_opts, self.BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        super(RasMemoryUncorrectableNonFatalErrorInjectionDsaWorkload, self).prepare()
    ...
    def execute(self):
        ...
        self._accelerator_lib.run_fisher_tool_on_host(type_of_error="uncorrectable", workload = "DSA")
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if RasMemoryUncorrectableNonFatalErrorInjectionDsaWorkload.main() else Framework.TEST_RESULT_FAIL)
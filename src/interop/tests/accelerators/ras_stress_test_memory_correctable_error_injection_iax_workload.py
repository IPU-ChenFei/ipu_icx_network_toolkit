...
class RasStressTestMemoryCorrectableErrorInjectionIaxWorkload(HqmBaseTest, QatBaseTest):
    ...
    TEST_CASE_ID = ["16014266919-RAS_Stress_Test_Memory_Correctable_Error_Injection_with_DSA_Workload"]
    ...
    step_data_dict = {1: {'step_details': 'Enable VT-d & WHEA Error Injection Support in Bios option. Boot to OS',
                      ...
                      4: {'step_details': 'Run fisher tool for injecting Memory Correctable error with IAX workload.',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(RasStressTestMemoryCorrectableErrorInjectionIaxWorkload, self).__init__(test_log, arguments, cfg_opts, self.BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        super(RasStressTestMemoryCorrectableErrorInjectionIaxWorkload, self).prepare()
    ...
    def execute(self):
        ...
        self._accelerator_lib.run_fisher_tool_on_host(type_of_error="correctable", workload = "IAX")
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if RasStressTestMemoryCorrectableErrorInjectionIaxWorkload.main() else Framework.TEST_RESULT_FAIL)
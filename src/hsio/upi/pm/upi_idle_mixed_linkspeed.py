...
class UpiIdleMixedSpeed(HsioUpiCommon):
    """
    hsdes id:  https://hsdes.intel.com/appstore/article/#/22014658367
    This test modifies BIOS to enable L0p and mixed link speeds
    Checks linkwidth,port status, mixed link speed and any errors
    """
    _BIOS_CONFIG_FILE = "upi_idle_mixed_linkspeed_"

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiIdleMixedSpeed object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiIdleMixedSpeed, self).__init__(
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiIdleMixedSpeed, self).prepare()

    def execute(self):

        return self.run_upi_idling_test(self._upi_checks.MIXED_LINK_SPEED)


if __name__ == "__main__":

    sys.exit(Framework.TEST_RESULT_PASS if UpiIdleMixedSpeed.main()

...
class UpiMixedLinkSpeedStressapp(HsioUpiCommon):
    """
    hsdes id: 1509139289 upi_non_ras_mixed_link_speed_stressapptest
    This test modifies BIOS to ensure mixed link speeds are set and
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiMixedLinkSpeedStressapp object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiMixedLinkSpeedStressapp, self).__init__(
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiMixedLinkSpeedStressapp, self).prepare()

    def execute(self):

        return self.run_upi_stressapp_test(self._upi_checks.MIXED_LINK_SPEED)


if __name__ == "__main__":

    sys.exit(Framework.TEST_RESULT_PASS if UpiMixedLinkSpeedStressapp.main()

...
class UpiMaxLinkSpeedMeshRandom(HsioUpiCommon):
    """
    hsdes id: 1509676906 upi_non_ras_max_linkspeed_random_ss_mlc
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiMaxLinkSpeedMeshRandom object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiMaxLinkSpeedMeshRandom, self).__init__(
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiMaxLinkSpeedMeshRandom, self).prepare()

    def execute(self):

        return self.run_upi_mesh_stress_test(self._upi_checks.MAX_LINK_SPEED, self.MESH_TEST_RANDOM)


if __name__ == "__main__":

    sys.exit(Framework.TEST_RESULT_PASS if UpiMaxLinkSpeedMeshRandom.main()

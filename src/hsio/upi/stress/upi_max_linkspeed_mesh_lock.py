...
class UpiMaxLinkSpeedMeshLock(HsioUpiCommon):
    """
    hsdes id: 1509676896 upi_non_ras_max_linkspeed_lock_ss_mlc
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiMaxLinkSpeedMeshLock object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiMaxLinkSpeedMeshLock, self).__init__(
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiMaxLinkSpeedMeshLock, self).prepare()

    def execute(self):

        return self.run_upi_mesh_stress_test(self._upi_checks.MAX_LINK_SPEED, self.MESH_TEST_LOCK)


if __name__ == "__main__":

    sys.exit(Framework.TEST_RESULT_PASS if UpiMaxLinkSpeedMeshLock.main()

...
class UpiMaxLinkspeedWithSpecCpu(HsioUpiCommon):
    """
    hsdes_id :  14014516860 upi_max_linkspeed with spec-cpu load
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiMaxLinkspeedWithSpecCpu object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiMaxLinkspeedWithSpecCpu, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        """
        try:
            super(UpiMaxLinkspeedWithSpecCpu, self).prepare()
        except:
    ...
    def execute(self):
        ...
        return self.verify_upi_with_spec_cpu(test_type=self._upi_checks.MAX_LINK_SPEED)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if UpiMaxLinkspeedWithSpecCpu.main() else Framework.TEST_RESULT_FAIL)

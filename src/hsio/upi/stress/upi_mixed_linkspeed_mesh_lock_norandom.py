...
class UpiMixedLinkSpeedMeshLockNorandom(HsioUpiCommon):
    """
    hsdes id: 1509679374 upi_non_ras_mixed_link_speed_lock_ss_mlc_noramdom
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiMixedLinkSpeedMeshLockNorandom object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiMixedLinkSpeedMeshLockNorandom, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiMixedLinkSpeedMeshLockNorandom, self).prepare()

    def execute(self):

        return self.run_upi_mesh_stress_test(self._upi_checks.MIXED_LINK_SPEED, self.MESH_TEST_LOCK_NORANDOM)


if __name__ == "__main__":

    sys.exit(Framework.TEST_RESULT_PASS if UpiMixedLinkSpeedMeshLockNorandom.main()

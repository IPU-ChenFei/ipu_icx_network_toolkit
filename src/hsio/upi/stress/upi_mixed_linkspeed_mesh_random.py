...
class UpiMixedLinkSpeedMeshRandom(HsioUpiCommon):
    """
    hsdes id: 1509679393 upi_non_ras_mixed_link_speed_random_ss_mlc
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiMixedLinkSpeedMeshRandom object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiMixedLinkSpeedMeshRandom, self).__init__(
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiMixedLinkSpeedMeshRandom, self).prepare()

    def execute(self):

        return self.run_upi_mesh_stress_test(self._upi_checks.MIXED_LINK_SPEED, self.MESH_TEST_RANDOM)


if __name__ == "__main__":

    sys.exit(Framework.TEST_RESULT_PASS if UpiMixedLinkSpeedMeshRandom.main()

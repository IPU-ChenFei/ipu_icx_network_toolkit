...
class UpiMixedLinkSpeedMeshSpecialCycles(HsioUpiCommon):
    """
    hsdes id: 1509679376 upi_non_ras_mixed_link_speed_special_cycles_ss_mlc
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiMixedLinkSpeedMeshSpecialCycles object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiMixedLinkSpeedMeshSpecialCycles, self).__init__(
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiMixedLinkSpeedMeshSpecialCycles, self).prepare()

    def execute(self):

        return self.run_upi_mesh_stress_test(self._upi_checks.MIXED_LINK_SPEED, self.MESH_TEST_SPECIAL_CYCLES)


if __name__ == "__main__":

    sys.exit(Framework.TEST_RESULT_PASS if UpiMixedLinkSpeedMeshSpecialCycles.main()

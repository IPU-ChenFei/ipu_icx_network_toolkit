...
class UpiTopologyWithSpecCpu(HsioUpiCommon):
    """
    hsdes_id :  22013653961 upi_topology with spec CPU

    This test verifies upi topology shows expected output during load
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiTopologyWithSpecCpu object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiTopologyWithSpecCpu, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        """
        try:
            super(UpiTopologyWithSpecCpu, self).prepare()
        except:
    ...
    def execute(self):
        """
        This method is used to execute verify_upi_topology_with_spec_cpu
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if UpiTopologyWithSpecCpu.main() else Framework.TEST_RESULT_FAIL)

...
class UpiMinLinkspeedWithMLCLoad(HsioUpiCommon):
    """
    hsdes_id :  22012953562 upi_min_linkspeed with mlc load
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiMinLinkspeedWithMLCLoad object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiMinLinkspeedWithMLCLoad, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        """
        try:
            super(UpiMinLinkspeedWithMLCLoad, self).prepare()
        except:
    ...
    def execute(self):
        ...
        return self.verify_upi_with_mlc(test_type=self._upi_checks.MIN_LINK_SPEED)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if UpiMinLinkspeedWithMLCLoad.main() else Framework.TEST_RESULT_FAIL)

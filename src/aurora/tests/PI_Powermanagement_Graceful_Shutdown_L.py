...
CASE_DESC = [
    'https://hsdes.intel.com/appstore/article/#/18014074949',
    'Verify the SUT can recover from an extended period of time',
    'in low-power mode back to normal operating mode in a Linux environment',
]

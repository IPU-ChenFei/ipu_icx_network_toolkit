...
class StorageM2NvmeOSInstallCentOS(BaseTestCase):
    """
    Glasgow : EGS_PV_1295-M.2 NVME OS installation.
    Pheonix Id : 16013598635-M.2 NVME OS installation(CentOS).

    Install CENTOS OS on M.2 NVME
    """
    TEST_CASE_ID = ["EGS_PV_1295", "P16013598635", "M.2 NVME OS installation(CentOS)"]
    NVME_SSD_NAME_CENTOS = "nvme_ssd_name_centos"

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new StorageM2NvmeOSInstallCentOS object
        ...
        super(StorageM2NvmeOSInstallCentOS, self).__init__(test_log, arguments, cfg_opts)
    ...
    def add_arguments(cls, parser):
        super(StorageM2NvmeOSInstallCentOS, cls).add_arguments(parser)
        # Use add_argument
    ...
    def cleanup(self, return_status):
        ...
        super(StorageM2NvmeOSInstallCentOS, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageM2NvmeOSInstallCentOS.main() else Framework.TEST_RESULT_FAIL)

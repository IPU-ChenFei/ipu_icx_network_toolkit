...
class SataU2M2EfiShellWarmReset(TxtBaseTest):
    """  Phoenix ID : 1509355093 SATA- U.2 and M.2 EFI shell reset(warm)

    This Testcase aims at Efi shell warm reset on U.2 Nvme
    """
    TEST_CASE_ID = ["1509355093", "SATA- U.2 and M.2 EFI shell reset(warm)"]
    ROOT_DIR = "/root"
    WAIT_TIME = 60
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new SataU2M2EfiShellWarmReset object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(SataU2M2EfiShellWarmReset, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        :return None
        """
        super(SataU2M2EfiShellWarmReset, self).prepare()
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        ...
        try:
            ...
            raise ex
        super(SataU2M2EfiShellWarmReset, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SataU2M2EfiShellWarmReset.main() else Framework.TEST_RESULT_FAIL)

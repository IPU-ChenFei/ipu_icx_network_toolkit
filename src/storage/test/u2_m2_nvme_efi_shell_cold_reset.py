...
class SataU2M2EfiShellColdReset(TxtBaseTest):
    """  Phoenix ID : 16013783811 SATA- U.2 and M.2 EFI shell reset(cold)

    This Testcase aims at Efi shell cold reset on U.2 Nvme
    """
    TEST_CASE_ID = ["16013783811", "SATA- U.2 and M.2 EFI shell reset(cold)"]
    ROOT_DIR = "/root"
    WAIT_TIME = 60
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new SataU2M2EfiShellColdReset object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(SataU2M2EfiShellColdReset, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        :return None
        """
        super(SataU2M2EfiShellColdReset, self).prepare()

    def execute(self):
        """
        This method functionality is to execute EFI shell cold reset( reset -c) to
        be triggered on SATA U2 and M2 SSDs.
        ...
        self._storage_common.verify_disks_in_sut_and_host(check="sata")
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        ...
        try:
            ...
            raise ex
        super(SataU2M2EfiShellColdReset, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SataU2M2EfiShellColdReset.main() else Framework.TEST_RESULT_FAIL)

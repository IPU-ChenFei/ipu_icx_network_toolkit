...
class M2SATAStabilityAndStressFIO(StorageCommon):
    """
    Glasgow : G44055-EGS_PV_1846-M-2-SATA-Stability and Stress- FIO
    This test case functionality is to install, execute fio tool on m.2 sata ssd and verify bandwidth
    """
    TEST_CASE_ID = ["G44055", 'EGS_PV_1846', "M_2_SATA_Stability_and_Stress_FIO"]
    FIO_TOOL_CMD = "fio -name=randomlinux --rw={} --bs=64k --iodepth=4 --runtime={} " \
    ...
    step_data_dict = {
        1: {'step_details': 'Verify M.2 SATA is connected or not',
            'expected_results': 'Successfully verified that M.2 is connected'},
        2: {'step_details': 'Install and execute fio tool for required time',
            'expected_results': 'Successfully installed and executed fio tool'},
        3: {'step_details': 'Verify bandwidth speed limit',
    ...
    def execute(self):
        ...
        # Checking M.2 SATA connected or not.

...
class StorageNvmeM2PcieCScriptsItpT4Gen3TxEqRedoLinux(ContentBaseTestCase):
    """
    Glasgow ID : G56608-NVMe_M.NVMe_M.2_PCIe_CScripts_ITP_T4_Gen3 TxEq Retrain
    The purpose of this Test Case is to verify the functionality of all supported M.2 nvme link state transition
    for a specific adapter in M.2 slot of the system.
    """
    TEST_CASE_ID = ["G56608", "NVMe_M.NVMe_M.2_PCIe_CScripts_ITP_T4_Gen3 TxEq Retrain"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a StorageNvmeM2PcieCScrStorageNvmeM2PcieCScriptsItpT4Gen3TxEqRedoLinux object
        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(StorageNvmeM2PcieCScriptsItpT4Gen3TxEqRedoLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(StorageNvmeM2PcieCScriptsItpT4Gen3TxEqRedoLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(StorageNvmeM2PcieCScriptsItpT4Gen3TxEqRedoLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageNvmeM2PcieCScriptsItpT4Gen3TxEqRedoLinux.main() else Framework.TEST_RESULT_FAIL)

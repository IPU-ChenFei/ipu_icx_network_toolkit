...
class StorageNvmeM2PcieCScriptsItpSpeedChangeRetainLinux(ContentBaseTestCase):
    """
    Glasgow ID : G56609-NVMe_M.2_PCIe_CScripts_ITP_T5_Speed Change Retrain /
                 G56610-NVMe_M.2_PCIe_CScripts_ITP_T6_Speed Change Retrain
    ...
    """
    TEST_CASE_ID = ["G56609", "NVMe_M.2_PCIe_CScripts_ITP_T5_Speed Change Retrain",
                    "G56610", "NVMe_M.2_PCIe_CScripts_ITP_T6_Speed Change Retrain"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a StorageNvmeM2PcieCscriptsItpSpeedChangeRetainLinux object
        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(StorageNvmeM2PcieCScriptsItpSpeedChangeRetainLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(StorageNvmeM2PcieCScriptsItpSpeedChangeRetainLinux, self).prepare()
    ...
    def execute(self):
        ...
        for bdf_value in device_details.keys():
            self._pcie_ltssm_provider.run_ltssm_tool_var_speed_grades(test_name=self.LTSSM_TEST_NAME,
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(StorageNvmeM2PcieCScriptsItpSpeedChangeRetainLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageNvmeM2PcieCScriptsItpSpeedChangeRetainLinux.main() else Framework.TEST_RESULT_FAIL)

...
class StorageNvmeU2PcieCScriptsItpBasicRetainLinux(ContentBaseTestCase):
    """
    Glasgow ID : G56504-NVMe_U.2_Direct Connect_CScripts_ITP_T1_Basic Link Retrain
    ...
    TEST_CASE_ID = ["G56504", "NVMe_U.2_Direct Connect_CScripts_ITP_T1_Basic Link Retrain"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a StorageNvmeU2PcieCScriptsItpBasicRetainLinux object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """

        super(StorageNvmeU2PcieCScriptsItpBasicRetainLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(StorageNvmeU2PcieCScriptsItpBasicRetainLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(StorageNvmeU2PcieCScriptsItpBasicRetainLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageNvmeU2PcieCScriptsItpBasicRetainLinux.main() else Framework.TEST_RESULT_FAIL)

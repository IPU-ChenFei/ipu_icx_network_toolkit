...
class StorageNvmeItpT2LinkEnableDisableLinux(ContentBaseTestCase):
    """
    Glasgow ID : G56859-NVMe_U.2_Direct Connect_CScripts_ITP_T2_Link Enabled - Disabled
    ...
    TEST_CASE_ID = ["G56859", "NVMe_U.2_Direct Connect_CScripts_ITP_T2_Link Enabled - Disabled"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a StorageNvmeItpT2LinkEnableDisableLinux object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """

        super(StorageNvmeItpT2LinkEnableDisableLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(StorageNvmeItpT2LinkEnableDisableLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(StorageNvmeItpT2LinkEnableDisableLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageNvmeItpT2LinkEnableDisableLinux.main() else Framework.TEST_RESULT_FAIL)

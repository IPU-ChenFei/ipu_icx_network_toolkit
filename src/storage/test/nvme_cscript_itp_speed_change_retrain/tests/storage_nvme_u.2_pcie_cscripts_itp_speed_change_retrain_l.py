...
class StorageNvmeU2PcieCScriptsItpSpeedChangeRetainLinux(ContentBaseTestCase):
    """
    Glasgow ID : G56862-NVMe_U.2_Direct Connect_CScripts_ITP_T5_Speed Change Retrain /
                 G56863-NVMe_U.2_Direct Connect_CScripts_ITP_T6_Speed Change Retrain
    ...
    TEST_CASE_ID = ["G56862", "NVMe_U.2_Direct Connect_CScripts_ITP_T5_Speed Change Retrain",
                    "G56863", "NVMe_U.2_Direct Connect_CScripts_ITP_T6_Speed Change Retrain"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a StorageNvmeU2PcieCScriptsItpSpeedChangeRetainLinux object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """

        super(StorageNvmeU2PcieCScriptsItpSpeedChangeRetainLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(StorageNvmeU2PcieCScriptsItpSpeedChangeRetainLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(StorageNvmeU2PcieCScriptsItpSpeedChangeRetainLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageNvmeU2PcieCScriptsItpSpeedChangeRetainLinux.main() else Framework.TEST_RESULT_FAIL)

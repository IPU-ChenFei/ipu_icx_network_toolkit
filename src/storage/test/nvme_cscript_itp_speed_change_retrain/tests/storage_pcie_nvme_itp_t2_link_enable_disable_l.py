...
class StorageNvmeItpT2LinkDisableLinux(ContentBaseTestCase):
    """
    GLASGOW ID : G56624, NVMe_HHHL_PCIe_CScripts_ITP_T2_Link Enabled - Disabled
    ...
    TEST_CASE_ID = ["G56624", "NVMe_HHHL_PCIe_CScripts_ITP_T2_Link Enabled - Disabled"]
    ...
    step_data_dict = {
        ...
        3: {'step_details': 'Check NVME device Link speed Width Retrain the tool and run the Ltssm tool '
                            'on OS and PythonSV',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a StorageNvmeItpT2LinkDisableLinux object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """

        super(StorageNvmeItpT2LinkDisableLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(StorageNvmeItpT2LinkDisableLinux, self).prepare()
        ...
        for each_slot in slot_list:
            ...
            for bdf_value in device_details.keys():
                ...
                if sut_socket is None and csp_path is None:
                    ...
                    continue
                cmd_output = self.SV.get_ltssm_object().runLinkDisable(
    ...
    def cleanup(self, return_status):
        ...
        super(StorageNvmeItpT2LinkDisableLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageNvmeItpT2LinkDisableLinux.main() else Framework.TEST_RESULT_FAIL)

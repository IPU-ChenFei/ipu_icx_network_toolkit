...
class StorageNvmeM2PcieCScriptsItpT1BasicLinkRetainLinux(ContentBaseTestCase):
    """
    Glasgow ID : G56605-NVMe_M.2_PCIe_CScripts_ITP_T1_Basic Link Retrain
    ...
    """
    TEST_CASE_ID = ["G56605", "NVMe_M.2_PCIe_CScripts_ITP_T1_Basic Link Retrain"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a StorageNvmeM2PcieCScriptsItpT1BasicLinkRetainLinux object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(StorageNvmeM2PcieCScriptsItpT1BasicLinkRetainLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(StorageNvmeM2PcieCScriptsItpT1BasicLinkRetainLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(StorageNvmeM2PcieCScriptsItpT1BasicLinkRetainLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageNvmeM2PcieCScriptsItpT1BasicLinkRetainLinux.main() else Framework.TEST_RESULT_FAIL)

...
class StorageNvmeItpT3D3HotLinux(ContentBaseTestCase):
    """
    GLASGOW ID : G56625, NVMe_HHHL_PCIe_CScripts_ITP_T3_D3hot (PML1)
    ...
    TEST_CASE_ID = ["G56625", "NVMe_HHHL_PCIe_CScripts_ITP_T3_D3hot (PML1)"]
    LTSSM_TEST_NAME = "pmL1"
    step_data_dict = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a StorageNvmeItpT3D3HotLinux object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(StorageNvmeItpT3D3HotLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(StorageNvmeItpT3D3HotLinux, self).prepare()
        ...
        for each_slot in slot_list:
            ...
            for bdf_value in device_details.keys():
                ...
                if sut_socket is None and csp_path is None:
                    ...
                    continue
                cmd_output = self.SV.get_ltssm_object().runPML1(
    ...
    def cleanup(self, return_status):
        ...
        super(StorageNvmeItpT3D3HotLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageNvmeItpT3D3HotLinux.main() else Framework.TEST_RESULT_FAIL)

...
class StorageIOStressNVMeLinux(ContentBaseTestCase):
    """
    HPQC : H82248-PI_Storage_StressIO_NVMe_L
    ...
    """
    TEST_CASE_ID = ["H82248", "PI_Storage_StressIO_NVMe_L"]
    CMD_FDISK = 'fdisk -l'
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new StorageIOStressNVMeLinux object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(StorageIOStressNVMeLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        """
        super(StorageIOStressNVMeLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        """
        super(StorageIOStressNVMeLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StorageIOStressNVMeLinux.main() else Framework.TEST_RESULT_FAIL)

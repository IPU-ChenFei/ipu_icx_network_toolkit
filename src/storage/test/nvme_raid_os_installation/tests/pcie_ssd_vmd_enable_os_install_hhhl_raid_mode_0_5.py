...
class PcieNVMeOSInstallationRAIDMode(ContentBaseTestCase):
    """
    PHOENIX id : 16013545200 - PCieSSD-VMD enable - OS Install to HHHL in VMD enable with raid Mode(0 and 5) and NVME driver installation check(use Samsung and Intel)

    This class used for creating RAID0, RAID5
    Install RHEL OS on RAID and delete RAID.
    """

    TEST_CASE_ID = ["16013545200", "PCieSSD-VMD enable - OS Install to HHHL in VMD enable with raid Mode(0 and 5) and NVME driver installation check(use Samsung and Intel)"]
    step_data_dict = {
                        1: {'step_details': 'Enable the VMD knobs according to PCIe slot settings',
                            'expected_results': 'Successfully enabled the VMD knobs'},
                        2: {'step_details': 'create the RAID0/RAID5 using two NVME Drives',
                            'expected_results': 'RAID0/RAID5 Creation is successful'},
                        3: {'step_details': 'Install RHEL OS on RAID0/RAID1 and boot to  OS',
                            'expected_results': 'Successfully installed OS in RAID0/RAID5'},
                        4: {'step_details': 'Verify OS is successfully installed in created RAID0/RAID5',
                            'expected_results': 'Verified OS installation is successful in RAID0/RAID5'},
                        5: {'step_details': 'delete RAID0/RAID5 Volume',
                            'expected_results': 'Successfully deleted RAID0/RAID5 Volume'}
                      }

    def __init__(self, test_log, arguments, cfg_opts):
        """
         Creates a new PcieNVMeOSInstallationRAIDMode object
        ...
        super(PcieNVMeOSInstallationRAIDMode, self).__init__(test_log, arguments, cfg_opts)
    ...
    def cleanup(self, return_status):
        ...
        super(PcieNVMeOSInstallationRAIDMode, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieNVMeOSInstallationRAIDMode.main() else Framework.TEST_RESULT_FAIL)
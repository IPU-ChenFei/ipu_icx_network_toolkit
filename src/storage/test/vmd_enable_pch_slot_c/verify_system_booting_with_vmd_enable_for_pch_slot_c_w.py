...
class VerifyVMDEnableForPchSlotC(ContentBaseTestCase):
    """
    Phoenix ID : 16013562029 -Verify system booting with VMD enable for PCH(Slot C)( Windows)
    ...
    """
    BIOS_CONFIG_FILE = "verify_system_booting_with_vmd_enable_for_pch_slot_c_w.cfg"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VerifyVMDEnableForPchSlotC, self).__init__(test_log, arguments, cfg_opts, self.bios_config_file)
    ...
    def prepare(self):
        ...
        :return None
        """
        super(VerifyVMDEnableForPchSlotC, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VerifyVMDEnableForPchSlotC.main() else Framework.TEST_RESULT_FAIL)

...
class StorageBootingToNvme(BaseTestCase):
    """
    PHEONIX ID : 16013539208 - PCieSSD-VMD Disable - OS Install to PCie NvMe in VMD disable Mode and NVME driver installation check (RHEL)
    """
    TEST_CASE_ID = ["16013539208",
                    "PI_Storage_Booting_To_PCIe_NVMe_UL",
    ...
    def execute(self):
        ...
        self._log.info("make any of the pcie nvme as the first  boot device")

...
class U2NvmeEfiShellWarmReset(TxtBaseTest):
    """  Phoenix ID : 16013539880 U.2 NVMe-EFI shell reset(Warm)

    This Testcase aims at Efi shell Warm reset on U.2 Nvme
    """
    TEST_CASE_ID = ["16013539880", "U.2 NVMe-EFI shell reset(Warm)"]
    ROOT_DIR = "/root"
    WAIT_TIME = 60
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new U2NvmeEfiShellWarmReset object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(U2NvmeEfiShellWarmReset, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        :return None
        """
        super(U2NvmeEfiShellWarmReset, self).prepare()
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        ...
        try:
            ...
            raise ex
        super(U2NvmeEfiShellWarmReset, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if U2NvmeEfiShellWarmReset.main() else Framework.TEST_RESULT_FAIL)

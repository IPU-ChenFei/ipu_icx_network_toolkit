...
class PcieNvmeEfiShellColdReset(TxtBaseTest):
    """  Phoenix ID : 16013537024 Pcie Nvme - EFI shell reset(cold)
		              16013537157 Pcie Nvme - EFI shell reset(cold)

    This Testcase aims at Efi shell cold reset on U.2 Nvme
    """
    TEST_CASE_ID = ["16013537024", "Pcie Nvme - EFI shell reset(cold)", "16013537157"]
    ROOT_DIR = "/root"
    WAIT_TIME = 60
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new PcieNvmeEfiShellColdReset object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(PcieNvmeEfiShellColdReset, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        :return None
        """
        super(PcieNvmeEfiShellColdReset, self).prepare()
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        ...
        try:
            ...
            raise ex
        super(PcieNvmeEfiShellColdReset, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieNvmeEfiShellColdReset.main() else Framework.TEST_RESULT_FAIL)

...
CASE_DESC = [
    'This testcase is to verify create data volume RAID10 in Win OS.',
...
def test_steps(sut, my_os):
    ...
    Case.step('create data volume RAID10')
    create_raid_cmd = rf'intelvroccli.exe -C -l 10 -n TestRAID10 --span {last_id_list[0]} {last_id_list[1]} {last_id_list[2]} {last_id_list[3]} -s 128 -z 120'
    ...
    try:
        ...
        Case.expect('create RAID10 success', ret_code == 0 and 'TestRAID10' in stdout2)
    except Exception as e:
        logger.info(e)
        logger.info(stderr[0])
        raise ValueError('create RAID10 fail')

    finally:
        Case.step('remove RAID volume')
        delete_raid_cmd = r'intelvroccli.exe -M -D TestRAID10'

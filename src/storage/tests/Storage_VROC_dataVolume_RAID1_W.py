...
CASE_DESC = [
    'This testcase is to verify create data volume RAID1 in Win OS.',
...
def test_steps(sut, my_os):
    ...
    create_raid_cmd = rf'intelvroccli.exe -C -l 1 -n TestRAID1 --span {last_id_list[0]} {last_id_list[1]} -z 120'
    ...
    try:
        ...
        Case.expect('create RAID1 success', ret_code == 0 and 'TestRAID1' in stdout2)
    except Exception as e:
        logger.info(e)
        logger.info(stderr[0])
        raise ValueError('create RAID1 fail')

    finally:
        Case.step('remove RAID volume')
        delete_raid_cmd = r'intelvroccli.exe -M -D TestRAID1'

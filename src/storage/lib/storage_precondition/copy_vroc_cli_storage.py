...
def test_steps(sut, sutos):
    ...
    tools.get('vroc_cli_storage').uncompress_to(method='zip')
    cmd = f'copy IntelVROCCli.exe {tools.vroc_cli_storage.ipath}'
    folder_name = tools.get("vroc_cli_storage").filename.rstrip('.zip')

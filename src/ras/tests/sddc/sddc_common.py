...
class SddcCommon(BaseTestCase):
    """
    Glasgow_id : 63036 and 61109
    Common base class for SDDC enable and functional test cases
    """

    BIOS_CONFIG_FILE = "sddc_bios_knobs.cfg"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(SddcCommon, self).__init__(test_log, arguments, cfg_opts)

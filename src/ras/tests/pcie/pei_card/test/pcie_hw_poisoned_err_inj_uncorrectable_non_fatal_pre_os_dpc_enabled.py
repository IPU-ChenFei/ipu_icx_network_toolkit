...
class PcieHwPoisonedErrInjUncorrectableNonFatalPreOsDpcEnabled(PcieHWLeakyBucketBaseTest):
    """
    ...
    def __init__(self, test_log, arguments, cfg_opts, bios_config_file=None):
        """
        Creates a new PcieHwPoisonedErrInjUncorrectableNonFatalPreOsDpcEnabled object
        ...
        """
        try:
            super(PcieHwPoisonedErrInjUncorrectableNonFatalPreOsDpcEnabled, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(PcieHwPoisonedErrInjUncorrectableNonFatalPreOsDpcEnabled, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieHwPoisonedErrInjUncorrectableNonFatalPreOsDpcEnabled.main() else Framework.TEST_RESULT_FAIL)

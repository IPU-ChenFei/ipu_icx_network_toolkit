...
class MalformedTlpPcieHwErrFatalErrorResponseLinux(KeysightPcieErrorInjectorCommon):
    """
    Glasgow_id : 59809
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new MalformedTlpPcieHwErrFatalErrorResponseLinux object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(MalformedTlpPcieHwErrFatalErrorResponseLinux, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(MalformedTlpPcieHwErrFatalErrorResponseLinux, self).prepare()
    ...
    def execute(self):
        ...
        os_error_log_found = self._os_log_ver_obj.verify_os_log_error_messages(
            __file__, self._os_log_ver_obj.DUT_MESSAGES_FILE_NAME, self.MALFORMED_TLP_FATAL_SIG_LINUX)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if MalformedTlpPcieHwErrFatalErrorResponseLinux.main() else

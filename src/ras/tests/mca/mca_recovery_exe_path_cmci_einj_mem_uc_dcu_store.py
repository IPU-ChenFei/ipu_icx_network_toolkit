...
class McaRecovExePathCmciEinjMemUcDcuStore(McaCommon):
    """
    Glasgow_id : 63079
    ...
    TEST_CASE_ID = ["G63079.0 - mca_recovery_exe_path_cmci_einj_mem_uc_dcu_store"]

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new McaRecovExePathCmciEinjMemUcDcuStore object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(McaRecovExePathCmciEinjMemUcDcuStore, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(McaRecovExePathCmciEinjMemUcDcuStore, self).prepare()
    ...
    def execute(self):
        ...
        """
        return self._mca_common.mca_inject_and_check(self._mca_common.RAS_MCA_EXE_DCU_STORE_PATH)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if McaRecovExePathCmciEinjMemUcDcuStore.main() else Framework.TEST_RESULT_FAIL)

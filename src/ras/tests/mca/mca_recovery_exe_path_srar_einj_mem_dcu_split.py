...
class McaRecovExePathSrarEinjMemDcuSplit(McaCommon):
    """
    Glasgow_id : 63078
    ...
    TEST_CASE_ID = ["G63078.0 - mca_recovery_exe_path_srar_einj_mem_uc_dcu_split"]

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new McaRecovExePathSrarEinjMemDcuSplit object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(McaRecovExePathSrarEinjMemDcuSplit, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(McaRecovExePathSrarEinjMemDcuSplit, self).prepare()
    ...
    def execute(self):
        ...
        """
        return self._mca_common.mca_inject_and_check(self._mca_common.RAS_MCA_EXE_DCU_SPLIT_PATH)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if McaRecovExePathSrarEinjMemDcuSplit.main() else Framework.TEST_RESULT_FAIL)

...
class UpiLaneReceiveFailureSingleEndOneHighLane(UpiLaneFailoverCommon):
    """
    Glasgow_id : 58367
    ...
    This test causes a UPI port 0 receive failure on a single link endpoint on all high lanes [7:0] and verifies the
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiLaneReceiveFailureSingleEndOneHighLane object

        :param test_log: Used for debug and info messages
        :param arguments: None
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiLaneReceiveFailureSingleEndOneHighLane, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiLaneReceiveFailureSingleEndOneHighLane, self).prepare()

    def execute(self):
        """
        This method is used to execute check_upi_lane_failover_enabled to verify if Upi self healing is enabled and
        causes a UPI port 0 receive failure on a single link endpoint on all high lanes [7:0] and verifies the error
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if UpiLaneReceiveFailureSingleEndOneHighLane.main() else

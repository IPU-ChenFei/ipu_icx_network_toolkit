...
class ReliabiliyCEMem(IoVirtualizationCommon):
    """
    GLASGOW ID: G68643

    While running stress on multiple VMs,
    Inject CE errors via fisher into VMM host
    ...
    VM = [VMs.RHEL]
    VM_NAME = None
    TEST_CASE_ID = ["G68643", "reliabiliy_ce_mem"]
    BIOS_CONFIG_FILE = "kvm_ballooning_memory_injection_bios_knobs.cfg"

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new ReliabiliyCEMem object.
        ...
        super(ReliabiliyCEMem, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):  # type: () -> None
        ...
        To Setup prepare
        """
        super(ReliabiliyCEMem, self).prepare()
    ...
    def execute(self):
        ...
        self.start_fisher_tool(self.FISHER_TOOL_CMD, self.FISHER_TOOL_WORKLOAD, self.FISHER_TOOL_RUN_DURATION_HOUR_MIN)

        # 12 hours timer
        fisher_tool_run_check_intervals = int(self.TWELVE_HOURS_TIMER_SEC/12)
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        ...
        super(ReliabiliyCEMem, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if ReliabiliyCEMem.main()

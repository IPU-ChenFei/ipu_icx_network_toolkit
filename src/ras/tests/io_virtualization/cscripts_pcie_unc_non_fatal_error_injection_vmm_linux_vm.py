...
class VmmCscriptsPcieUncNonFatalErrorVmmInjectionLinuxVm(VmmCscriptsPcieErrorInjectionBaseTest):
    """
    GLASGOW ID: G67418_L
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new CscriptsPcieUncNonFatalErrorVmmInjectionLinuxVm object.
        ...
        super(VmmCscriptsPcieUncNonFatalErrorVmmInjectionLinuxVm, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):  # type: () -> None
        ...
        super(VmmCscriptsPcieUncNonFatalErrorVmmInjectionLinuxVm, self).prepare()
    ...
    def execute(self, err_type=ErrorTypeAttribute.UNC_NON_FATAL, severity=SeverityAttribute.NON_FATAL):
        ...
        """
        super(VmmCscriptsPcieUncNonFatalErrorVmmInjectionLinuxVm, self).execute(err_type=ErrorTypeAttribute.UNC_NON_FATAL,
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        ...
        """
        super(VmmCscriptsPcieUncNonFatalErrorVmmInjectionLinuxVm, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VmmCscriptsPcieUncNonFatalErrorVmmInjectionLinuxVm.main()

...
class VmmCscriptsPcieCorrectableErrorInjectionVmmLinuxVm(VmmCscriptsPcieErrorInjectionBaseTest):
    """
    GLASGOW ID: G67417_L
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new CscriptsPcieCorrectableErrorInjectionVmmLinuxVm object.
        ...
        super(VmmCscriptsPcieCorrectableErrorInjectionVmmLinuxVm, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):  # type: () -> None
        ...
        super(VmmCscriptsPcieCorrectableErrorInjectionVmmLinuxVm, self).prepare()
    ...
    def execute(self, err_type=ErrorTypeAttribute.CORRECTABLE, severity=None):
        ...
        """
        super(VmmCscriptsPcieCorrectableErrorInjectionVmmLinuxVm, self).execute(err_type=ErrorTypeAttribute.CORRECTABLE)
        return True
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        ...
        """
        super(VmmCscriptsPcieCorrectableErrorInjectionVmmLinuxVm, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VmmCscriptsPcieCorrectableErrorInjectionVmmLinuxVm.main()

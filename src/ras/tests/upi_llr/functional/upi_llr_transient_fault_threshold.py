...
class UpiLlrTransientFaultThreshold(UpiLlrCrcCommon):
    """
    Glasgow_id : 66096
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiLlr16bCrcErr object
        ...
        super(UpiLlrTransientFaultThreshold, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiLlrTransientFaultThreshold, self).prepare()

    def execute(self):
        """
        This method is used to execute:
        1. Set the error threshold.
        2. Inject the UPI error.
        3. Verify Os log.
        ...
        return self.inject_upi_threshold_test(csp=cscripts_obj, sdp=sdp_obj, stress_test=False, threshold_value=0x8014)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if UpiLlrTransientFaultThreshold.main() else Framework.TEST_RESULT_FAIL)

...
class FailedDimmIsolationCorrectableErrorOob(ContentBaseTestCase):
    """
    Glasgow_id : G58457.2
    ...
    TEST_CASE_ID = ["G58457.2", "_16_02_05_dimm_ce_OOB"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new FailedDimmIsolationCorrectableErrorOob object

        :param test_log: Used for debug and info messages
        :param arguments: Arguments used in Baseclass
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(FailedDimmIsolationCorrectableErrorOob, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        super(FailedDimmIsolationCorrectableErrorOob, self).prepare()
    ...
    def execute(self):
        """
        This Method injects and verifies if Failed Dimm Isolation correctable memory OOB error is captured or not
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if FailedDimmIsolationCorrectableErrorOob.main() else Framework.TEST_RESULT_FAIL)

...
class VerifyViralInjectionDetectionRecoveryWithBPS(ViralInjectionDetectionRecoveryCommon):
    """
    Glasgow_id : 60851
    ...
    """
    _BIOS_CONFIG_FILE = "viral_injection_bios_knobs.cfg"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(VerifyViralInjectionDetectionRecoveryWithBPS, self).__init__(test_log, arguments, cfg_opts,
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if VerifyViralInjectionDetectionRecoveryWithBPS.main() else Framework.TEST_RESULT_FAIL)

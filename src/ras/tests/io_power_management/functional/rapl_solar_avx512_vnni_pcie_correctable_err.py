...
class RaplSolarAVX512VNNIPcieCorrectableErrors(IoPmCommon):
    """
    hsdes_id : https://hsdes.intel.com/appstore/article/#/22012477214
    RAPL + Solar AVX512VNNI workload + PCIe correctable error injections + OS log checks

    With the Solar tool running a AVX512VNNI workload, this test case walks you through
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new RaplSolarAVX512VNNIPcieCorrectableErrors object
        ...
        super(RaplSolarAVX512VNNIPcieCorrectableErrors, self).__init__(
        ...
        self.WORKLOADS = [self.SOLAR_WL_AVX512VNNI]
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(RaplSolarAVX512VNNIPcieCorrectableErrors, self).prepare()
...
if __name__ == "__main__":
    ...
    sys.exit(Framework.TEST_RESULT_PASS if RaplSolarAVX512VNNIPcieCorrectableErrors.main()

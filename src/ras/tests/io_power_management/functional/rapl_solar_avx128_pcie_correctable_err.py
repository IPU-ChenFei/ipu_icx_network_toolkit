...
class RaplSolarAVX128PcieCorrectableErrors(IoPmCommon):
    """
    hsdes_id : https://hsdes.intel.com/appstore/article/#/22012477213
    RAPL + Solar AVX128 workload + PCIe correctable error injections + OS log checks

    With the Solar tool running a AVX128 workload, this test case walks you through
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new RaplSolarAVX128PcieCorrectableErrors object
        ...
        super(RaplSolarAVX128PcieCorrectableErrors, self).__init__(
        ...
        self.WORKLOADS = [self.SOLAR_WL_AVX128]
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(RaplSolarAVX128PcieCorrectableErrors, self).prepare()
...
if __name__ == "__main__":
    ...
    sys.exit(Framework.TEST_RESULT_PASS if RaplSolarAVX128PcieCorrectableErrors.main()

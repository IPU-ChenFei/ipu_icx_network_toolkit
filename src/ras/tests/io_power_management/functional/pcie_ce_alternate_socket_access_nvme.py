...
class PcieCeAlternateSocketAccessNvme(EinjCommon):
    """
    PM RAS Alternate/secondary socket CPU IO access +PTU + PCIe correctable error + OS log checks using NVMe
    https://hsdes.intel.com/appstore/article/#/18014548833
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(PcieCeAlternateSocketAccessNvme, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        super(PcieCeAlternateSocketAccessNvme, self).prepare()

    def execute(self):
        """
        PCIe CE injection at runtime with PTU load and disc performance tool running.
        eDPC enabled.
        ...
        if not self._ras_nvme_utils_obj.inject_pcie_correctable_errors(self.injection_count, self.nvme_partition,
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieCeAlternateSocketAccessNvme.main()

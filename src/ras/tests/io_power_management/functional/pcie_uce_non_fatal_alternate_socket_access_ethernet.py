...
class PcieUceAlternateSocketAccessNonFatalEthernet(EinjCommon):
    """
    ...
    def __init__(self, test_log, arguments, cfg_opts,):
        ...
        """
        super(PcieUceAlternateSocketAccessNonFatalEthernet, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        super(PcieUceAlternateSocketAccessNonFatalEthernet, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieUceAlternateSocketAccessNonFatalEthernet.main()

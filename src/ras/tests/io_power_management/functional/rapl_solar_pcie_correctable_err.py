...
class RaplSolarPcieCorrectableErrors(IoPmCommon):
    """
    Glasgow_id : 70798 PM RAS Windows RAPL + Solar workload + PCIe correctable error injections + OS log checks

    With the Solar tool running a workload, this test case walks you through
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new RaplSolarPcieCorrectableErrors object
        ...
        super(RaplSolarPcieCorrectableErrors, self).__init__(
        ...
        self.WORKLOADS = [self.SOLAR_WL_SSE2, self.SOLAR_WL_AVX128, self.SOLAR_WL_AVX256,
                          self.SOLAR_WL_AVX512, self.SOLAR_WL_AVX128LITE, self.SOLAR_WL_AVX256LITE,
                          self.SOLAR_WL_AVX512LITE, self.SOLAR_WL_AVX512VNNI, SOLAR_WL_DGEMM]
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(RaplSolarPcieCorrectableErrors, self).prepare()
...
if __name__ == "__main__":
    ...
    sys.exit(Framework.TEST_RESULT_PASS if RaplSolarPcieCorrectableErrors.main()

...
class RaplSolarSSE2PcieCorrectableErrors(IoPmCommon):
    """
    hsdes_id : https://hsdes.intel.com/appstore/article/#/22012452720
    RAPL + Solar SSE2 workload + PCIe correctable error injections + OS log checks

    With the Solar tool running a SSE2 workload, this test case walks you through
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new RaplSolarSSE2PcieCorrectableErrors object
        ...
        super(RaplSolarSSE2PcieCorrectableErrors, self).__init__(
        ...
        self.WORKLOADS = [self.SOLAR_WL_SSE2]
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(RaplSolarSSE2PcieCorrectableErrors, self).prepare()
...
if __name__ == "__main__":
    ...
    sys.exit(Framework.TEST_RESULT_PASS if RaplSolarSSE2PcieCorrectableErrors.main()

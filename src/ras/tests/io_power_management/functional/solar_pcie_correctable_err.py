...
class SolarPcieCorrectableErrors(IoPmCommon):
    """
    Glasgow_id : 70253 PM RAS - Windows 2019 Server + Solar Workload + C-Scripts PCIe Correctable Error Injection

    With the Solar tool running a workload, this test case walks you through
    how to do PCIE error injection to the platform.
    """
    _BIOS_CONFIG_FILE = "solar_pstate_pcie_err_no_turbo_bios_knob.cfg"
    EVENT_LOGGING_DELAY_SEC = 3
    NUM_CYCLE = 235

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new SolarPcieCorrectableErrors object
        ...
        super(SolarPcieCorrectableErrors, self).__init__(
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(SolarPcieCorrectableErrors, self).prepare()
...
if __name__ == "__main__":
    ...
    sys.exit(Framework.TEST_RESULT_PASS if SolarPcieCorrectableErrors.main()

...
class RaplSolarAVX256PcieCorrectableErrors(IoPmCommon):
    """
    hsdes_id : https://hsdes.intel.com/appstore/article/#/22012477219
    RAPL + Solar AVX256 workload + PCIe correctable error injections + OS log checks

    With the Solar tool running a AVX256 workload, this test case walks you through
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new RaplSolarAVX256PcieCorrectableErrors object
        ...
        super(RaplSolarAVX256PcieCorrectableErrors, self).__init__(
        ...
        self.WORKLOADS = [self.SOLAR_WL_AVX256]
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(RaplSolarAVX256PcieCorrectableErrors, self).prepare()
...
if __name__ == "__main__":
    ...
    sys.exit(Framework.TEST_RESULT_PASS if RaplSolarAVX256PcieCorrectableErrors.main()

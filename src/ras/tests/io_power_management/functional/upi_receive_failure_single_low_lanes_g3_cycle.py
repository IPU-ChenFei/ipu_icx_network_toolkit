...
class UpiReceiveFailureSingleLowLanesG3Cycle(IoPmCommon):
    """
    Glasgow_id : 70729

    This TC causes an UPI port 0 Socket 0 receive failure on all low lanes [7:0] and verifies the
    error is signaled to the OS during G3 cold cycling.
    """
    NUM_CYCLES = 10
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(UpiReceiveFailureSingleLowLanesG3Cycle, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiReceiveFailureSingleLowLanesG3Cycle, self).prepare()

    def execute(self):
        """
        UPI Port 0 Socket 0 receive failure on low lanes during G3 cold cycling.
        ...
        for i in range(self.NUM_CYCLES):
            try:
                ...
                with ProviderFactory.create(self.sil_cfg, self._log) as cscripts_obj:
                    ...
                    self.set_rx_data_lane_enable(cscripts_obj)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if UpiReceiveFailureSingleLowLanesG3Cycle.main()

...
class PcieUceNonfatalWarmBootEdpcEnabled(IoPmCommon):
    """
    Glasgow_id : 70797 PM RAS - Linux - PCIe Uncorrectable nonfatal Warm Reboot Cycling - eDPC Enabled
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PcieUceNonfatalWarmBootEdpcEnabled, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(PcieUceNonfatalWarmBootEdpcEnabled, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieUceNonfatalWarmBootEdpcEnabled.main() else Framework.TEST_RESULT_FAIL)

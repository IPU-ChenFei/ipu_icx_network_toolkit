...
class LinuxTurboOnMlcUpiCorrectableErrors(IoPmCommon):
    """
    Glasgow_id : 70587 PM RAS - Linux - turbo mode On(default) -MLC stress - UPI 16-bit CRC LLR error
    ...
    """
    _BIOS_CONFIG_FILE = "turbo_on_mlc_upi_16bit_llr_err_bios_knob.cfg"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new LinuxTurboOnMlcUpiCorrectableErrors object
        ...
        super(LinuxTurboOnMlcUpiCorrectableErrors, self).__init__(
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(LinuxTurboOnMlcUpiCorrectableErrors, self).prepare()
...
if __name__ == "__main__":
    ...
    sys.exit(Framework.TEST_RESULT_PASS if LinuxTurboOnMlcUpiCorrectableErrors.main()

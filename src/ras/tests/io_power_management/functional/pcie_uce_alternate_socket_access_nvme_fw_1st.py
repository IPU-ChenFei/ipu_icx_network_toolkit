...
class PcieUceAlternateSocketAccessNvmeFWFirst(EinjCommon):
    """
    PM RAS Alternate/secondary socket CPU IO access +PTU + PCIe uncorrectable error + OS log checks using NVMe
    FW first version
    https://hsdes.intel.com/appstore/article/#/18014548770

    Please note: This test requires kernel.org version 5.12.0 or greater to pass.
    """
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new PcieUceNonfatalAlternateSocketAccessNvmeFWFirst object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(PcieUceAlternateSocketAccessNvmeFWFirst, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        """
        return
        super(PcieUceAlternateSocketAccessNvmeFWFirst, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieUceAlternateSocketAccessNvmeFWFirst.main()

...
class RaplSolarAVX512PcieCorrectableErrors(IoPmCommon):
    """
    hsdes_id : https://hsdes.intel.com/appstore/article/#/22012477212
    RAPL + Solar AVX512 workload + PCIe correctable error injections + OS log checks

    With the Solar tool running a AVX512 workload, this test case walks you through
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new RaplSolarAVX512PcieCorrectableErrors object
        ...
        super(RaplSolarAVX512PcieCorrectableErrors, self).__init__(
        ...
        self.WORKLOADS = [self.SOLAR_WL_AVX512]
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(RaplSolarAVX512PcieCorrectableErrors, self).prepare()
...
if __name__ == "__main__":
    ...
    sys.exit(Framework.TEST_RESULT_PASS if RaplSolarAVX512PcieCorrectableErrors.main()

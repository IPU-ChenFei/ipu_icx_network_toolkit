...
class VerifySmmBreakDumpStateStorageMsrs(EsmmSaveCommon):
    """
    Glasgow_id : G58339-_74_02_03_verify_smm_break_dump_state_storage_msrs_available
    This test verifies Spurious SMI Handling flow support

    """
    TEST_CASE_ID = ["G58339", "_74_02_03_verify_smm_break_dump_state_storage_msrs_available"]
    BIOS_CONFIG_FILE = "esmm_save_state_bios_knobs.cfg"

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new VerifySmmBreakDumpStateStorageMsrs object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(VerifySmmBreakDumpStateStorageMsrs, self).__init__(test_log, arguments, cfg_opts, self.BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        # type: () -> None
        """
        Creates a new VerifySmmBreakDumpStateStorageMsrs object and we are calling a Prepare function
        ...
        :return: None
        """
        super(VerifySmmBreakDumpStateStorageMsrs, self).prepare()
    ...
    def execute(self):
        ...
        return (self.esmm_utils_obj.is_long_and_blocked_flow_indication_enabled()
                ...
                self.esmm_utils_obj.is_esmm_bios_write_protect_enable() and
                self.esmm_utils_obj.verify_smm_dump_state_storage_msrs_available(
                verify_non_smm_break_msrs=False, verify_smm_break_msrs=True))


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VerifySmmBreakDumpStateStorageMsrs.main() else Framework.TEST_RESULT_FAIL)

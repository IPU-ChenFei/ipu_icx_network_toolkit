...
class MirrorModeCommon(BaseTestCase):
    """
    This Class is Used as Common Class For all the Mirror Mode Test Cases
    """
    ...
    def verify_whether_mirror_mode_enabled(self):
        """
        ...
        if mirror_mode == 0x1:
            ...
            self._log.info("Mirror Mode is Not Enabled")

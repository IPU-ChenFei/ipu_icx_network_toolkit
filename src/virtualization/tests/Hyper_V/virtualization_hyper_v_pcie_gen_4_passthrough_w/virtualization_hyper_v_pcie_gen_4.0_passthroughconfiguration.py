...
class VirtualizationPCIePassThroughNetwork(VirtualizationCommon):
    ...
    """
    TC_ID = ["16013375294", "Virtualization_PCIe_Gen_5.0_PassThroughNetwork_W"]
    STEP_DATA_DICT = {
        ...
        5: {'step_details': "Perform Network Passthrough for Gen4.0 by creating External Switch using Physical adapter"
                            "by pinging VM",
            'expected_results': "Passthrough for Gen4.0 has been verified successfully"},
    }
    BIOS_CONFIG_FILE = "hyperv_gen4.0_passthroughnetwork_bios_knobs.cfg"
    NUMBER_OF_VMS = 1
    VM = [VMs.WINDOWS]
    VM_TYPE = "RS5"
    ...
    def execute(self):
        ...
        4. Perform Network Passthrough for Gen4.0 by creating External Switch using Physical adapter by pinging VM
        """
        ...
        for index in range(self.NUMBER_OF_VMS):
            ...
            # Performs Hyper-V Network passthrough for Gen4.0 card test by pinging VM from SUT

...
class VirtualizationSIOVQATCpmVMStressWorkload(BaseQATUtil):
    """
    Phoenix ID : 16012899860
    ...
    VM_TYPE = "CENTOS"
    TEST_CASE_ID = ["P16012899860", "VirtualizationSIOVQATCpmVMStressWorkload"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationSIOVQATCpmVMStressWorkload, self).__init__(test_log, arguments, cfg_opts, self.virt_siov_qatcpm_func_vmwl_biosknobs)
    ...
    def prepare(self):
        ...
        super(VirtualizationSIOVQATCpmVMStressWorkload, self).prepare()
    ...
    def execute(self):
        ...
        qat_dependency_packages = "zlib-devel libnl3-devel boost-devel systemd-devel yasm lz4-devel " \
        ...
        while True:
            ...
            for index, vm_name, each_vm_obj in zip(range(len(self.LIST_OF_VM_NAMES)), self.LIST_OF_VM_NAMES,
                ...
                self.run_qat_stress_workload(common_content_lib_vm_obj)
                time.sleep(5)
        ...
        for index, vm_name in zip(range(len(self.LIST_OF_VM_NAMES)), self.LIST_OF_VM_NAMES):
            ...
            for vqat_num in range(start_vqat_index_in_list, (start_vqat_index_in_list + vqat_per_vm)):
                ...
                try:
                    self._log.info("Detaching info: {} {}".format(vm_name, vqat_uuid))
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationSIOVQATCpmVMStressWorkload, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationSIOVQATCpmVMStressWorkload.main() else Framework.TEST_RESULT_FAIL)

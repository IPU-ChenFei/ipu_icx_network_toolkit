...
class SprDsaGuestVMPassThrough(VirtualizationCommon, DsaBaseTest_virtualization):
    """
    Phoenix ID : 18014074761
    ...
    VM = [VMs.CENTOS] * 1
    VM_TYPE = "CENTOS"
    TEST_CASE_ID = ["18014074761", "PI_SPR_DSA_HI_Configuration_GuestVM_Passthrough_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(SprDsaGuestVMPassThrough, self).__init__(test_log, arguments, cfg_opts, self.virtualization_dsa_bios_knobs)
    ...
    def prepare(self):
        ...
        super(SprDsaGuestVMPassThrough, self).prepare()
    ...
    def execute(self):
        ...
        for index, vm_name, each_vm_obj in zip(range(len(self.LIST_OF_VM_NAMES)), self.LIST_OF_VM_NAMES,
            ...
            self.execute_opcode_test(spr_file_path=spr_dir_path,common_content_lib_vm=common_content_lib_vm_obj, vm_obj=each_vm_obj)
            self.execute_dma_test(spr_file_path=spr_dir_path, common_content_lib_vm=common_content_lib_vm_obj, vm_obj=each_vm_obj)
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(SprDsaGuestVMPassThrough, self).cleanup(return_status)

if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SprDsaGuestVMPassThrough.main() else Framework.TEST_RESULT_FAIL)

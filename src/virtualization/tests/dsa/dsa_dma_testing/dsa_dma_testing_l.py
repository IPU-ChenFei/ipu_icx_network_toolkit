...
class DsaDMATesting(DsaBaseTest):
    """
    Phoenix ID : 18014075503-PI_SPR_DSA_DMA_testing_L

    This Test case is to Test the DSA DMA the Linux SUT
    """
    TEST_CASE_ID = ["18014075503", "PI_SPR_DSA_DMA_testing_L"]
    BIOS_CONFIG_FILE = "../vtd_bios_config.cfg"
    DSAI_DMA_MODE_SCRIPT = "./setup_dsai_DMA_mode.sh"
    EXEC_DMA_TEST_SCRIPT = "./Setup_Randomize_DSA_Conf.sh -i 100 -j 2"
    EXEC_DISABLE_WQ = "./Setup_Randomize_DSA_Conf.sh -d"
    ...
    STEP_DATA_DICT = {1: {'step_details': 'Enable Intel VT for Directed I/O (VT-d), Interrupt Remapping, PCIe ENQCMD '
                      ...
                      5: {'step_details': 'Execute DMA test with 2channels &100 iterations',
                          'expected_results': 'Executed DMA Test successfully '},
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create instance of DsaDMATesting
        ...
        super(DsaDMATesting, self).__init__(test_log, arguments, cfg_opts, self.dsa_bios_enable)
    ...
    def prepare(self):
        ...
        super(DsaDMATesting, self).prepare()
    ...
    def execute(self):
        ...
        result = self.execute_shell_script(self.DSAI_DMA_MODE_SCRIPT, self.TEST_CASE_CONTENT_PATH)
        ...
        # Execute DMA test with 2channels &100 iterations
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if DsaDMATesting.main() else Framework.TEST_RESULT_FAIL)

...
class PiVirtualizationVTXEnablingL(ContentBaseTestCase):
    ...
    """
    TEST_CASE_ID = ["H79625"]
    MSR_TOOLS = "msr-tools-1.3-12.el8.x86_64.rpm"
    ...
    def execute(self):
        ...
        """
        # Downloading msr-tools from Artifactory
        tool_path = self._artifactory_obj.download_tool_to_automation_tool_folder(self.MSR_TOOLS)
        self.os.copy_local_file_to_sut(tool_path, self.ROOT_PATH)
        # Install msr-tools

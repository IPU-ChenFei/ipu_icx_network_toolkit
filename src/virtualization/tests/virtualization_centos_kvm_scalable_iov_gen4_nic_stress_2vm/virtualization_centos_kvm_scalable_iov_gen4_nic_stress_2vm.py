...
class VirtualizationCentOsKvmScalableIovGen4NicStress2Vm(VirtualizationCommon):
    """
    Phoenix ID: 16013376171
    ...
    """
    TEST_CASE_ID = ["p16013376171", "Virtualization-CentOs-Kvm-ScalableIov-Gen4-Nic-Stress_2vm"]
    STEP_DATA_DICT = {
        ...
        4: {'step_details': "Create 2 CentOS virtual machine based on given name",
    ...
    NUMBER_OF_VMS = [VMs.CENTOS]*2  # 1, tested with 1
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationCentOsKvmScalableIovGen4NicStress2Vm, self).__init__(test_log, arguments, cfg_opts)
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationCentOsKvmScalableIovGen4NicStress2Vm, self).cleanup(return_status)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationCentOsKvmScalableIovGen4NicStress2Vm.main()

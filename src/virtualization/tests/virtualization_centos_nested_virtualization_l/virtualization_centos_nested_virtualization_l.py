...
class VirtualizationCentOSNestedVirtualization(VirtualizationCommon):
    """
    ...
    """
    TEST_CASE_ID = ["P16014135631", "VirtualizationCentOSNestedVirtualization"]
    STEP_DATA_DICT = {
    ...
    VMN = [VMs.CENTOS] * 1
    VMN_TYPE = "CENTOS"
    TC_ID = ["P16014135631-VirtualizationCentOSNestedVirtualization"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationCentOSNestedVirtualization, self).__init__(test_log, arguments, cfg_opts)
    ...
    def execute(self):
        ...
        for index, each_vm_obj in zip(range(len(self.LIST_OF_VM_NAMES)), vm_sut_obj_list):
            ...
            for vm_name_nested in self.LIST_OF_NESTED_VM_NAMES:
                ...
                vm_vm_os_obj = virtualization_obj_vm.create_vm_host_nested(vm_name_nested, self.VMN_TYPE,
                                                                           nesting_level="l2")
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationCentOSNestedVirtualization, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationCentOSNestedVirtualization.main()

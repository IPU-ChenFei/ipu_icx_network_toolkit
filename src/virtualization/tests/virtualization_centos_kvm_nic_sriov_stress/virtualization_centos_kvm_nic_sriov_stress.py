...
class VirtualizationCentOSKvmNicSriovStress(VirtualizationCommon):
    """
    Phoenix ID: 16014135726
    ...
    """
    TEST_CASE_ID = ["p16014135726", "Virtualization-CentOS-KVM-NIC-SRIOV-stress"]
    STEP_DATA_DICT = {
    ...
    BIOS_CONFIG_FILE = "virtualization_centos_kvm_nic_sriov_stress.cfg"
    NUMBER_OF_VMS = 1
    VM = [VMs.CENTOS]*1
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationCentOSKvmNicSriovStress, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(VirtualizationCentOSKvmNicSriovStress, self).prepare()
    ...
    def execute(self):
        ...
        for index in range(self.NUMBER_OF_VMS):
            ...
            vf_adapter_name = self.get_virtual_adapter_name_in_vm(common_content_lib_vm_obj)
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        # pass
        super(VirtualizationCentOSKvmNicSriovStress, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationCentOSKvmNicSriovStress.main()

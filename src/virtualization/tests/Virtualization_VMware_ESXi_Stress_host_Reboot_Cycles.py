"""
@Case Link: https://hsdes.intel.com/appstore/article/#/1509884216
@Author:Liu,jianjunX
@Prerequisite:
1. HW Configuration
...
def test_steps(sut, my_os):
    ...
    Case.step("Start the cycling.The script would be run automatically every time system reboots")
    for i in range(1, 5):
        Case.step(f"reboot Cycle {i}")

...
class VirtualizationRhelKvmVmScalableIovAndDsa(VirtualizationCommon, DsaBaseTest_virtualization):
    """
    ...
    STEP_DATA_DICT = {1: {'step_details': 'Enable Intel VT for Directed I/O (VT-d), Interrupt Remapping, PCIe ENQCMD '
                      ...
                      7: {'step_details': 'Install the depedencies packages on the VM', 'expected_results': 'Should be successfull'},
                      8: {'step_details': 'Configure DSA on guest','expected_results': 'Should be successfull'},
                      9: {'step_details': 'Run workload to attached device as MDEV','expected_results': 'Should be successfull'},
                      }
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationRhelKvmVmScalableIovAndDsa, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        super(VirtualizationRhelKvmVmScalableIovAndDsa, self).prepare()
    ...
    def execute(self):
        ...
        for index in range(self.NUMBER_OF_VMS):
           ...
           # create VM os object
            ...
            self.attach_mdev_instance_to_vm(vm_name, uuid)
            self._log.info("Attached all the devices to VM successfully")
            ...
            configure_wq = "./Guest_Mdev_Randomize_DSA_Conf.sh -cu"
            ...
            cmd_dma = "./Guest_Mdev_Randomize_DSA_Conf.sh -o 0x3"
            ...
            cmd_opt = vm_os_obj.execute(cmd_check_error, self._command_timeout)
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationRhelKvmVmScalableIovAndDsa, self).cleanup(return_status)

if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if VirtualizationRhelKvmVmScalableIovAndDsa.main() else Framework.TEST_RESULT_FAIL)

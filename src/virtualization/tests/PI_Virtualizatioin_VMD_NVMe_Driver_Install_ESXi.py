"""
 @Case Link: https://hsdes.intel.com/appstore/article/#/1509889320
 @Author:YanXu
 @Prerequisite:
    1. HW Configuration
        1.Plug 1 NVMe SSD intoSUT
    2. SW Configuration
...
def test_steps(sut, my_os):
    ...
    _, install_nvme, _ = sut.execute_shell_cmd(
        f'esxcli software vib install -v /{MKDIR_NAME}/{INTEL_NVME_VIB} --no-sig-check', timeout=100)
    Case.expect('VIBs Installed: INT_bootbank_intel-nvme-vmd_2.0.0.1146-1OEM.700.1.0.15843807',
                VIBS_INSTALLED in install_nvme)

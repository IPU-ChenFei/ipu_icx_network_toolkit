"""
 @Case Link: https://hsdes.intel.com/appstore/article/#/1509883793
 @Author:Liu, JianjunX
 @Prerequisite:
    1. SW Configuration
        1. QEMU is installed:
...
def test_steps(sut, my_os):
    ...
    Case.step("./tests/smap")
    _, out, _ = sut.execute_shell_cmd("./tests/smap", cwd=tool_name_master)
    # The successful code need to the last line of log has string "PASS smap"
    res = log_check.find_lines("PASS", out)
    result = log_check.find_keyword("smap", res[-1])

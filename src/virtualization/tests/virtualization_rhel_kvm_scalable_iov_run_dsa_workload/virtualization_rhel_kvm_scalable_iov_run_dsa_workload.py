...
class VirtualizationRhelKvmVmScalableIovRunDSAWorkload(VirtualizationCommon, DsaBaseTest_virtualization):
    """
    HPALM ID: 16013374828
    ...
    7. Run DSA workload on host and Guest
    """
    ...
    TEST_CASE_ID = ["H16013374828", "DSA_TEST"]
    STORAGE_VOLUME = ["/home"]
    ...
    STEP_DATA_DICT = {1: {'step_details': 'Enable Intel VT for Directed I/O (VT-d), Interrupt Remapping, PCIe ENQCMD '
                      ...
                      7: {'step_details': 'Run DSA workload on host and Guest', 'expected_results': 'Should be successfull'},
                      }
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationRhelKvmVmScalableIovRunDSAWorkload, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        super(VirtualizationRhelKvmVmScalableIovRunDSAWorkload, self).prepare()
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationRhelKvmVmScalableIovRunDSAWorkload, self).cleanup(return_status)

if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if VirtualizationRhelKvmVmScalableIovRunDSAWorkload.main() else Framework.TEST_RESULT_FAIL)

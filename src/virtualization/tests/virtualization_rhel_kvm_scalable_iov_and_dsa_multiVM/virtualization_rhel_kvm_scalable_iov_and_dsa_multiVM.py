...
class VirtualizationRhelKvmVmScalableIovAndDsa_multiVM(VirtualizationCommon,DsaBaseTest_virtualization):
    """
    HPALM ID: 16013977962
    ...
    TEST_CASE_ID = ["H16013977962", "DSA_TEST"]
    STORAGE_VOLUME = ["/home"]
    ...
    STEP_DATA_DICT = {1: {'step_details': 'Enable Intel VT for Directed I/O (VT-d), Interrupt Remapping, PCIe ENQCMD '
                      ...
                      7: {'step_details': 'Run workload to attached device as MDEV',
                          'expected_results': 'Should be successfull'},
                      8: {'step_details': 'Repeat steps for MultiVM',
                          'expected_results': 'Should be successfull'},
                      }
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationRhelKvmVmScalableIovAndDsa_multiVM, self).__init__(test_log, arguments, cfg_opts, self.dsa_bios_enable)
    ...
    def prepare(self):
        ...
        super(VirtualizationRhelKvmVmScalableIovAndDsa_multiVM, self).prepare()
    ...
    def execute(self):
        ...
        7. Run workload to attached device as MDEV.
        8.Repeat the steps for multiVM
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
       super(VirtualizationRhelKvmVmScalableIovAndDsa_multiVM, self).cleanup(return_status)

if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationRhelKvmVmScalableIovAndDsa_multiVM.main() else Framework.TEST_RESULT_FAIL)

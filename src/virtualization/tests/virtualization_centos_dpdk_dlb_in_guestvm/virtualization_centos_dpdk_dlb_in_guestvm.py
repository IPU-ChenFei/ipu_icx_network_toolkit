...
class VirtualizationDpdkDlbGuest(VirtualizationCommon):
    """
    Phoenix ID : 16014124038
    ...
    VM = [VMs.CENTOS] * 1
    VM_TYPE = "CENTOS"
    TEST_CASE_ID = ["p16014124038", "Virtualization_Dpdk_Dlb_guestVM"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationDpdkDlbGuest, self).__init__(test_log, arguments, cfg_opts, self.virtualization_dpdk_dlb_bios_knobs)
    ...
    def prepare(self):
        ...
        super(VirtualizationDpdkDlbGuest, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationDpdkDlbGuest.main() else Framework.TEST_RESULT_FAIL)

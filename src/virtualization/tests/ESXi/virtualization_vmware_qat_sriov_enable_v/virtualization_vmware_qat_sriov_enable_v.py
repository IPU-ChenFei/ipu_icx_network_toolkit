...
class VirtualizationVmwareQATSRIOVEnable(BaseQATUtil):
    """
    Phoenix ID: 16013373368
    ...
    VM = [VMs.RHEL] * 1
    VM_TYPE = ["RHEL"]
    TEST_CASE_ID = ["P16013373234", "Virtualization_VMware_QAT_SRIOV_Enable"]
    STEP_DATA_DICT = {
        ...
        8: {'step_details': "Adding qat vf to vm and Verify qat in VM",
            'expected_results': "Qat vf added to vm enabled successfully"},
        9: {'step_details': "Verify qat in VM",
            'expected_results': "The QAT VF is verified in VM"},
        10: {'step_details': "Remove Passthrough QAT devices from VM",
            'expected_results': "The QAT VF from vm is dettached successfully"},
        11: {'step_details': "Disable SRIOV for qat driver ",
             'expected_results': "Disabled SRIOV successfully"},
        12: {'step_details': "Remove qat driver from SUT",
             'expected_results': "qat driver removed successfully"},
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(VirtualizationVmwareQATSRIOVEnable, self).__init__(test_log, arguments, cfg_opts)
    ...
    def execute(self):
        ...
        for vm_index, vm_name in enumerate(self.LIST_OF_VM_NAMES):
            ...
            self.qat_device_presencein_vm(common_content_obj_vm)
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationVmwareQATSRIOVEnable, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationVmwareQATSRIOVEnable.main()

...
class VirtualizationVmwareQATSriovSingleVMMultiPFDataMov(BaseQATUtil):
    """
    ...
    3. Enable SRIOV and Create 2 VFs for each QAT PFs
    ...
    11. Remove the Passthrough from VMs
    """
    NUM_VM = 1
    VM = [VMs.RHEL] * NUM_VM  # , VMs.WINDOWS]
    VM_TYPE = ["RHEL"] * NUM_VM  # , "WINDOWS"]
    cpa_sample_command = "./cpa_sample_code signOfLife=1"
    TEST_CASE_ID = ["P16013374116", "VirtualizationVmwareQATSriovSingleVMMultiPFDataMov"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(VirtualizationVmwareQATSriovSingleVMMultiPFDataMov, self).__init__(test_log, arguments, cfg_opts)
    ...
    def execute(self):
        ...
        self._log.info(no_of_qat_devices)
        self._test_content_logger.end_step_logger(4, return_val=True)

        #no_of_vfs = 2 * no_of_qat_devices
        max_vf_per_qat = 2
        qat_bdf_list = []
        ...
        for vm_index, vm_name in enumerate(self.LIST_OF_VM_NAMES):
            ...
            for qat_pf_index in range(no_of_qat_devices):
            ...
            self.install_check_qat_status(vm_name=vm_name, os_obj=vm_os_obj, qat_type="sriov",
                                          target_type="guest",
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationVmwareQATSriovSingleVMMultiPFDataMov, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationVmwareQATSriovSingleVMMultiPFDataMov.main()

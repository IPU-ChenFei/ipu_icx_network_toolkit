...
class VirtualizationVmwareQATSRIOVSingleVM(BaseQATUtil):
    """
    ...
    VM = [VMs.RHEL] * 1
    VM_TYPE = "RHEL"
    TEST_CASE_ID = ["P16013373368", "Virtualization_VMware_QAT_SRIOV_Single_VM_Data_movement"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(VirtualizationVmwareQATSRIOVSingleVM, self).__init__(test_log, arguments, cfg_opts)
    ...
    def execute(self):
        ...
        for vm_name in self.LIST_OF_VM_NAMES:
            ...
            cpa_sample_command = "./cpa_sample_code"
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationVmwareQATSRIOVSingleVM, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationVmwareQATSRIOVSingleVM.main()

...
class VirtualizationCreateVMRhelCentosWinCPUMemWorkloads(VirtualizationCommon):
    """
    Phoenix ID: 16014379501
    ...
    """
    TEST_CASE_ID = "p16014379501"
    TEST_CASE_DETAILS = ["p16014379501", "Virtualization-CreateVirtualmachines-Rhel-Centos-Win-CPU-Mem-Workloads"]
    STEP_DATA_DICT = {
        ...
        3: {'step_details': "Create CentOS, RHEL, Windows VM's",
            'expected_results': "VM's Created Successfully"},
        4: {'step_details': "Install MLC tool from artifactory on all VMs",
            'expected_results': "Successfully installed MLC tool on VM"},
        5: {'step_details': "Start MLC tool on all VM",
            'expected_results': "VM tool started successfully on all VM"},
    }

    BIOS_CONFIG_FILE = "virtualization_kvm_vm_stress_memory_bios.cfg"
    NUMBER_OF_CENT_VMS = [VMs.CENTOS] * 5
    NUMBER_OF_RHEL_VMS = [VMs.RHEL] * 5
    NUMBER_OF_WIN_VMS = [VMs.WINDOWS] * 5
    NUM_OF_LINUX_VMS = 10
    STORAGE_VOLUME = ["/home"]
    MAC_ID = True
    CENT_VM_TYPE = "CENTOS"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new VirtualizationCreateVMRhelCentosWinCPUMemWorkloads object.
        ...
        super(VirtualizationCreateVMRhelCentosWinCPUMemWorkloads, self).__init__(test_log, arguments,
                                                                                              cfg_opts)
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationCreateVMRhelCentosWinCPUMemWorkloads, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationCreateVMRhelCentosWinCPUMemWorkloads.main()

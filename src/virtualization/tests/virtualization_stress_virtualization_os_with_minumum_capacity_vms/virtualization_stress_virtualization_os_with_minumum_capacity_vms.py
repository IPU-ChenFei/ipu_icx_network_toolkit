...
class VirtualizationStressOSMinimumCapacityVms(ilvssutil, VirtualizationCommon):
    """
    Phoenix ID: 18014073786
    ...
    VM_TYPE = "RHEL"
    STORAGE_VOLUME = ["/home"]
    BIOS_CONFIG_FILE = "virtualization_stress_virtualization_os_with_minumum_capacity_vms.cfg"
    TOOL_RUN_TIME = 7200
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationStressOSMinimumCapacityVms, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):  # type: () -> None
        ...
        super(VirtualizationStressOSMinimumCapacityVms, self).prepare()
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationStressOSMinimumCapacityVms, self).cleanup(return_status)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationStressOSMinimumCapacityVms.main()

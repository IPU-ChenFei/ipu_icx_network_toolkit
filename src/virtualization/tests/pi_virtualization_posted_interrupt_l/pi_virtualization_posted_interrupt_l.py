...
class PiVirtualizationPostedInterruptL(VirtualizationCommon):
    """
    HPALM ID: H81076-PI_Virtualization_Posted_interrupt_L

    1. Run KVM Unit Test command
    2. Verify the expected output is present in the command result
    """
    TC_ID = ["H81076-PI_Virtualization_Posted_interrupt_L"]
    __BIOS_CONFIG_FILE = r"..\..\kvm_unittests_bios_knobs.cfg"
    __KVM_UNIT_TEST_EXPECTED_RESULT = "PASS: process-posted interrupts"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiVirtualizationPostedInterruptL, self).__init__(test_log, arguments, cfg_opts, create_bridge=False)
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(PiVirtualizationPostedInterruptL, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiVirtualizationPostedInterruptL.main()

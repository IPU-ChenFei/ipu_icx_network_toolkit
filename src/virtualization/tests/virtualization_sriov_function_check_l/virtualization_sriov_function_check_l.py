...
class VirtualizationSriovFunctionCheck(VirtualizationCommon):
    """
    Phoenix ID: 18014074714
    ...
    """
    TEST_CASE_ID = ["p18014074714", "PI_Virtualization_SR-IOVFunctionCheck_L"]
    STEP_DATA_DICT = {
    ...
    BIOS_CONFIG_FILE = "virtualization_sriov_function_check_l.cfg"
    NUMBER_OF_VMS = 1
    VM = [VMs.CENTOS]*1
    BASE_PORT = 5000
    STORAGE_VOLUME = ["/home"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(VirtualizationSriovFunctionCheck, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(VirtualizationSriovFunctionCheck, self).prepare()
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        super(VirtualizationSriovFunctionCheck, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if VirtualizationSriovFunctionCheck.main()

...
class BmcRemoteControlBootDefault(ManageabilityCommon):
    """
        HPALM ID: 80235
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of BmcRemoteControlBootDefault
        ...
        super(BmcRemoteControlBootDefault, self).__init__(test_log, arguments, cfg_opts)
    ...
    def execute(self):
        """
            ...
            3. Set the system boot option to BIOS and then NONE
            4. Power on
        """
        ...
        self._log.info("Setting system to BOOT to DEFAULT")
    ...
    def cleanup(self, return_status):
        """Test Cleanup"""
        super(BmcRemoteControlBootDefault, self).cleanup(return_status=True)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if BmcRemoteControlBootDefault.main() else Framework.TEST_RESULT_FAIL)

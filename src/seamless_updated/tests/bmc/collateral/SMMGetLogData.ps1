...
Invoke-Command -ScriptBlock {Param($command) C:\Windows\System32\SeamlessUpdateToolbox.ps1 -sruFlow getLogData -maxLogSize $command} -ArgumentList($command) -Session $s

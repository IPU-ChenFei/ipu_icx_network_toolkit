...
Invoke-Command -ScriptBlock {Param($command) C:\Windows\System32\SeamlessUpdateToolbox.ps1 -sruFlow setLogLevel -logLevel $command} -ArgumentList($command) -Session $s

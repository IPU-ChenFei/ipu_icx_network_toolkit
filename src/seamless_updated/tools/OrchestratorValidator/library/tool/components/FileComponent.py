...
class FileComponent(ByteArrayComponent):
        ...
        with open(self.value, "rb") as f:
            ...
            if self.size_formula:
                ...
                if len(self._data) != self.size:
                    raise ComponentException("Invalid size of external_data, should be {} but is {}".format(self.size, len(self._data)), self.name)
    ...
    def _parse_string_path_value(self, value):
        ...
        if old_value != value and value and self.decomp_dependency:

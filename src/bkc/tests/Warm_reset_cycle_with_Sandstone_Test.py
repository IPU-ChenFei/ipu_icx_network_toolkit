...
def test_steps(tcd):
    ...
    # Tool Version [0.2.13]
    #ID/LINK: https://hsdes.intel.com/appstore/article/#/15010691538
    #TITLE: Warm_reset_cycle_with_Sandstone_Test
    #DOMAIN: system
    ...
    if tcd.prepare("setup system for test"):
        ...
        # has several criterial: power on: 4h,  BKC : 12h,  Volume validation: 48h
    ...
    ## 6
    if tcd.step("## Call TCDB BKC_UNIQ_15010691538 Start"):
        
        ### Call TCDB BKC_UNIQ_15010691538 Start
        for i in range(0, 2):
            # Test Tcd
        ...
        ### Call TCDB BKC_UNIQ_15010691538 End
    ...
    ## 8
    if tcd.step("8"):
        sutos.execute_cmd(sut, f'cat /var/log/sandstone.log |grep -i "cycle 2 done"')
        ### Notes ###

...
def test_steps(sut, sutos):
    ...
    os.system(
        'curl "https://ubit-artifactory-sh.intel.com/artifactory/validationtools-sh-local/val/ipmitoolkit_1.8.18.zip" -o "C:\\BKCPkg\\ipmitoolkit_1.8.18.zip"')
    os.system(
        'curl "https://ubit-artifactory-sh.intel.com/artifactory/validationtools-sh-local/val/unzip.exe" -o "C:\\BKCPkg\\unzip.exe"')

    os.chdir('C:\\BKCPkg')
    os.system('unzip.exe ipmitoolkit_1.8.18.zip')

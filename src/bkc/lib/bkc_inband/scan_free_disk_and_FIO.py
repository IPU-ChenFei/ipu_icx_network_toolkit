...
def run_test(test_name,disk_label,log_path):
    ...
    os.system(f"fio -filename={disk} -direct=1 -iodepth 1 -thread -rw=randrw -rwmixread=70 -ioengine=psync -bs=4k -size=300G -numjobs=50 -runtime=10 -group_reporting -name=randrw_70read_4k -output={log}")

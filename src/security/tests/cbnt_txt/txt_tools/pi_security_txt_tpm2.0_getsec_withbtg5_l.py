...
class SystemBootSecretFlagWithBTG5(TxtBaseTest):
    """
    HPQC ID : H101225-PI_Security_TXT_TPM2.0_Getsec_withBTG5_L
    PHOENIX ID : 18016910182-PI_Security_TXT_TPM2.0_Getsec_withBTG5_L
    ...
    5.Verify Boot Guard Profile 5
    """

    _BIOS_CONFIG_FILE = "txt_base/security_txt_bios_knobs_enable.cfg"
    _TEST_CASE_ID = ["H101225","PI_Security_TXT_TPM2.0_Getsec_withBTG5_L", "18016910182"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of SystemBootSecretFlagWithBTG5

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        """
        super(SystemBootSecretFlagWithBTG5, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        super(SystemBootSecretFlagWithBTG5, self).prepare()
    ...
    def execute(self):
        ...
        if not self._bootguard_common_obj.verify_profile_5():
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        if str(self.current_boot_order) != str(self.previous_boot_oder):
            self.itp_xml_cli_util.set_boot_order(self.previous_boot_oder)
        super(SystemBootSecretFlagWithBTG5, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SystemBootSecretFlagWithBTG5.main() else Framework.TEST_RESULT_FAIL)

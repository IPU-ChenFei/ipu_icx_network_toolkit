...
class SystemBootWithSecretFlag(TxtBaseTest):
    """
    HPQC ID : H79549-PI_Security_TXT_TPM2.0_SECRETS_L
    ...
    _TEST_CASE_ID = ["H79549-PI_Security_TXT_TPM2.0_SECRETS_L"]
    ...
    step_data_dict = {1: {'step_details': 'Enable the Bios knobs for TXT',
                      ...
                      4: {'step_details': 'Execute the Server Secrets64.efi -s to assert secret flag',
                      ...
                      6: {'step_details': 'Execute SENTER with the getsec EFI tool',
                          'expected_results': 'System entered the TXT environment successfully'},
                      7: {'step_details': 'Execute the Server Secrets64.efi -n to de-assert secret flag',
                          'expected_results': 'Secret flag de-asserted successfully'}}

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of SystemBootWithSecretFlag

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        """
        super(SystemBootWithSecretFlag, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        super(SystemBootWithSecretFlag, self).prepare()
    ...
    def execute(self):
        ...
        5. execute Server Secrets64.efi -n to de-assert secret flag
    ...
    def cleanup(self, return_status):  # type: (bool) -> None
        if str(self.current_boot_order) != str(self.previous_boot_oder):
            self.itp_xml_cli_util.set_boot_order(self.previous_boot_oder)
        super(SystemBootWithSecretFlag, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SystemBootWithSecretFlag.main() else Framework.TEST_RESULT_FAIL)

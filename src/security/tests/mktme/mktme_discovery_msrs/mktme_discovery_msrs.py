...
class MktmeDiscoveryMsrs(MktmeBaseTest):
    ...
    Phoenix ID : P18014070445 - Verify the presence of TME MSRs (platform is TME/MKTME capable)
    ...
    TEST_CASE_ID = ["G59514.2", "MKTME Discovery (in-band)_MSRs",
                    "P18014070445 - Verify the presence of TME MSRs (platform is TME/MKTME capable)"]

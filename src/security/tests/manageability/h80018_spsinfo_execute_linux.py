...
class InstallSpsToolInfo(ContentBaseTestCase):
    ...
    The purpose of this test case is to verify Spsinfo folder to be copy on Linux sut and
    ...
    step_data_dict = {1: {'step_details': 'Check spstool copied on sut based on os ',
                          'expected_results': 'Verify firmware version tool output with the '
                                              'content configuration version '},
                      2: {'step_details': 'Execute  ./spsInfoLinux64 on sut collect the firmware version ',
    ...
    def execute(self):
        ...
        and also this verify the actual firmware version number with tool output to configuration info
        """

...
class TrustedBootDCCycle(TxtBaseTest):
    ...
    STEP_DATA_DICT = {
        ...
        3: {'step_details': 'Perform dc cycle to the platform and verify Btg 5 enabled and platform boot '
                            'trusted',
            'expected_results': 'Btg 5 verified and Platform has Booted Trusted Successfully'},
        4: {'step_details': 'dc cycle and verify platform boot to trusted',
            'expected_results': 'Platform has Booted Trusted Successfully'}}
    ...
    def add_arguments(cls, parser):
        ...
        :return: None
        """
        super(TrustedBootDCCycle, cls).add_arguments(parser)
    ...
    def execute(self):
        ...
        if self.bootguard:
            ...
            self.cycling_common.trigger_txt_cycles_with_bootguard(self.total_tboot_DC_cycle_number,

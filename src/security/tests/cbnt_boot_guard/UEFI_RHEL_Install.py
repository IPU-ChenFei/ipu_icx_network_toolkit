...
class UEFIRHELInstall(TxtBaseTest):
    ...
    def execute(self):
        ...
        self.os.system("python paiv_rhel_os_offline_installation.py --LOCAL_OS_PACKAGE_LOCATION C:\os_package\%s.zip "%os_name)
        ...
        self._log.info("Copy intel-yum.repo from the Files tab to /etc/yum.repos.d "
                       "(use yum-intel.repo.rhel8 if installing RHEL8 and rename to intel-yum.repo) "

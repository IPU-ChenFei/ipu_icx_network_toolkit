...
class SGXVerifyPSWInstallation(content_base_test_case.ContentBaseTestCase):
    """
    Glasgow ID : G62117.3-Verify PSW is installed
    HPALM ID : H80100-PI_Security_SGX_Verify_PSW_installed_L
               H81528-PI_Security_SGX_Verify_PSW_installed_W
    ...
    For Linux:
    After initial configuration setup, cd into the SGXFunctionalValidation directory and run the following command line (FVT test):
    ...
    TEST_CASE_ID = ["G62117.3", "Verify_PSW_is_installed", "H80100", "PI_Security_SGX_Verify_PSW_installed_L",
                    "H81528", "PI_Security_SGX_Verify_PSW_installed_W"]

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of SGXVerifyPSWInstallation
        ...
        super(SGXVerifyPSWInstallation, self).__init__(
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(SGXVerifyPSWInstallation, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(SGXVerifyPSWInstallation, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SGXVerifyPSWInstallation.main()

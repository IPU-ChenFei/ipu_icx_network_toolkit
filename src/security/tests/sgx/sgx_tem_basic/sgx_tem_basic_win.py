...
class SGXTEMBasicWin(content_base_test_case.ContentBaseTestCase):
    """
    HPALM ID : H65961/H81540
    Enable SGX bios and install sgx in windows sut app acheck sgx_app test results and all tests should be passed
    """
    BIOS_CONFIG_FILE = "../sgx_enable_through_bios.cfg"
    TEST_CASE_ID = ["H65961", "PI_Security_SGX_TEM_BasicTest_W", "H81540", "PI_SGX_TEM_BasicTest_W"]

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of SGXTEMBasicWin
        ...
        super(SGXTEMBasicWin, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path=bios_config_file)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(SGXTEMBasicWin, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SGXTEMBasicWin.main() else Framework.TEST_RESULT_FAIL)

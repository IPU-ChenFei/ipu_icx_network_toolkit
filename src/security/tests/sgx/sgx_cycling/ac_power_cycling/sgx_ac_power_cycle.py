...
class SGXAcPowerCycle(SGXCyclingCommon):
    """
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new SGXAcPowerCycle object

        :param test_log: Used for debug and info messages
        :param arguments:
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(SGXAcPowerCycle, self).__init__(test_log, arguments, cfg_opts)
        self.total_sgx_ac_cycle_number, self.ac_cycle_recovery_mode = \
            self._common_content_configuration.get_sgx_num_of_cycles(self._AC_CYCLE)
    ...
    def prepare(self):
        ...
        """
        super(SGXAcPowerCycle, self).prepare()
    ...
    def execute(self):
        ...
        self.trigger_sgx_cycle(self.total_sgx_ac_cycle_number, self.sgx_cycle_type[self._AC_CYCLE],
                               ac_cycle_str, self.ac_cycle_recovery_mode)
        return True


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SGXAcPowerCycle.main() else Framework.TEST_RESULT_FAIL)

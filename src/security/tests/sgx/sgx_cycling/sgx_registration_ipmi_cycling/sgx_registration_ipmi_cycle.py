...
class SGXRegistrationIPMICycle(SGXCyclingCommon):
    """
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new SGXRegistrationIPMICycle object
        ...
        super(SGXRegistrationIPMICycle, self).__init__(test_log, arguments, cfg_opts)
        ...
        self.total_sgx_ipmi_cycle_number, self.ipmi_cycle_recovery_mode = \
            self._common_content_configuration.get_sgx_num_of_cycles(self._IPMI_CYCLE_REG)
    ...
    def get_bmc_details(self):
        """
        Gets the details of the BMC Ip , username and password from System configuration.xml file
        ...
        try:
            ...
            raise content_exceptions.TestSetupError("DTAF System config file is not populated with BMC "
    ...
    def download_ipmi_tool(self):
        ...
        try:
            ...
            raise content_exceptions.TestSetupError("Unable to download IPMI tool {}".format(e))
    ...
    def execute(self):
        ...
        self.trigger_sgx_cycle(self.total_sgx_ipmi_cycle_number, self.sgx_cycle_type[self._IPMI_CYCLE],
                               ipmi_cycle_str, self.ipmi_cycle_recovery_mode, True)
        return True


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SGXRegistrationIPMICycle.main() else Framework.TEST_RESULT_FAIL)

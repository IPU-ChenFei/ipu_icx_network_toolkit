...
class UCErrorEpcMetadata(SgxErrorInjectionBaseTest):
    TEST_CASE_ID: List[str] = ["18014072230", "Uncorrectable single-bit error injection in EPC memory holding XuCode/metadata"]
    ...
    def execute(self) -> bool:
        ...
        try:
            ...
            raise content_exceptions.TestFail("Failed to inject error")

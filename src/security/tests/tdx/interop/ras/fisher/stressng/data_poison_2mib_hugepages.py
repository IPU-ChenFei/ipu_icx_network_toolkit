...
class TdxDataPoisonTwoMiBHugePages(TdxRasFisherBaseTest):
    """
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        :return: None
        """
        super(TdxDataPoisonTwoMiBHugePages, self).__init__(test_log, arguments, cfg_opts)
        ...
        self.fisher_command = "fisher --workload=\"stress-ng --stream 0 --stream-madvise hugepage --verify " \
                              "--timeout 5m\" --injection-type=memory-uncorrectable-non-fatal " \
                              f"--match=DRd --workload-exit-code=0,2 --runtime={self.run_time}h"
        self.pass_ratio = 0.8
        self.bios_knobs = ["fisher_poison_knobs.cfg"]


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if TdxDataPoisonTwoMiBHugePages.main() else Framework.TEST_RESULT_FAIL)

...
##########################################################################
"""
    :TDX RAS Interop Code Poison Consumption ST:
...
class TdxCodePoisonConsumptionST(TdxRasFisherBaseTest):
    """
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        :return: None
        """
        super(TdxCodePoisonConsumptionST, self).__init__(test_log, arguments, cfg_opts)
        self.workload_name = "stress-ng"
        self.run_time = 1  # 1 hour time out
        self.fisher_command = "fisher --workload=\"stress-ng --cpu 1 --cpu-method all --verify --timeout 5m\" " \
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if TdxCodePoisonConsumptionST.main() else Framework.TEST_RESULT_FAIL)

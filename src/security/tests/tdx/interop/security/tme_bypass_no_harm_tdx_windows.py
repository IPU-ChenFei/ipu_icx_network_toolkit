...
from src.security.tests.tdx.tdvm.legacy_vm_and_td_guest_running_parallel_windows import LegacyVMAndTDVMParallelWindows


class TmeBypassNoHarmWindows(LegacyVMAndTDVMParallelWindows):
    """
            his recipe tests TD guest boot and requires the use of a OS supporting TD guests.
    ...
    def prepare(self):
        super(TmeBypassNoHarmWindows, self).prepare()
    ...
    def execute(self):
        return super(TmeBypassNoHarmWindows, self).execute()


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if TmeBypassNoHarmWindows.main() else Framework.TEST_RESULT_FAIL)

...
class SgxHydraLegacyMktmeTdGuestWindows(WindowsTdxBaseTest, SgxHydraTestWindows):
    """
            This test verifies the coexistence of an SGX enclave, legacy VM, mk-tme enabled VM
            and a TD guest on the SUT.  Paths to SGX PSW and FVT packages from BKC must be updated in
            ...
            :Test steps:
                ...
                :3:  Create and launch a TD guest, Legacy VM and mk-tme VM.
    ...
    def __init__(self, test_log: logging.Logger, arguments: argparse.Namespace, cfg_opts: ElementTree) -> None:
        ...
        """
        super(SgxHydraLegacyMktmeTdGuestWindows, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SgxHydraLegacyMktmeTdGuestWindows.main() else Framework.TEST_RESULT_FAIL)

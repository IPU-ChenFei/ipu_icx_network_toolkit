...
class Os_Installation(BaseTestCase):
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        self._direct_atf_bmc_path = arguments.atf_bmc_bmc_path  # full atf bmc_pkg path along with file name extension usually .zip
    ...
    def add_arguments(cls, parser):
        ...
        parser.add_argument('--ATF_PATH_BMC_RED_PKG', action="store", dest="atf_bmc_bmc_path", default=None,
                            help="InOrder TO Directly Download Ifwi-Package From ATF Make It True,by Default False")

...
class Os_Installation(BaseTestCase):
    ...
    def add_arguments(cls, parser):
        ...
        parser.add_argument('--RHEL_CFG_FILE_NAME', action="store", dest="post_os_automation_enabler_rhel",
                            default="rh8.4-uefi.cfg",
                            help="CFG file in Software Package will be Additionally Added with AutomationEnabler Functionality ,Please Give the correct CFG file,by default is rh8.4-uefi.cfg for RHEL")
            ...
            if (path.exists(Dnd_sft_path) == True):
                ...
                if (Extract == True):
                    ...
                    try:
                        ...
                        for i in range(0,2):
                            self._log.info("Replacing Software Packages Extraction {0} time".format(i))

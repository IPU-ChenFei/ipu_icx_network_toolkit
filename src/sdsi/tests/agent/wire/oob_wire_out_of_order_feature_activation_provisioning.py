...
class OobWireOutOfOrderFeatureActivationProvisioning(IbOutOfOrderFeatureActivationProvisioning):
    """
...
if __name__ == "__main__":
    sys.exit(not OobWireOutOfOrderFeatureActivationProvisioning.run())

...
from src.sdsi.tests.agent.qat.ib_provisioning_qat4_func_upgrade_and_rtb import IbQAT4FuncProvisionAndRTB


class OobQAT4FuncProvisionAndRTB(IbQAT4FuncProvisionAndRTB):
    """
...
if __name__ == "__main__":
    sys.exit(not OobQAT4FuncProvisionAndRTB.run())

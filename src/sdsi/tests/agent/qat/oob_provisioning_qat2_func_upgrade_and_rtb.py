...
from src.sdsi.tests.agent.qat.ib_provisioning_qat2_func_upgrade_and_rtb import IbQAT2FuncProvisionAndRTB


class OobQAT2FuncProvisionAndRTB(IbQAT2FuncProvisionAndRTB):
    """
...
if __name__ == "__main__":
    sys.exit(not OobQAT2FuncProvisionAndRTB.run())

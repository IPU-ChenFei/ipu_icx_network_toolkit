...
from src.sdsi.tests.agent.qat.ib_provisioning_qat4_func_upgrade_single_socket import IbQAT4FuncProvisionSingleSocket


class OobQAT4FuncProvisionSingleSocket(IbQAT4FuncProvisionSingleSocket):
    """
...
if __name__ == "__main__":
    sys.exit(not OobQAT4FuncProvisionSingleSocket.run())

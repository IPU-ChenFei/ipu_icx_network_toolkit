...
class IbDlb4FuncProvisionAndRTB(SDSiBaseTestCase):
    """
    Verify that DLB devices work only after applying the DLB4 licenses (except default devices)
    """
    ...
    def execute(self) -> None:
        ...
        # Verify DLB4 devices are numerated.
        self._log.info("Verify DLB4 devices are enumerated after applying capability payload")
...
if __name__ == "__main__":
    sys.exit(not IbDlb4FuncProvisionAndRTB.run())

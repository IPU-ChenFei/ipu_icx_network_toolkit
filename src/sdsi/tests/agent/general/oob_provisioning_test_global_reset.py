...
from src.sdsi.tests.agent.general.ib_provisioning_test_global_reset import IbProvisioningTestGlobalReset


class OobProvisioningTestGlobalReset(IbProvisioningTestGlobalReset):
    """
...
if __name__ == "__main__":
    sys.exit(not OobProvisioningTestGlobalReset.run())

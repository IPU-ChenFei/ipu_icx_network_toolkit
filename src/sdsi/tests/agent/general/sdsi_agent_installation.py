...
class SDSiAgentInstallation(SDSiBaseTestCase):
    """
    Verify the installation of the SDSi Agent by running the help command.
    """
...
if __name__ == "__main__":
    sys.exit(not SDSiAgentInstallation.run())

...
from src.sdsi.tests.agent.general.ib_provisioning_warm_reset import IbProvisioningWarmReset


class OobProvisioningWarmReset(IbProvisioningWarmReset):
    """
...
if __name__ == "__main__":
    sys.exit(not OobProvisioningWarmReset.run())

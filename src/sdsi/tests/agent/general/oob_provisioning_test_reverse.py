...
from src.sdsi.tests.agent.general.ib_provisioning_test_reverse import IbProvisioningTestReverse


class OobProvisioningTestReverse(IbProvisioningTestReverse):
    """
...
if __name__ == "__main__":
    sys.exit(not OobProvisioningTestReverse.run())

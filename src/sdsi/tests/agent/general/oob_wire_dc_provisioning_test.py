...
from src.sdsi.tests.agent.general.ib_dc_provisioning_test import InBandDCProvisioningTest


class OobWireDCProvisioningTest(InBandDCProvisioningTest):
    """
...
if __name__ == "__main__":
    sys.exit(not OobWireDCProvisioningTest.run())

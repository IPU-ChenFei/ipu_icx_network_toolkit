...
from src.sdsi.tests.agent.general.ib_upgrade_limit_per_boot_verification import IbUpgradeLimitPerBootVerification


class OobUpgradeLimitPerBootVerification(IbUpgradeLimitPerBootVerification):
    """
...
if __name__ == "__main__":
    sys.exit(not OobUpgradeLimitPerBootVerification.run())

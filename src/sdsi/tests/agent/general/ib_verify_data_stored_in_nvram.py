...
class IbVerifyDataStoredInNvram(SDSiBaseTestCase):
    """
    ...
    def execute(self) -> None:
        ...
        for socket in range(self.sdsi_agent.num_sockets):
            self._log.info(f'Write a payload configuration to the SUT for socket {socket}.')
...
if __name__ == "__main__":
    sys.exit(not IbVerifyDataStoredInNvram.run())

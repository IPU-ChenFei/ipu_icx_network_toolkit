...
from src.sdsi.tests.agent.sgx.ib_provisioning_sgx512_rtb_repeat import IbProvisioningSgx512RTBRepeat


class OobProvisioningSgx512RTBRepeat(IbProvisioningSgx512RTBRepeat):
    """
...
if __name__ == "__main__":
    sys.exit(not OobProvisioningSgx512RTBRepeat.run())

...
from src.sdsi.tests.agent.sgx.ib_provisioning_sgx256_unsupported_cap import IbSGXUnsupportedCap


class OobSGXUnsupportedCap(IbSGXUnsupportedCap):
    """
...
if __name__ == "__main__":
    sys.exit(not OobSGXUnsupportedCap.run())

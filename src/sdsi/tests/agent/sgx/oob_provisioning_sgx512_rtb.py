...
from src.sdsi.tests.agent.sgx.ib_provisioning_sgx512_rtb import IbProvisioningSgx512RTB


class OobProvisioningSgx512RTB(IbProvisioningSgx512RTB):
    """
...
if __name__ == "__main__":
    sys.exit(not OobProvisioningSgx512RTB.run())

...
from src.sdsi.tests.agent.negative.ib_provisioning_previous_feature_activation_payload import \
    IbProvisioningPreviousFeatureActivationPayload


class OobProvisioningPreviousFeatureActivationPayload(IbProvisioningPreviousFeatureActivationPayload):
    """
...
if __name__ == "__main__":
    sys.exit(not OobProvisioningPreviousFeatureActivationPayload.run())

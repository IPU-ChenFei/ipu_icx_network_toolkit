...
from src.sdsi.tests.agent.negative.ib_multi_socket_provisioning_single_socket_support import \
    IbMultiSocketProvisioningSingleSocketSupport


class OobMultiSocketProvisioningSingleSocketSupport(IbMultiSocketProvisioningSingleSocketSupport):
    """
...
if __name__ == "__main__":
    sys.exit(not OobMultiSocketProvisioningSingleSocketSupport.run())

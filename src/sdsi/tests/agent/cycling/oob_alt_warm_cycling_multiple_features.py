...
class OobAltWarmCyclingMultipleFeatures(SDSiBaseTestCase):
    """
    Verify that a system can perform warm system reset cycles including OS boot and shutdown without unexpected errors.
    Platform maintains initial configuration settings and Soft Sku provisioning, and system does not fail with any
    unexpected error conditions.
    """
    WARM_CYCLE_COUNT = 1000
...
if __name__ == "__main__":
    sys.exit(not OobAltWarmCyclingMultipleFeatures.run())

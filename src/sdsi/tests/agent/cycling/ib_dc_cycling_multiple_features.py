...
class IbDcCyclingMultipleFeatures(SDSiBaseTestCase):
    """
    ...
    def execute(self) -> None:
        ...
        for cycle in range(self.DC_CYCLE_COUNT):
            self._log.info(f'Performing DC cycle #{cycle}, then validating expected provisioning.')
...
if __name__ == "__main__":
    sys.exit(not IbDcCyclingMultipleFeatures.run())

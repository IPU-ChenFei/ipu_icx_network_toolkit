...
class IbIAA4FuncProvisionAndRTB(SDSiBaseTestCase):
    """
    Verify that IAA devices work only after applying the IAA4 licenses (except default devices)
    """
    ...
    def execute(self) -> None:
        ...
        # Verify IAA4 devices are numerated.
        self._log.info("Verify IAA4 devices are enumerated after applying capability payload")
...
if __name__ == "__main__":
    sys.exit(not IbIAA4FuncProvisionAndRTB.run())

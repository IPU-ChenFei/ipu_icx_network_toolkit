...
from src.sdsi.tests.agent.iaa.ib_provisioning_iaa2_func_upgrade_and_rtb import IbIAA2FuncProvisionAndRTB


class OobIAA2FuncProvisionAndRTB(IbIAA2FuncProvisionAndRTB):
    """
...
if __name__ == "__main__":
    sys.exit(not OobIAA2FuncProvisionAndRTB.run())

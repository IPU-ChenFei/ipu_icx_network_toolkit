...
from src.sdsi.tests.agent.mixed.ib_functional_provision_different_revs_mixed import IbProvisionDifferentRevsMixed


class OobProvisionDifferentRevsMixed(IbProvisionDifferentRevsMixed):
    """
...
if __name__ == "__main__":
    sys.exit(not OobProvisionDifferentRevsMixed.run())

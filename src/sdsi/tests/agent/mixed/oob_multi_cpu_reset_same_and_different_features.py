...
from src.sdsi.tests.agent.mixed.ib_multi_cpu_reset_same_and_different_features import \
    IbMultiCpuResetSameAndDifferentFeatures


class OobMultiCpuResetSameAndDifferentFeatures(IbMultiCpuResetSameAndDifferentFeatures):
    """
...
if __name__ == "__main__":
    sys.exit(not OobMultiCpuResetSameAndDifferentFeatures.run())

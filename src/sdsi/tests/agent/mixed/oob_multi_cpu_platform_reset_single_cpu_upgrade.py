...
from src.sdsi.tests.agent.mixed.ib_multi_cpu_platform_reset_single_cpu_upgrade import IbMultiCpuResetSingleCpuUpgrade


class OobMultiCpuResetSingleCpuUpgrade(IbMultiCpuResetSingleCpuUpgrade):
    """
...
if __name__ == "__main__":
    sys.exit(not OobMultiCpuResetSingleCpuUpgrade.run())

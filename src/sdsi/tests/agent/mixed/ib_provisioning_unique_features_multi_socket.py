...
class IbProvisionUniqueFeaturesMultiSocket(SDSiBaseTestCase):
    """
    ...
    def execute(self) -> None:
        ...
        # Install different features on different sockets [DSA4], [DLB4].
        socket_0_features = self.sdsi_agent.apply_lac_by_name(0, [FeatureNames.DSA4.value])
...
if __name__ == "__main__":
    sys.exit(not IbProvisionUniqueFeaturesMultiSocket.run())

...
from src.sdsi.tests.agent.mixed.ib_multiple_feature_bundles_rtb import IbMultipleFeatureBundlesRTB


class OobMultipleFeatureBundlesRTB(IbMultipleFeatureBundlesRTB):
    """
...
if __name__ == "__main__":
    sys.exit(not OobMultipleFeatureBundlesRTB.run())

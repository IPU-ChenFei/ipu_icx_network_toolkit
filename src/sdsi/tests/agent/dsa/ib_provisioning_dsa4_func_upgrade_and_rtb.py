...
class IbDSA4FuncProvisionAndRTB(SDSiBaseTestCase):
    """
    Verify that DSA devices work only after applying the DSA4 licenses (except default devices)
    """
    ...
    def execute(self) -> None:
        ...
        # Verify DSA4 devices are numerated.
        self._log.info("Verify DSA4 devices are enumerated after applying capability payload")
...
if __name__ == "__main__":
    sys.exit(not IbDSA4FuncProvisionAndRTB.run())

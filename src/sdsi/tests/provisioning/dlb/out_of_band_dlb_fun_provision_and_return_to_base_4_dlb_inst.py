...
class OutOfBandDLBProvisionAndReturnToBaseFourDlbInst(SDSI_DLB_Base_Class):
    """
    Glasgow_ID: 70169
    Phoenix_ID: 18014074781
    Expectation is that DLB/HQM devices should works only after applying the HQM4 licenses.
    """
    ...
    HQM_PAYLOAD_NAME_TO_ENABLE = "HQM4"

    #socket_0_din0, socket_0_din1, socket_0_din2, socket_0_din3,
    #socket_1_din0, socket_1_din1, socket_1_din2, socket_1_din3
    dlb_pcie_device_ids_list = ["6d:00.0", "7c:00.0", "72:00.0", "77:00.0",
                                "ea:00.0", "f9:00.0", "ef:00.0", "f4:00.0"]
    hqm_bios_name_list = ["HqmEn_0", "HqmEn_1","HqmEn_2", "HqmEn_3","HqmEn_4", "HqmEn_5","HqmEn_6", "HqmEn_7"]
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        self._log.info("OutOfBandDLBProvisionAndReturnToBaseFourDlbInst::prepare")
        super().prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if OutOfBandDLBProvisionAndReturnToBaseFourDlbInst.main()

...
class InBandDLBProvisionAndReturnToBaseOneDlbInst(SDSI_DLB_Base_Class):
    """
    Glasgow_ID: 74721
    Phoenix_ID: 22013944913
    Expectation is that DLB/HQM devices should works only after applying the HQM1 licenses.
    """
    ...
    HQM_PAYLOAD_NAME_TO_ENABLE = "HQM1"

    # socket_0_din0, socket_1_din0
    dlb_pcie_device_ids_list = ["6d:00.0", "ea:00.0"]
    hqm_bios_name_list=["HqmEn_0","HqmEn_4"]
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        self._log.info("OutOfBandDLBProvisionAndReturnToBaseOneDlbInst::prepare")
        super().prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if InBandDLBProvisionAndReturnToBaseOneDlbInst.main()

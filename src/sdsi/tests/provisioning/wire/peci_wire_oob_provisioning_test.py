...
class OutOfBandProvisioningTest(ContentBaseTestCase):
    """
    Glasgow_ID: 77505
    Phoenix_ID: 22014730898
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(OutOfBandProvisioningTest, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(OutOfBandProvisioningTest, self).prepare()
    ...
    def execute(self):
        """
            ...
            4. Write a random capability activation payload to the CPU. Write to the sockets in numerical order.
    ...
    def cleanup(self, return_status):
        ...
        """DTAF cleanup"""
        self.perform_graceful_g3()
        super(OutOfBandProvisioningTest, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if OutOfBandProvisioningTest.main()

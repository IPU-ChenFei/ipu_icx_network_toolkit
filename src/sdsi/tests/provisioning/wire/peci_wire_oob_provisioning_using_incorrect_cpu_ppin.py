...
class OutOfBandProvisioningUsingIncorrectCpuPpin(ContentBaseTestCase):
    """
    Glasgow_ID: 70142
    Phoenix_ID: NA - MCTP: 18014075172
    This test is to verify the platform behavior when attempting to apply a license to an incorrect CPU PPIN via OOB
    """
    _INCORRECT_CPU_PPIN_PAYLOAD = "084DE64A6F06E13D_key_id_1_rev_11_SSTE.bin"

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of OutOfBandProvisioningUsingIncorrectCpuPpin

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(OutOfBandProvisioningUsingIncorrectCpuPpin, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(OutOfBandProvisioningUsingIncorrectCpuPpin, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(OutOfBandProvisioningUsingIncorrectCpuPpin, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if OutOfBandProvisioningUsingIncorrectCpuPpin.main()

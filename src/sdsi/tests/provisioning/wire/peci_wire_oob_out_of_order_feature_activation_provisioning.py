...
class PeciWireOobOutOfOrderFeatureActivationProvisioning(InBandSDSiInstallerOutOfOrderFeatureActivationProvisioning):
    """
    Glasgow_ID: NA
    Phoenix_ID: NA - MCTP: 22012923587
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PeciWireOobOutOfOrderFeatureActivationProvisioning.main()

...
class InBandProvisioningWarmReset(ContentBaseTestCase):
    """
    Glasgow_ID: 75094
    Phoenix_ID: 22013745930
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of InBandProvisioningWarmReset

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(InBandProvisioningWarmReset, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(InBandProvisioningWarmReset, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(InBandProvisioningWarmReset, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if InBandProvisioningWarmReset.main()

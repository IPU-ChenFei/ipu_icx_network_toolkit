...
class OobProvisioningSgx512RTBRepeat(OutOfBandSdsiSgxCommon):
    """
    Glasgow_ID: 70021
    Phoenix_ID: 18014074924
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(OobProvisioningSgx512RTBRepeat, self).__init__(test_log, arguments, cfg_opts)

    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(OobProvisioningSgx512RTBRepeat, self).prepare()
    ...
    def execute(self):
        ...
        for _test_repeat in range(2):
            ...
            if self.set_and_validate_prm_size(self.prm_size_to_apply[FeatureNames.SG40.value]):
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(OobProvisioningSgx512RTBRepeat, self).cleanup(return_status)

if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if OobProvisioningSgx512RTBRepeat.main()

...
class SDSiSGXUnsupportedCap(InBandSdsiSgxCommon):
    """
    Glasgow_ID: 75517
    Phoenix_ID: 22013738499
    ...
    def execute(self):
        ...
        self.perform_and_validate_sgx_operation(FeatureNames.SG20)
        if not self.set_and_validate_prm_size(self.prm_size_to_apply[FeatureNames.SG20]):

...
class IbProvisioningSgx512RTB(InBandSdsiSgxCommon):
    """
    Glasgow_ID: 70598
    Phoenix_ID: 18014074412
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(IbProvisioningSgx512RTB, self).__init__(test_log, arguments, cfg_opts)

    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(IbProvisioningSgx512RTB, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(IbProvisioningSgx512RTB, self).cleanup(return_status)

if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if IbProvisioningSgx512RTB.main()

...
class InBandSDSIVerifyDataStoredInS3MNvram(ContentBaseTestCase):
    """
    Glasgow_ID: 71745
    Phoenix_ID: 22013642717
    Verifies that the SDSI NVRAM Data Structure for each populated CPU contains data as expected after provisioning.
    The OOB-MSM driver will need to be configured to load on every OS boot since our content includes system resets.
    """

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of InBandSDSIVerifyDataStoredInS3MNvram

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(InBandSDSIVerifyDataStoredInS3MNvram, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(InBandSDSIVerifyDataStoredInS3MNvram, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(InBandSDSIVerifyDataStoredInS3MNvram, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if InBandSDSIVerifyDataStoredInS3MNvram.main()

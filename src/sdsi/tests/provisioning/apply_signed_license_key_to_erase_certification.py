...
class ApplySignedLicenseKeyToEraseEertification(ContentBaseTestCase):
    """
    Glasgow_ID: 69599
    Phoenix_ID: 18014075585
    Using OOB Terminal, Use SDSi SW to Apply a License Erase Certification Key and verify
    the CPU provisioning information stored in NVRAM is deleted.
    """

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of ApplySignedLicenseKeyToEraseEertification

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(ApplySignedLicenseKeyToEraseEertification, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(ApplySignedLicenseKeyToEraseEertification, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(ApplySignedLicenseKeyToEraseEertification, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if ApplySignedLicenseKeyToEraseEertification.main()

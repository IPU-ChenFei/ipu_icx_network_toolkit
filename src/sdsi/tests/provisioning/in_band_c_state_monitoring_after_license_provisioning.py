...
class InBandCStateMonitoring(ContentBaseTestCase):
    """
    Glasgow_ID: 69435
    Phoenix_ID: 22013734218
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of InBandCStateMonitoring

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(InBandCStateMonitoring, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(InBandCStateMonitoring, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        self.perform_graceful_g3()
        super(InBandCStateMonitoring, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if InBandCStateMonitoring.main()

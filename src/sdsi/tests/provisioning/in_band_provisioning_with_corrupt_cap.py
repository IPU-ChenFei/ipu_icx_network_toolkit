...
class InBandProvisioningWithCorruptCap(ContentBaseTestCase):
    """
    Glasgow_ID: 75098
    Phoenix_ID: 22013642595
    This test case is to verify the In Band provisioning of the SSKU enabled CPU by applying the license key
    certificate, and a capability activation payload and verify it is available.
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(InBandProvisioningWithCorruptCap, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(InBandProvisioningWithCorruptCap, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(InBandProvisioningWithCorruptCap, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if InBandProvisioningWithCorruptCap.main()

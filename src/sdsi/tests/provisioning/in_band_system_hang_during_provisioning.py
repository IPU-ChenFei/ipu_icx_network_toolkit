...
class InBandSystemHang(ContentBaseTestCase):
    """
    Glasgow_ID: 75405
    Phoenix_ID: 22013768611
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of InBandSystemHang

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(InBandSystemHang, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(InBandSystemHang, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        self.perform_graceful_g3()
        super(InBandSystemHang, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if InBandSystemHang.main()

...
class SDSIApplyLicenseWithCorruptKeySignature(ContentBaseTestCase):
    """
    Glasgow_ID: 69276
    Phoenix_ID: 18014074351
    This test case verifies that a feature is not activated when license provisioning is attempted using an authentication key with a modified public key (customer) signature on a CPU that supports Soft Sku.
    Provisioning should be disallowed.
    """
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(SDSIApplyLicenseWithCorruptKeySignature, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(SDSIApplyLicenseWithCorruptKeySignature, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(SDSIApplyLicenseWithCorruptKeySignature, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SDSIApplyLicenseWithCorruptKeySignature.main()

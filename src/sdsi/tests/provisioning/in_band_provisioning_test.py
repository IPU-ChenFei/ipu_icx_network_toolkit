...
class InBandProvisioningTest(ContentBaseTestCase):
    """
    Glasgow_ID: 70139
    Phoenix_ID: 18014074639
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(InBandProvisioningTest, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        # type: () -> None
        """preparing the setup"""
        super(InBandProvisioningTest, self).prepare()
    ...
    def execute(self):
        ...
        for cpu_counter in range(self._sdsi_obj.number_of_cpu):
            ...
            # self._log.info("Apply a payload configuration to the SUT for CPU {}.".format(cpu_counter))
            # payload_name = self._sdsi_obj.apply_capability_activation_payload(socket=cpu_counter)
        ...
        self._log.info("Performing greaceful shutdown")
    ...
    def cleanup(self, return_status):
        ...
        self.perform_graceful_g3()
        super(InBandProvisioningTest, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if InBandProvisioningTest.main()

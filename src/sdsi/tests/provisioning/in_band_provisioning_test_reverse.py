...
class InBandProvisioningTestReverse(ContentBaseTestCase):
    """
    Glasgow_ID: 75576
    Phoenix_ID: 22013767530
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(InBandProvisioningTestReverse, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(InBandProvisioningTestReverse, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        """DTAF cleanup"""
        self.perform_graceful_g3()
        super(InBandProvisioningTestReverse, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if InBandProvisioningTestReverse.main()

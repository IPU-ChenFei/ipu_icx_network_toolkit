...
from src.sdsi.tests.provisioning.in_band_sdsi_upgrade_limit_per_boot_verification import \
    InBandSDSiUpgradeLimitPerBootVerification


class SDSiUpgradeLimitPerBootVerification(InBandSDSiUpgradeLimitPerBootVerification):
    """
    SDSi - SoftSku Upgrade Limit Per Boot Verification - OOB
    Glasgow_ID: 70589
    Phoenix_ID: 18014075614
    """
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if SDSiUpgradeLimitPerBootVerification.main()

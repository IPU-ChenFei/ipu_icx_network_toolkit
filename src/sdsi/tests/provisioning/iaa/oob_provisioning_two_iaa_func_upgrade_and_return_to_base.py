...
from src.sdsi.tests.provisioning.iaa.ib_provisioning_two_iaa_func_upgrade_and_return_to_base import \
    InBandTwoIAAFuncProvisionAndReturnToBase


class OutOfBandTwoIAAFuncProvisionAndReturnToBase(InBandTwoIAAFuncProvisionAndReturnToBase):
    """
    Glasgow_ID: 74642

...
def test_steps(sut, my_os):
    ...
    try:
        ...
        ret, _ ,_ = sut.execute_shell_cmd('echo 0x100 > error_type', cwd='/sys/kernel/debug/apei/einj')
        ...
        ret_1, stdout, _ = sut.execute_shell_cmd('dmesg |grep -i Error')
        Case.expect('Check error', 'Fatal' in stdout)

...
CASE_DESC = [
    # TODO
    'Basic LAN IPv4 Ping with Link Partner',
...
def test_steps(sut, my_os):
    ...
    try:
        ...
        # Step1 - Get IP from DHCP for XHC
        Case.step('Get IP from DHCP for XHC and ping from XHC to DHCP server')
        mev.pass_xhc_traffic()
        Case.expect('ping to IPv4 DHCP server successfully.', MEVOp.ping_to_dhcp(mev.xhc, mode='ipv4'))

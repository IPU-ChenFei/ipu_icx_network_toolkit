...
CASE_DESC = [
    ...
    'Run cpa_sample_code with the sign of life option ',
]
...
def test_steps(sut, my_os):
    ...
    # Step 2 - Run cpa_sample_code with the sign of life option
    Case.step('Run cpa_sample_code with the sign of life option')

...
def test_steps(sut, my_os):
    ...
    dlb_vf_list_list = esxi_rich.create_multi_device_vf('dlb', dlb_device_num, 5)
    esxi_rich.attach_vfs_rich_vm('dlb', dlb_vf_list_list)
    ...
    esxi_rich.check_device_in_rich_vm(esxi, 'dlb', 5)

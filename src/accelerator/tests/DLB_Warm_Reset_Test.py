...
CASE_DESC = [
    'perform Warm Reset on EGS-SPR Platform while running load balancing traffic example of DLB driver.'
]
...
def test_steps(sut, my_os):
    ...
    # Step 3 - Run ldb_traffic example on the PF with warm reset

...
def test_steps(sut, my_os):
    ...
    # Step 1
    Case.step('Check QAT device and clear abort log')
    ...
    # Step 2
    Case.step('Uninstall QAT driver and install QAT driver')
    acce.qat_uninstall()
    ...
    # Step 3
    Case.step('Modefy QAT config file and run qat,fio stress')

...
def test_steps(sut, my_os):
    ...
    # Step 3 - Run Device Reset Cycling Script.
    Case.step('Run Device Reset Cycling Script.')
    acce.acce_random_test('iax_device_wq_reset.sh -d 2')

    # Step 4 - check logs and Uninstall accel config tool

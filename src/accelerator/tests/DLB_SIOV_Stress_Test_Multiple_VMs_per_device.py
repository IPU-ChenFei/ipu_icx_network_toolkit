...
def test_steps(tcd):
    ...
    if tcd.prepare("setup system for test"):
        ...
        sutos.execute_cmd(sut, f'cd $API_SCRIPT && python3 $API_SCRIPT/vm_img_copy.py -d \'dlb\' -s \'16\' -g \'2\' -f $CENTOS_IMG_NAME', timeout=60*60)
    ...
    if tcd.step("Start VM using QEMU:"):
        ...
        sutos.execute_cmd(sut, f'cd $API_SCRIPT && python3 $API_SCRIPT/resource_config_login.py -d \'dlb\' -s \'16\' -g \'2\'', timeout=60*60)

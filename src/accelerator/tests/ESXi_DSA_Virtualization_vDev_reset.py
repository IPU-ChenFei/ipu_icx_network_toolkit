...
CASE_DESC = [
    'Verify DSA device is available in guest VM after a reset.  '
]
...
def test_steps(sut, my_os):
    ...
    # precondition case: step 1 - Check iadx device in VMware OS
    ...
    # precondition case: step 2 - Configure device passthrough
    esxi.passthrough_conf('dsa', vm_name0)
    esxi.passthrough_memory_conf(memsize, vm_name0)

    # precondition case: step 3 - Re-register and Power-on guest VM

...
def test_steps(sut, my_os):
    ...
    Case.prepare('Enable sgx in BIOS and install rpm package')
    logger.info('')
    ...
    # Step 4 - Install sgx driver and run sgx sampleenclave test
    Case.step('Install sgx driver and run sgx sampleenclave test')

...
def test_steps(sut, my_os):
    ...
    # step 1 - Install kernel server devel and yum
    Case.step('Install kernel header devel devel and rpm install')
    ...
    # Step 3 - QAT driver install
    Case.step('QAT driver install')
    acce.qat_install(False)

    # Step 4 - check cpa_sample_code file generate
    Case.step('check cpa_sample_code file generate')

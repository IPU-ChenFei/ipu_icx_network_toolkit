...
def test_steps(sut, my_os):
    ...
    esxi.attach_vf_to_guest(vm_name0,'qat', vf_id_list[0])
    ...
    _,out,_ = esxi.execute_vm_cmd(vm_name0, f'service qat_service status')

...
def test_steps(sut, my_os):
    ...
    sut.execute_shell_cmd_async('./QAT_Linux_OpenSSL_Speed_Test_Script_Asymmetric.sh > openssl_asym_async.log', timeout=30 * 60, cwd=f'{QAT_ASYM_PATH_L}')
    acce.dlb_stress()

    # Step 9 -catch prime95 async test log
    ...
    # Step 10 -catch qatzip async test log
    ...
    # Step 11 -catch QAT asym async test log
    ...
    # Step 12 - Clear test environment

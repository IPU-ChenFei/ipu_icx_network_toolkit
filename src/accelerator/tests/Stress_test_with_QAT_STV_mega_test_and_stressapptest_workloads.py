...
def test_steps(sut, my_os):
    ...
    acce.check_qat_service_status(False)
    ...
    # Step 4 - Run stressapptest stress
    Case.step('Run stressapptest stress')
    acce.stressapptest_stress()

    # Step 5 - Check mce error

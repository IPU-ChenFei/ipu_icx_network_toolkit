...
def test_steps(sut, my_os):
    ...
    # step 1 - Check QAT device in VMware OS
    Case.step('Check QAT device in VMware OS')
    sut.execute_shell_cmd(f'esxcfg-module -u qat', timeout=60)
    sut.execute_shell_cmd(f'esxcli software component remove -n Intel-qat', timeout=60)
    acce.check_acce_device_esxi('qat', cpu_num)
    ...
    # step 3 - Uninstall QAT driver
    Case.step('Uninstall QAT driver')

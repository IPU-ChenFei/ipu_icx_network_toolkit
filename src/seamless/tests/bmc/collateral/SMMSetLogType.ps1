...
Invoke-Command -ScriptBlock {Param($command) C:\Windows\System32\SeamlessUpdateToolbox.ps1 -sruFlow setLogType -logType $command} -ArgumentList($command) -Session $s

# -*- coding: utf-8 -*-
"""
Created on Tue Jun 16 15:16:42 2020
...
if __name__ == "__main__":
    ...
    if average_cascade_deviation*0.1 < average_max_deviation - average_cascade_deviation:
        APP_LOG.info('Test pass! Average Cascade mode deviation is lower than Max mode')
    else:
        APP_LOG.info('Test fail! Average Cascade mode deviation is larger than Max mode')
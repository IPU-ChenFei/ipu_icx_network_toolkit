...
class RdtDefineCosBitMask(content_base_test_case.ContentBaseTestCase):
    """
    HPQC ID : H79574-PI_RDT_A_CATDefineCOSBitmask_L

    This test case aims to install RDT if it not installed and
    Check possibility of defining the allocation classes with bitmask for CPU cache resources via pqos -e
    """

    TEST_CASE_ID = ["H79574-PI_RDT_A_CATDefineCOSBitmask_L"]
    COS_ARG1 = "12"
    COS_ARG2 = "13"
    COS_ARG3 = "14"
    COS_ARG1_VALUE = "0xf"
    COS_ARG2_VALUE = "0xff"
    COS_ARG3_VALUE = "0xfff"
    CHANGE_BIT_MASK_CMD = "pqos -e 'llc:{}={};llc:{}={};llc:{}={}'".format(COS_ARG1, COS_ARG1_VALUE, COS_ARG2,
                                                                           COS_ARG2_VALUE, COS_ARG3, COS_ARG3_VALUE)
    step_data_dict = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of RdtDefineCosBitMask

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(RdtDefineCosBitMask, self).__init__(test_log, arguments, cfg_opts)
    ...
    def execute(self):
        ...
        4. Change Bit mask value like: pqos -e 'llc:12=0xf;llc:13=0xff;llc:14=0xfff'
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if RdtDefineCosBitMask.main() else Framework.TEST_RESULT_FAIL)

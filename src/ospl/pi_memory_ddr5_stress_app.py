...
class PiMemoryDdr5StressApp(DDRCommon):
    ...
    step_data_dict = {1: {'step_details': 'To verify Maximum Memory population with 2DPC, Clear System and Application '
                      ...
                      2: {'step_details': 'Verify the memory displayed at POST is the amount of memory installed in '
                                          'the system.',
                          'expected_results': 'Verified POST memory with the physical memory installed in system.'},
                      3: {'step_details': 'Verify the amount of memory reported by the EDKII Menu -> System '
                                          'Information with  amount of memory installed in the system.',
                          'expected_results': 'Verified the amount of memory installed in System Information.'},
                      ...
                      5: {'step_details': 'Install latest version of stress app test and run stress for given time',
    ...
    def execute(self):
        ...
        self.verify_installed_memory_in_bios_level()
        ...
        return self._memory_common_lib.parse_log_for_error_patterns(log_path=os.path.join(log_path_to_parse,
                                                                                          self.LOG_FILE_NAME))

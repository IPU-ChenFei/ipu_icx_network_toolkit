...
class UpiLaneReceiveFailureDoubleEndAllLowLanes(UpiLaneFailoverCommon):
    """
    Glasgow_id : G58368-lane_receive_failure_double_end_all_low_lanes
    ...
    This test causes a UPI port 1 receive failure on a single link endpoint on all high lanes [7:0] and verifies the
    error is corrected and signaled to the OS as such.
    """
    TEST_CASE_ID = ["G58368", "lane_receive_failure_double_end_all_low_lanes"]
    _BIOS_CONFIG_FILE = "upi_lane_failure_bios_knobs.cfg"

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a new UpiLaneReceiveFailureDoubleEndAllLowLanes object

        :param test_log: Used for debug and info messages
        :param arguments: None
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(UpiLaneReceiveFailureDoubleEndAllLowLanes, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(UpiLaneReceiveFailureDoubleEndAllLowLanes, self).prepare()
    ...
    def execute(self):
        ...
        causes a UPI port 1 receive failure on a single link endpoint on all high lanes [7:0] and verifies the error is
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(UpiLaneReceiveFailureDoubleEndAllLowLanes, self).cleanup(return_status)
        if self.os.is_alive():
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if UpiLaneReceiveFailureDoubleEndAllLowLanes.main() else

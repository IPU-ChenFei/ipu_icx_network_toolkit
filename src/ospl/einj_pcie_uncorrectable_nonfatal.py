...
class EinjPcieUncorrectableNonFatalError(EinjCommon):
    ...
    def execute(self):
        ...
        """
        return self._ras_einj_obj.einj_inject_and_check(self._ras_einj_obj.EINJ_PCIE_UNCORRECTABLE_NONFATAL)

    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(EinjPcieUncorrectableNonFatalError, self).cleanup(return_status)
        if self.os.is_alive():

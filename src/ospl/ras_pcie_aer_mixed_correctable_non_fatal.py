...
class RasPcieAerMixedCorrNonFatalError(PcieAerCommon):
    ...
    def execute(self):
        ...
        self.DMESG_CORR_BAD_TLP_UNC_NONFATAL_COMP_ABORT_SIG.append(self.CORR_ERR_RECEIVED.format(bdf_value))
        self.DMESG_CORR_BAD_TLP_UNC_NONFATAL_COMP_ABORT_SIG.append(self.UNC_NONFATAL_ERR_RECEIVED.format(bdf_value))

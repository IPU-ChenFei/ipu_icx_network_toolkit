...
class McaRecoveryExecutionPath(McaCommon):
    """
    Glasgow_id : 59494
    Hpalm_id : 81522
    ...
    MCA Recovery execution path SRAR error.
    """
    _BIOS_CONFIG_FILE = "mca_bios_knobs.cfg"
    TEST_CASE_ID = ["G59494.0 - mca_recovery_exe_path", "H81522-PI_RAS_CPU_mca_recovery_exe_path"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(McaRecoveryExecutionPath, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
    ...
    def prepare(self):
        ...
        :return: None
        """
        super(McaRecoveryExecutionPath, self).prepare()
    ...
    def execute(self):
        ...
        """
        return self._mca_common.mca_inject_and_check(self._mca_common.RAS_MCA_EXE_PATH)

    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(McaRecoveryExecutionPath, self).cleanup(return_status)
        if self.os.is_alive():
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if McaRecoveryExecutionPath.main() else Framework.TEST_RESULT_FAIL)

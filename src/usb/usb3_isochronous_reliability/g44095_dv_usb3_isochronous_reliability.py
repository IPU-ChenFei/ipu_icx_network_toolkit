...
class USB3IsochronousReliability(ContentBaseTestCase):
    """
    Glasgow ID : G44095.4-DV-USB3-Isochronous Reliability

    Passmark: Ensure that USB 3.0 devices can use interrupt based polling without generating errors.
    """
    TEST_CASE_ID = ["G44095.4", "DV_USB3_Isochronous_Reliability"]
    STEP_DATA_DICT = {
        ...
        3: {'step_details': 'Install the USB3COnsole to execute the Passmark loopback plug and '
                            'Set Test Mode to Benchmark, Duration to 15 minutes and Endpoint Type to Isochronous (Iso)'
                            'execute Loopback testing',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of USB3IsochronousReliability

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(USB3IsochronousReliability, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(USB3IsochronousReliability, self).prepare()
    ...
    def execute(self):
        ...
        self.usb_utils.execute_passmark_loopback(self.usb_utils.MODE[1], self.usb_utils.END_POINT[1],
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if USB3IsochronousReliability.main() else Framework.TEST_RESULT_FAIL)

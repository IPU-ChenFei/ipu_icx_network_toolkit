...
class USB3BackwardCompBulkTransferReliability(ContentBaseTestCase):
    """
    Glasgow ID : G44098.2-DV-USB3-Backward Comp Bulk Transfer Reliability

    Passmark: Ensure that USB 2.0 storage devices transfers files in bulk transfer mode without generating errors.
    In backwards compatibility mode.
    """
    TEST_CASE_ID = ["G44098.2", "DV_USB3_Backward_Comp_Bulk_Transfer_Reliability"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of USB3BackwardCompBulkTransferReliability

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(USB3BackwardCompBulkTransferReliability, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(USB3BackwardCompBulkTransferReliability, self).prepare()
    ...
    def execute(self):
        ...
        2. Install the USB3COnsole to execute the Passmark loopback plug and
            Set Test Mode to Loopback, Duration to 15 minutes, Endpoint Type to Bulk and execute Loopback testing.
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if USB3BackwardCompBulkTransferReliability.main() else Framework.TEST_RESULT_FAIL)

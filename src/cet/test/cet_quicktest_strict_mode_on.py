...
class CetStrictMode(ContentBaseTestCase):

    def __init__(self, test_log, arguments, cfg_opts):
        super(CetStrictMode, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        2. Enable shadawstack strict mode"""

        self._cet_common_obj.clear_event_log()
        self._cet_common_obj.set_cet_strict_mode()
    ...
    def execute(self):
        ...
        reg_values = self._cet_common_obj.verify_Shadowstack_values()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if CetStrictMode.main() else Framework.TEST_RESULT_FAIL)

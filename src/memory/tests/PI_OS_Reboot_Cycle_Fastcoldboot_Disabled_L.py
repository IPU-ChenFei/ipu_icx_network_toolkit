...
CASE_DESC = [
    'The objective of this test case is used to reboot cycle boot flow when fast boot is disabled',
...
def test_steps(sut, my_os):
    ...
    Case.prepare('setup bios')
    boot_to_with_bios_knobs(sut, sut.default_os, *bios_knob("Attempt_Fast_Boot_disable_xmlcli"),
                            *bios_knob("Attempt_Fast_Boot_Cold_disable_xmlcli"))
    ...
    knob_str = 'WarmBoot --> ColdBoot'
    expect_str = 'subBootMode = WarmBoot --> ColdBoot'

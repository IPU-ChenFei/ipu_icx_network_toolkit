...
class StressTestRebootFastBootDis(DDRCommon):
    """
    Glasgow ID: 60841
    ...
    """
    _bios_config_file = "memory_bios_knobs_fastboot_disable.cfg"
    TEST_CASE_ID = "G60841"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(StressTestRebootFastBootDis, self).__init__(test_log, arguments, cfg_opts, self._bios_config_file)
    ...
    def prepare(self):
        ...
        self._platform_cycler_extract_path = self._install_collateral.install_platform_cycler()  # Install platform
        # cycler tool in SUT
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if StressTestRebootFastBootDis.main() else Framework.TEST_RESULT_FAIL)

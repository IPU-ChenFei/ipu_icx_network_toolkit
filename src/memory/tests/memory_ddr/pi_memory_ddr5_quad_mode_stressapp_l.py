...
class PiMemoryDdr5QuadModeStressAppLinux(ContentBaseTestCase):
    """
    pheonix id : 16014658638 - PI_Memory_DDR5_QUAD_Mode_Stressapp_L

    """

    TEST_CASE_ID = ["16014658638", "PI_Memory_DDR5_QUAD_Mode_Stressapp_L"]
    ...
    step_data_dict = {1: {'step_details': 'To Load default bios settings and set quad mode bios knob',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryDdr5QuadModeStressAppLinux object.
        ...
        super(PiMemoryDdr5QuadModeStressAppLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiMemoryDdr5QuadModeStressAppLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        """DTAF cleanup"""
        self._stress_provider.kill_stress_tool(StressAppTestConstants.STRESS_APP_TOOL_NAME, self.STRESS_APP_COMMAND)
        super(PiMemoryDdr5QuadModeStressAppLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryDdr5QuadModeStressAppLinux.main() else Framework.TEST_RESULT_FAIL)

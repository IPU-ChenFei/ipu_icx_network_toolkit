...
class StressTestShutdownFastBootEn(DDRCommon):
    """
    Glasgow ID: 57806
    ...
    """
    _bios_config_file = "dc_os_shutdown_fastboot_enable.cfg"
    TEST_CASE_ID = "G57806"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(StressTestShutdownFastBootEn, self).__init__(test_log,
                                                           arguments, cfg_opts,
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if StressTestShutdownFastBootEn.main() else Framework.TEST_RESULT_FAIL)

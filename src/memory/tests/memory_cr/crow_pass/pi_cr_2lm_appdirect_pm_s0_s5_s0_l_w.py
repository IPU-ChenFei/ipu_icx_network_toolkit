...
class PiCR2LMAppDirectPMS0S5S0(ContentBaseTestCase):
    """
    HP QC  ID: H101121-PI_CR_2LM_AppDirect_PM_S0_S5_S0_L and H101166-PI_CR_2LM_AppDirect_PM_S0_S5_S0_W

    To check system power sequence with 1LM CR: so->s5->s0
    """

    TEST_CASE_ID = ["H101121", "PI_CR_2LM_AppDirect_PM_S0_S5_S0_L",
                    "H101166", "PI_CR_2LM_AppDirect_PM_S0_S5_S0_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiCR2LMAppDirectPMS0S5S0, self).__init__(test_log, arguments, cfg_opts)

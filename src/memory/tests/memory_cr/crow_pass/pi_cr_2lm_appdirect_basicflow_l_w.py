...
class PiCR2LMAppDirectBasicFlow(CrProvisioningTestCommon):
    """
    HP QC ID: H101111-PI_CR_2LM_AppDirect_BasicFlow_L and H101156-PI_CR_2LM_AppDirect_BasicFlow_W
    ...
    TEST_CASE_ID = ["H101111", "PI_CR_2LM_AppDirect_BasicFlow_L", "H101156", "PI_CR_2LM_AppDirect_BasicFlow_W"]
    return_value = []
    PARTITION_SIZE_LIST = ["16GB", "8GB", "8GB"]
    step_data_dict = {1: {'step_details': 'Clear OS logs and Set the bios knobs, Restart the system, Boot to OS '
                      ...
                      5: {'step_details': 'Create Storage namespace on AppDirect',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiCR2LMAppDirectBasicFlow8plus8 object.
        ...
        super(PiCR2LMAppDirectBasicFlow, self).__init__(test_log, arguments, cfg_opts, mode=MemoryTopology.TWO_LM)
    ...
    def execute(self):
        ...
        1. Create goal AppDirect = 50%, Memory Mode = 50%.
        ...
        self.return_value.append(
            self._ipmctl_provider.verify_lm_provisioning_configuration(dcpmm_disk_goal, mode=MemoryTopology.TWO_LM))
        ...
        for each_value in self.PARTITION_SIZE_LIST:
        ...
        self.return_value.append(self._partition_provider.verify_device_partitions(
            pmem_list, drive_letters))

...
class PiCRRunDiagnosticFirmware(PiCR2LMOsBoot):
    """
    HP QC  ID: 101118: PI_CR_RunDiagnosticFirmware_L, H101163 : PI_CR_RunDiagnosticFirmware_W

    2LM Basic functionality check,verify diagnostic firmware.
    """

    TEST_CASE_ID = ["H101118", "PI_CR_RunDiagnosticFirmware_L", "H101163", "PI_CR_RunDiagnosticFirmware_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiCRRunDiagnosticFirmware object.
        ...
        super(PiCRRunDiagnosticFirmware, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiCRRunDiagnosticFirmware.main() else Framework.TEST_RESULT_FAIL)

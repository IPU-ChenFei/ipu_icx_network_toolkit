...
class PiCR1LMAppDirectMemoryResourceCheck(CrProvisioningTestCommon):
    """
    HP QC ID: 101108 : PI_CR_1LM_AppDirect_MemoryResourceCheck_L and 101152 : PI_CR_1LM_AppDirect_MemoryResourceCheck_W

    To Verify Memory information for CR DIMMs is correct.
    """

    TEST_CASE_ID = ["H101108", "PI_CR_1LM_AppDirect_MemoryResourceCheck_L",
                    "H101153", "PI_CR_1LM_AppDirect_MemoryResourceCheck_W"]

...
class PiCR2LMAppDirectPMWarmReboot(ContentBaseTestCase):
    """
    HP QC ID: H101122-PI_CR_2LM_AppDirect_PM_WarmReboot_L and H101167-PI_CR_2LM_AppDirect_PM_WarmReboot_W

    To check system power sequence with 2LM CR: Warm reboot
    """

    TEST_CASE_ID = ["H101122", "PI_CR_2LM_AppDirect_PM_WarmReboot_L",
                    "H101167", "PI_CR_2LM_AppDirect_PM_WarmReboot_W"]

    step_data_dict = {1: {'step_details': 'To provision the CPS with 2LM 50% AppDirect and 50% Memory mode',
                          'expected_results': 'Successfully provisioned CPS with 2LM 50% AppDirect and 50% Memorymode'},
                      ...
                      3: {'step_details': 'Reboot the SUT', 'expected_results': 'The SUT was rebooted and came to OS.'},
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiCR2LMAppDirectPMWarmReboot object.
        ...
        super(PiCR2LMAppDirectPMWarmReboot, self).__init__(test_log, arguments, cfg_opts)
    ...
    def execute(self):
        ...
        3. Reboot the SUT.
        4. Calculate the checksum value using md5sum for linux and certutil for windows after warm reboot.
    ...
    def cleanup(self, return_status):
        ...
        super(PiCR2LMAppDirectPMWarmReboot, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiCR2LMAppDirectPMWarmReboot.main() else Framework.TEST_RESULT_FAIL)

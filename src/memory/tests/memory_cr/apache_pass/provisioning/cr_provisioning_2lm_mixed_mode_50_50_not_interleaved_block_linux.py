...
class CRProvisioning2LM50AppDirect50MemoryModeLinux(CrProvisioningTestCommon):
    """
    Glasgow ID: 57625
    ...
    BIOS_CONFIG_FILE = "cr_provisioning_2lm_mixed_mode_50_50_not_interleaved_block_linux.cfg"
    TEST_CASE_ID = "G57625"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(CRProvisioning2LM50AppDirect50MemoryModeLinux, self).__init__(test_log,
                                                                            arguments, cfg_opts,
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if CRProvisioning2LM50AppDirect50MemoryModeLinux.main()

...
class CRProvisioning2LM50AppDirect50MemoryMode(CrProvisioningTestCommon):
    """
    Glasgow ID: 58171
    ...
    BIOS_CONFIG_FILE = "cr_provisioning_2lm_mixed_mode_50_50_Interleaved_dax_bios_knob.cfg"
    TEST_CASE_ID = "G58171"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(CRProvisioning2LM50AppDirect50MemoryMode, self).__init__(test_log,
                                                                       arguments, cfg_opts,
    ...
    def execute(self):
        ...
        dcpmm_disk_goal = self.dcpmm_configuration(
            ...
            cmd=r".\ipmctl.exe create -f -goal memorymode=50 persistentmemorytype=appdirect",
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if CRProvisioning2LM50AppDirect50MemoryMode.main() else Framework.TEST_RESULT_FAIL)

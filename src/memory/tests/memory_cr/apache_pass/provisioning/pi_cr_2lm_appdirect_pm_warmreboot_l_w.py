...
class PICR2lmAppDirectPMWarmReboot(CrProvisioningTestCommon):
    """
    HP QC  ID: 79532 (Linux) and 82167 (Windows)

    To check system power sequence with 2LM CR: Warm reboot
    """

    TEST_CASE_ID = "H79532/H82167-Pi_CR_2lm_AppDirect_PM_WarmReboot"
    ...
    step_data_dict = {1: {'step_details': 'To provision the crystal ridge with 2LM 50% AppDirect mode and '
                      ...
                      4: {'step_details': 'Reboot the SUT', 'expected_results': 'The SUT has been rebooted'},
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PICR2lmAppDirectPMWarmReboot, self).__init__(test_log, arguments, cfg_opts, bios_config_file=None)
    ...
    def prepare(self):
        ...
        # To generate a 5GB file in the SUT
    ...
    def execute(self):
        ...
        self._test_content_logger.end_step_logger(3, return_val=checksum_list_values_before_reboot)

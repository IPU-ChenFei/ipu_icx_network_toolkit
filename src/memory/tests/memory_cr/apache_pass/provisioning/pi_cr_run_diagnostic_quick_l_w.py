...
class PICRRunDiagnosticQuick(CrProvisioningTestCommon):
    """
    HP QC ID: 79533 (Linux) and 82168 (Windows)
    2LM Basic functionality check,verify diagnostic quick.
    """

    TEST_CASE_ID = "H79533/H82168_PI_CR_RunDiagnosticQuick"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PICRRunDiagnosticQuick, self).__init__(test_log, arguments, cfg_opts, bios_config_file=None)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PICRRunDiagnosticQuick.main()

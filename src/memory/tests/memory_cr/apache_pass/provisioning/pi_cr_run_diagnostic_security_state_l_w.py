...
class PICRRunDiagnosticSecurityState(CrProvisioningTestCommon):
    """
    HP QC  ID: 79527 (linux) and 82162 (Windows)
    2LM Basic functionality check,verify diagnostic security.
    """

    TEST_CASE_ID = "H79527/H82162_PI_CR_RunDiagnosticSecurityState"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PICRRunDiagnosticSecurityState object.
        ...
        super(PICRRunDiagnosticSecurityState, self).__init__(test_log, arguments, cfg_opts, bios_config_file=None)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PICRRunDiagnosticSecurityState.main()

...
class PICRRunDiagnosticConfig(CrProvisioningTestCommon):
    """
    HP QC ID: 79526 (Linux) and 82161 (Windows)
    2LM Basic functionality check,verify diagnostic config.
    """

    TEST_CASE_ID = "H79526/H82161-PI_CR_RunDiagnosticConfig"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PICRRunDiagnosticConfig, self).__init__(test_log, arguments, cfg_opts, bios_config_file=None)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PICRRunDiagnosticConfig.main()

...
from src.memory.tests.memory_cr.apache_pass.provisioning.pi_cr_2lm_memory_mode_basic import \
    PICR2lmMemoryModeBasic


class PICR2LMMemoryResourceCheck(CrProvisioningTestCommon):
    """
    HP QC ID: 79520 (Linux) and 82155 (Windows)

    To Verify Memory information for CR DIMMs is correct in linux
    """

    TEST_CASE_ID = ["PI_CR_2LM_MemoryResourceCheck_L", "PI_CR_2LM_MemoryResourceCheck_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PICR2LMMemoryResourceCheck, self).__init__(test_log, arguments, cfg_opts,
    ...
    def execute(self):
        ...
        self._memory_common_lib.verify_memory_resource_information(mem_resources_data, "2LM")
        ...
        self._memory_common_lib.verify_socket_information(socket_op, cpu_locators, mode="2LM")
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if PICR2LMMemoryResourceCheck.main() else Framework.TEST_RESULT_FAIL)

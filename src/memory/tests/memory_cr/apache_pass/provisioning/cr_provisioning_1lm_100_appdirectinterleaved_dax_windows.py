...
class CRProvisioning1LM100AppDirectInterleavedDax(CrProvisioningTestCommon):
    """
    Glasgow ID: 57899
    ...
    1LM mode.
    2. DCPMMs will be provisioned as 100% persistent memory with DAX mode partitions
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new CRProvisioning1LM100AppDirectInterleavedDax object.
        ...
        super(CRProvisioning1LM100AppDirectInterleavedDax, self).__init__(test_log, arguments, cfg_opts,
    ...
    def execute(self):
        ...
        self.create_partition_dcpmm_disk(convert_type="gpt", disk_lists=disk_list, mode="dax")
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if CRProvisioning1LM100AppDirectInterleavedDax.main() else

...
class CrOsGracefulWarmResetAdrEnabledLinux(CrCyclingCommon):
    """
    Glasgow ID: 57081
    ...
    BIOS_CONFIG_FILE = "cr_os_graceful_warm_reset_adr_enabled_linux.cfg"
    TEST_CASE_ID = "G57081"
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(CrOsGracefulWarmResetAdrEnabledLinux, self).__init__(test_log, arguments, cfg_opts,
    ...
    def execute(self):
        ...
        return_value.append(self.execute_dcpmm_soft_reboot_cycler(self._dcpmm_platform_cycler_file_path))
...
if __name__ == "__main__":
    sys.exit(
        Framework.TEST_RESULT_PASS if CrOsGracefulWarmResetAdrEnabledLinux.main() else Framework.TEST_RESULT_FAIL)

...
class DcCyclingGracefulOsShutdownEADREnabled(CrCyclingCommon):
    """
    Glasgow ID: 57164
    ...
    """
    _bios_config_file = "cr_dc_cycling_graceful_os_shutdown_eadr_enabled_linux_57164.cfg"
    TEST_CASE_ID = "G57164"
    LINUX_PLATFORM_CYCLER_DCGRACEFUL_LOG_FOLDER = "/platform_dc_graceful/logs/"

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new DcCyclingGracefulOsShutdownEADREnabled object.
        ...
        super(DcCyclingGracefulOsShutdownEADREnabled, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):
        ...
        command = "rm -rf {}".format(self.LINUX_PLATFORM_CYCLER_DCGRACEFUL_LOG_FOLDER)
    ...
    def execute(self):
        ...
        2. Execute dcpmm dcgraceful cycle as specified in the test case.
        3. Check all the cyler logs for unexpected errors.

        :return: True, if the test case is successful.
        """
        command = "--dcpmm --dcgraceful"
        # call installer dcgraceful test
        ...
        log_path_to_parse = self._common_content_lib.copy_log_files_to_host(
            test_case_id=self.TEST_CASE_ID, sut_log_files_path=self.LINUX_PLATFORM_CYCLER_DCGRACEFUL_LOG_FOLDER,
            extension=".log")

        final_result = [
            self._mem_parse_log.dcpmm_platform_log_parsing
            ...
            self._mem_parse_log.verification_dcpmm_log(log_path=os.path.join(log_path_to_parse, "dcpmm.log")),
            self._mem_parse_log.check_memory_log(log_path=os.path.join(log_path_to_parse, "memory.log")),
            ...
            self._mem_parse_log.parse_log_for_error_patterns(log_path=os.path.join(log_path_to_parse, "sel.log"),
                                                             encoding="UTF-8")]
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if DcCyclingGracefulOsShutdownEADREnabled.main() else

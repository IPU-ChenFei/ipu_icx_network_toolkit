...
CASE_DESC = [
    'The objective of this test case is used to reboot cycle boot flow when fast boot is enabled',
...
def test_steps(sut, my_os):
    ...
    Case.prepare('boot to os setup bios')
    ...
    expect_str = 'subBootMode = WarmBootFast'

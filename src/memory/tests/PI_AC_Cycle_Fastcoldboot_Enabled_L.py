...
CASE_DESC = [
    'The objective of this test case is used to AC cycle boot flow when fast boot is enabled.'
]
...
def test_steps(sut, my_os):
    ...
    boot_to_with_bios_knobs(sut, sut.default_os, *bios_knob('Attempt_Fast_Boot_enable_xmlcli'), *bios_knob('Attempt_Fast_Boot_Cold_enable_xmlcli'))

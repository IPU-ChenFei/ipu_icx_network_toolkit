...
def help():
    ...
    1. download network tools from fileserver, and run pre-defined installation process
        > Python install_network_tools.py --platform=bhs --domain=network
    2. download network tools from fileserver, and ignore pre-defined installation process
        > Python install_network_tools.py --platform=bhs --domain=network --skipinstall=true
    3. ignore download actions, only run pre-defined installation process
        > Python install_network_tools.py --platform=bhs --domain=network --skipdownload=true
    """
    print(help.__doc__)

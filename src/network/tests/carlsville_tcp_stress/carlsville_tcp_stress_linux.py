...
class CarlsvilleTcpStressLinux(NetworkingCommon):
    """
    HPQC ID : H91199-PI_Networking_Carlsville_TCPStress_L

    This Class is used to check the TCP through IPerf, by setting One Sut as iperf Server and other one as Iperf Client.
    """
    TEST_CASE_ID = ["H91199", "PI_Networking_Carlsville_TCPStress_L"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of CarlsvilleTcpStressLinux

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(CarlsvilleTcpStressLinux, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if CarlsvilleTcpStressLinux.main()

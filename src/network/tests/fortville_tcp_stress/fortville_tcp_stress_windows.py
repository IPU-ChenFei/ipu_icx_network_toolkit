...
class FortvilleTcpStressWindows(NetworkingCommon):
    """
    ...
    """
    TEST_CASE_ID = ["18014067723", "PI_Networking_Fortville_TCPStress_W"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of FortvilleTcpStressWindows

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(FortvilleTcpStressWindows, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if FortvilleTcpStressWindows.main()

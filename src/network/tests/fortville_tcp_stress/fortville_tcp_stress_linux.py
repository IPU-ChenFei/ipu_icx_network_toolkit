...
class FortvilleTcpStressLinux(NetworkingCommon):
    """
    HPQC ID : H93821-PI_Networking_Fortville_TCPStress_L

    This Class is used to check the TCP through IPerf, by setting One Sut as iperf Server and other one as Iperf Client.
    """
    TEST_CASE_ID = ["H93821", "PI_Networking_Fortville_TCPStress_L"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of FortvilleTcpStressLinux

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(FortvilleTcpStressLinux, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if FortvilleTcpStressLinux.main()

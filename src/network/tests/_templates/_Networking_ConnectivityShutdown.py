...
CASE_DESC = [
    ...
    'shutdown sut1 then dc on to os, sut2 ping sut1 successful',
...
def test_steps(sut, my_os):
    ...
    Case.step("shutdown sut1 then dc on to os, sut2 ping sut1 successful, repeat 5 times")
    for i in range(3):
        my_os.g3_cycle_step(sut1)
        Case.wait_and_expect('wait for restoring sut2 ssh connection', 60 * 5, sut2.check_system_in_os)

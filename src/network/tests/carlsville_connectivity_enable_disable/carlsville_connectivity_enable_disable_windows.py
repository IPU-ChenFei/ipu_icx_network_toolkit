...
class CarlsvilleConnectivityEnableDisableWindows(NetworkingCommon):
    """
    HPQC ID : H91329-PI_Networking_Carlsville_ConnectivityEnableDisable_W

    This Class is Used to Check the Connectivity of Carlsville Network Driver by Enabling and Disabling Network Adapter
    and Pinging System Ip.
    """
    TEST_CASE_ID = ["H91329", "PI_Networking_Carlsville_ConnectivityEnableDisable_W"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of CarlsvilleConnectivityEnableDisableWindows

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(CarlsvilleConnectivityEnableDisableWindows, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if CarlsvilleConnectivityEnableDisableWindows.main()

...
class CarlsvilleConnectivityRebootLinux(NetworkingCommon):
    """
    HPQC ID : H91324-PI_Networking_Carlsville_ConnectivityReboot_L

    This Class is used to check the networking connectivity after Reboot Cycles of SUT.
    """
    TEST_CASE_ID = ["H91324", "PI_Networking_Carlsville_ConnectivityReboot_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of CarlsvilleConnectivityRebootLinux.

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(CarlsvilleConnectivityRebootLinux, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if CarlsvilleConnectivityRebootLinux.main()

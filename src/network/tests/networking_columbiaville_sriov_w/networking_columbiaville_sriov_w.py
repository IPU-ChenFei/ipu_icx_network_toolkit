...
class CoulumbiavilleSriovWindows(NetworkingCommon, VirtualizationCommon):
    """
    Phoenix ID : 18014067597-PI_Networking_Coulumbiaville_SRIOV_W
    This Class is Used to Generate Coulumbiaville Virtual Network Adapters and assign Static IP and IPv6 Address to each
    Virtual Network Adapter Generated and Ping them. Reset Count of Virtual Network Adapters to there Default Value.
    """
    TEST_CASE_ID = ["18014067597", "PI_Networking_Coulumbiaville_SRIOV_W"]
    BIOS_CONFIG_FILE = 'network_columbiaville_sriov_bios.cfg'
    VM_TYPE = "RS5"
    VM = [VMs.WINDOWS]
    ...
    STEP_DATA_DICT = {
        ...
        4: {'step_details': "Copy Coulumbiaville driver to VM and install it.",
            'expected_results': "Coulumbiaville driver installation is successfully"},
        }
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of CoulumbiavilleSriovWindows
        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(CoulumbiavilleSriovWindows, self).__init__(test_log, arguments, cfg_opts)
    ...
    def cleanup(self, return_status):
        """
        This Method is Used to Install Coulumbiaville driver and Reset Virtual Network Adapters to their Default Value.
        """
        super(CoulumbiavilleSriovWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if CoulumbiavilleSriovWindows.main()

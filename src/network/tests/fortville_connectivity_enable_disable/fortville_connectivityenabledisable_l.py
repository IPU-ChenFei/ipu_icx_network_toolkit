...
class FortvilleConnectivityEnableDisable(NetworkingCommon):
    """
    HPQC ID : H93817-PI_Networking_Fortville_ConnectivityEnableDisable_L
    ...
    """
    TEST_CASE_ID = ["H93817", "PI_Networking_Fortville_ConnectivityEnableDisable_L"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of FortvilleConnectivityEnableDisable

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(FortvilleConnectivityEnableDisable, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if FortvilleConnectivityEnableDisable.main()

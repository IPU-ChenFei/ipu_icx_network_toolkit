...
class JacksonvilleConnectivityEnableDisableLinux(NetworkingCommon):
    """
    HPQC ID : H80070-PI_Networking_JacksonVille_ConnectivityEnableDisable_L

    This case is used to check the networking connectivity after enable/disable network.
    """
    TEST_CASE_ID = ["H80070", "PI_Networking_JacksonVille_ConnectivityEnableDisable_L"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of JacksonvilleConnectivityEnableDisableLinux

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(JacksonvilleConnectivityEnableDisableLinux, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if JacksonvilleConnectivityEnableDisableLinux.main()

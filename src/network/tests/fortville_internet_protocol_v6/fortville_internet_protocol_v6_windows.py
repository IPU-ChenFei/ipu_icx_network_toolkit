...
class FortvilleInternetProtocolV6Windows(NetworkingCommon):
    """
    HPQC ID : H93833-PI_Networking_Fortville_InternetProtocolv6_W
    ...
    """
    TEST_CASE_ID = ["H93833", "PI_Networking_Fortville_InternetProtocolv6_W"]
    STEP_DATA_DICT = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create an instance of FortvilleInternetProtocolV6Windows

        :param cfg_opts: Configuration Object of provider
        :param test_log: Log object
        :param arguments: None
        """
        super(FortvilleInternetProtocolV6Windows, self).__init__(test_log, arguments, cfg_opts)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if FortvilleInternetProtocolV6Windows.main()

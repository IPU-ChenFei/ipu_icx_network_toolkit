...
class PcieModelAvailabilityOsGen5Linux(PcieCommon):
    """
    HPQC : 89996-PI_PCIe_PCIModelAvailability_OS_Gen5_L
    ...
    """
    TEST_CASE_ID = ["H89996", "PI_PCIe_PCIModelAvailability_OS_Gen5_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(PcieModelAvailabilityOsGen5Linux, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieModelAvailabilityOsGen5Linux.main() else Framework.TEST_RESULT_FAIL)

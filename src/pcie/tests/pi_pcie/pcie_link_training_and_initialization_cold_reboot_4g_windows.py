...
from src.lib.dtaf_content_constants import WindowsMemrwToolConstant, PcieSlotAttribute


class PcieLinkTrainingAndInitializationColdReboot4gWindows(PcieCommon):
    """
    HPQC ID : H89963-PI_PCIe_Link_training_and_Initialization_Overnight_AC_cycling_Gen4_W
    ...
    TEST_CASE_ID = ["H89963", "PI_PCIe_Link_training_and_Initialization_Overnight_AC_cycling_Gen4_W"]

    SCRIPT_FILE_NAME = WindowsMemrwToolConstant.CYCLING_SCRIPT_FILE_NAME

    ARGUMENTS = { "Previous cycle logs detected.": "y",
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a PcieLinkTrainingAndInitializationColdReboot4gWindows object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(PcieLinkTrainingAndInitializationColdReboot4gWindows, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):  # type: () -> None
        ...
        super(PcieLinkTrainingAndInitializationColdReboot4gWindows, self).prepare()
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieLinkTrainingAndInitializationColdReboot4gWindows.main()

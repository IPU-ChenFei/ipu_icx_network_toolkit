...
class PcieSlotBifurcationBiosSettingLinkStatusWidthLinux(PcieCommon):
    """
    HPQC : H89969-PI_PCIe_Slot_Bifurcation_Bios_Setting_Link_Status_Width_L

    Verify Bifurcation bios setting in sls and Verify width and speed
    """
    TEST_CASE_ID = ["H89969", "PI_PCIe_Slot_Bifurcation_Bios_Setting_Link_Status_Width_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        """
        super(PcieSlotBifurcationBiosSettingLinkStatusWidthLinux, self).__init__(test_log, arguments, cfg_opts,
    ...
    def prepare(self):  # type: () -> None
        ...
        """
        super(PcieSlotBifurcationBiosSettingLinkStatusWidthLinux, self).prepare()

    def execute(self):
        """
        This method is to execute:
        1. Verify Bifurcation in pcie.sls.
        2. Check LinkCap, LinkStat Speed and Width.
        ...
        for each_slot in pcie_slot_device_list:
            ...
            self.verify_required_slot_pcie_device(cscripts_obj=cscripts_obj,
                                                  ...
                                                  lnk_stat_width_speed=True, generation=5, bifurcation=True)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieSlotBifurcationBiosSettingLinkStatusWidthLinux.main() else Framework.TEST_RESULT_FAIL)

...
class PcieModelAvailabilityOsGen5Windows(PcieCommon):
    """
    HPQC : 83431-PI_PCIe_PCIModelAvailability_OS_Gen5_W
    ...
    """
    TEST_CASE_ID = ["H83431", "PI_PCIe_PCIModelAvailability_OS_Gen5_W"]

    _BIOS_CONFIG_FILE = "gen5_bios_knobs_config.cfg"
    step_data_dict = {
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a PcieModelAvailabilityOsGen5Linux object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(PcieModelAvailabilityOsGen5Windows, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieModelAvailabilityOsGen5Windows.main() else Framework.TEST_RESULT_FAIL)

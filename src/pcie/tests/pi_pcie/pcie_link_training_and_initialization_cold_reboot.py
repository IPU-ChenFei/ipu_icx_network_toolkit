...
from src.lib.dtaf_content_constants import LinuxCyclingToolConstant, WindowsMemrwToolConstant, PcieSlotAttribute


class PcieLinkTrainingAndInitializationColdReboot(PcieCommon):
    """
    HPQALM ID : H82140, H82143
    GLASGOW : 58049.0

    This Testcase is used to check the pcie link train and initialize proper after Cold reboot.
    """
    TEST_CASE_ID = ["H82140", "PI_PCIe_Link_training_and_Initialization-Overnight_Ac_cycling_L",
                    "H82143", "PI_PCIe_Link_training_and_Initialization-Overnight_Ac_cycling_W",
                    "G58049", "PCI_Express_Link_training_and_initialization_Overnight_AC_Cycling"
                    ]
    ...
    ARGUMENTS = {OperatingSystems.LINUX: {"ex: sda sdb sdc sdd hda hdb": "1",
                 ...
                 OperatingSystems.WINDOWS: {"Previous cycle logs detected.": "y",
                                            "Please select the type of cycling to perform:": "3", "(y/n)": "y",
                                            ...
                                            "Please enter the number of minutes to wait before sending a wake signal:":
                                            "30", "You have entered 30 minutes": "y",
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a PcieLinkTrainingAndInitializationColdReboot object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(PcieLinkTrainingAndInitializationColdReboot, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):  # type: () -> None
        ...
        super(PcieLinkTrainingAndInitializationColdReboot, self).prepare()
    ...
    def execute(self):
        ...
        if not self._common_content_configuration.get_user_inputs_for_pcie_flags():
            ...
            self.execute_the_cycling_tool(arguments=self.ARGUMENTS[self.os.os_type], directory_path=
                                          self._cycling_tool_sut_folder_path.strip(), boot_type="ac_cycle")
            ...
            self.perform_pcie_cyling(reboot_type="ac_cycle")
        return True


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieLinkTrainingAndInitializationColdReboot.main() else Framework.TEST_RESULT_FAIL)

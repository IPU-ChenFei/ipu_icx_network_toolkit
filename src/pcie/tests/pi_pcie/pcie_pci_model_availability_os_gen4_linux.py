...
class PcieModelAvailabilityOsGen4Linux(PcieCommon):
    """
    HPQC : 79608-PI_PCIe_PCIModelAvailability_OS_Gen4_L
    ...
    """
    TEST_CASE_ID = ["H79608", "PI_PCIe_PCIModelAvailability_OS_Gen4_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Creates a PcieModelAvailabilityOsGen4Linux object

        :param test_log: Used for debug and info messages
        :param cfg_opts: xml.etree.ElementTree.Element of configuration options for execution environment.
        """
        super(PcieModelAvailabilityOsGen4Linux, self).__init__(test_log, arguments, cfg_opts, self._BIOS_CONFIG_FILE)
...
if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PcieModelAvailabilityOsGen4Linux.main() else Framework.TEST_RESULT_FAIL)

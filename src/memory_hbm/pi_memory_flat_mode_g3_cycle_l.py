...
class PiMemoryFlatModeG3CycleLinux(MemoryHbmCommon):
    """
    HP QC ID:H109182, Pheonix ID:16014741277 -PI_Memory_Flat_Mode_G3_Cycle_L

    """

    TEST_CASE_ID = ["16014741277", "PI_Memory_Flat_Mode_G3_Cycle_L"]
    BIOS_CONFIG_FILE = "one_lm_bios_knob.cfg"
    G3_CYCLES = 10

    step_data_dict = {1: {'step_details': 'To verify SUT has 1DPC or 2DPC memory configuration ...',
                          'expected_results': 'SUT has 1DPC or 2DPC expected memory configuration ...'},
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryFlatModeG3CycleLinux object.
        ...
        super(PiMemoryFlatModeG3CycleLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeG3CycleLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeG3CycleLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeG3CycleLinux.main() else Framework.TEST_RESULT_FAIL)

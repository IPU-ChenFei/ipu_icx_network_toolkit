...
class PiMemoryFlatModeS0S5S0Linux(MemoryHbmCommon):
    """
    HP QC ID:H109180, Pheonix ID:16014741547 - PI_Memory_Flat_Mode_PM_S0_S5_S0_L

    """

    TEST_CASE_ID = ["16014741547", "PI_Memory_Flat_Mode_PM_S0_S5_S0_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryFlatModeS0S5S0Linux object.
        ...
        super(PiMemoryFlatModeS0S5S0Linux, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeS0S5S0Linux, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeS0S5S0Linux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeS0S5S0Linux.main() else Framework.TEST_RESULT_FAIL)

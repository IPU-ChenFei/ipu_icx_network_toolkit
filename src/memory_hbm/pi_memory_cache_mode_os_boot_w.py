...
class PiMemoryCacheModeOSBootWindows(MemoryHbmCommon):
    """
    Pheonix ID:16014743342 - PI_Memory_Cache_Mode_OS_Boot_W

    """

    TEST_CASE_ID = ["16014743342", "PI_Memory_Cache_Mode_OS_Boot_W"]
    ...
    step_data_dict = {1: {'step_details': 'To verify SUT has 1DPC or 2DPC memory configuration ...',
                      ...
                      4: {'step_details': 'Verify memory displayed at POST and amount of memory reported by the '
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryCacheModeOSBootWindows object.
        ...
        super(PiMemoryCacheModeOSBootWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeOSBootWindows, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeOSBootWindows, self).cleanup(return_status)



if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeOSBootWindows.main() else Framework.TEST_RESULT_FAIL)

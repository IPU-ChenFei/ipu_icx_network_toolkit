...
class PiFlatModeQuadModeStressAppLinux(MemoryHbmCommon):
    """
    HP QC ID : H109149, pheonix id : 16014741649 - PI_Memory_Flat_Mode_Quad_Mode_Stressapp_L

    """

    TEST_CASE_ID = ["16014741649", "PI_Memory_Flat_Mode_Quad_Mode_Stressapp_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiFlatModeQuadModeStressAppLinux object.
        ...
        super(PiFlatModeQuadModeStressAppLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiFlatModeQuadModeStressAppLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        """DTAF cleanup"""
        self._stress_provider.kill_stress_tool(StressAppTestConstants.STRESS_APP_TOOL_NAME, self.STRESS_APP_COMMAND)
        super(PiFlatModeQuadModeStressAppLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiFlatModeQuadModeStressAppLinux.main() else Framework.TEST_RESULT_FAIL)

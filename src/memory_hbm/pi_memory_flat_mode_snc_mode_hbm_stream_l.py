...
class PiFlatModeSNCModeMemStreamLinux(MemoryHbmCommon):
    """
    Phoenix id : 16014741391 - PI_Memory_Flat_Mode_SNC_Mode_HBM_Stream_L
    """

    TEST_CASE_ID = ["16014741391", "PI_Memory_Flat_Mode_SNC_Mode_HBM_Stream_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiFlatModesncModeMemStreamLinux object.
        ...
        super(PiFlatModeSNCModeMemStreamLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(PiFlatModeSNCModeMemStreamLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(PiFlatModeSNCModeMemStreamLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiFlatModeSNCModeMemStreamLinux.main() else Framework.TEST_RESULT_FAIL)

...
class PiMemoryCacheModeOSBootLinux(MemoryHbmCommon):
    """
    HP QC ID:H109170, Pheonix ID:1601474102 - PI_Memory_Cache_Mode_OS_Boot_L

    """

    TEST_CASE_ID = ["1601474102", "PI_Memory_Cache_Mode_OS_Boot_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryCacheModeOSBootLinux object.
        ...
        super(PiMemoryCacheModeOSBootLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeOSBootLinux, self).prepare()
    ...
    def execute(self):
        ...
        # Need to check this function after running manually in system
        self._ddr_common.verify_physical_memory_in_system_information_in_bios()
        ...
        # To verify nodes
        self.verify_number_of_nodes(memory_mode=MemoryTopology.TWO_LM, cluster_mode=cluster_mode)
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeOSBootLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeOSBootLinux.main() else Framework.TEST_RESULT_FAIL)

...
class PiMemoryHBMQuadMlcLinux(MemoryHbmCommon):
    """
     Pheonix ID: 16014742977 - PI_Memory_HBM_Mode_QUAD_Mode_MLC_L
    """

    TEST_CASE_ID = ["16014742977", "PI_Memory_HBM_Mode_QUAD_Mode_MLC_L"]
    ...
    step_data_dict = {1: {'step_details': 'To verify SUT no DDR memory configuration and '
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryHBMQuadMlcLinux object.
        ...
        super(PiMemoryHBMQuadMlcLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiMemoryHBMQuadMlcLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        """DTAF cleanup"""
        self._stress_provider.kill_stress_tool(MLCToolConstants.MLC_TOOL_NAME, self.MLC_COMMAND)
        super(PiMemoryHBMQuadMlcLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryHBMQuadMlcLinux.main() else Framework.TEST_RESULT_FAIL)

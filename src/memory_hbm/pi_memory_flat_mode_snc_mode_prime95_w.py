...
class PiMemoryFlatSncPrime95Windows(MemoryHbmCommon):
    """
    pheonix id : 16014744346 - 	PI_Memory_HBM_Mode_SNC_Mode_Prime95_W

    """

    TEST_CASE_ID = ["16014744346", "	PI_Memory_HBM_Mode_SNC_Mode_Prime95_W"]
    BIOS_CONFIG_FILE = "one_lm_snc4_bios_knob.cfg"
    ...
    step_data_dict = {1: {'step_details': 'To verify SUT has 1DPC or 2DPC memory configuration and '
                                          ...
                                          'Check ktilk_snc_config expected value is 0x00000f',
                          'expected_results': 'SUT has 1DPC or 2DPC memory configuration and '
                                              ...
                                              'verified and ktilk_snc_config expected value 0x00000f verified.'},
                      2: {'step_details': 'To Install Prime95 tool and Run Prime95 Tool for 1hour',
                          'expected_results': 'Prime95 ran with out errors ...'}}

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryHbmSncPrime95Windows object.
        ...
        super(PiMemoryFlatSncPrime95Windows, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        # snc_check_with_pythonsv_values need to put common location
    ...
    def execute(self):
        ...
        2. run the Prime95 tool for 1 Hour.
    ...
    def cleanup(self, return_status):
        ...
        super(PiMemoryFlatSncPrime95Windows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatSncPrime95Windows.main() else Framework.TEST_RESULT_FAIL)

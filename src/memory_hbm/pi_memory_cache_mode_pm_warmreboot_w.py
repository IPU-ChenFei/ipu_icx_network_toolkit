...
class PiMemoryCacheModeWarmRebootW(MemoryHbmCommon):
    """
    Pheonix ID:16014743655 - PI_Memory_Cache_Mode_PM_WarmReboot_W

    """

    TEST_CASE_ID = ["16014743655", "PI_Memory_Cache_Mode_PM_WarmReboot_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryCacheModeWarmRebootW object.
        ...
        super(PiMemoryCacheModeWarmRebootW, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeWarmRebootW, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeWarmRebootW, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeWarmRebootW.main() else Framework.TEST_RESULT_FAIL)

...
class PiMemoryHbmSncIwvss(MemoryHbmCommon):
    """
    pheonix id : 16014744397 - 	PI_Memory_HBM_Mode_SNC_Mode_Iwvss_W

    """

    TEST_CASE_ID = ["16014744397", "	PI_Memory_HBM_Mode_SNC_Mode_Iwvss_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryHbmSncIwvss, self).__init__(test_log, arguments, cfg_opts)
    ...
    def cleanup(self, return_status):
        ...
        super(PiMemoryHbmSncIwvss, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryHbmSncIwvss.main() else Framework.TEST_RESULT_FAIL)

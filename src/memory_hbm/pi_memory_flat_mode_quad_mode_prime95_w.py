...
class PiFaltQuadPrime95Windows(MemoryHbmCommon):
    """
    pheonix id : 16014744307 - PI_Memory_Flat_Mode_Quad_Mode_Prime95_W

    """

    TEST_CASE_ID = ["16014744307", "PI_Memory_Flat_Mode_Quad_Mode_Prime95_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiFaltQuadPrime95Windows, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiFaltQuadPrime95Windows, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(PiFaltQuadPrime95Windows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiFaltQuadPrime95Windows.main() else Framework.TEST_RESULT_FAIL)

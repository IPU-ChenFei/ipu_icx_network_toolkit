...
class PiMemoryFlatModeS0S5S0Windows(MemoryHbmCommon):
    """
    Phoenix ID:16014743873 - PI_Memory_Flat_Mode_PM_S0_S5_S0_W

    """

    TEST_CASE_ID = ["16014743873", "PI_Memory_Flat_Mode_PM_S0_S5_S0_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryFlatModeS0S5S0Windows object.
        ...
        super(PiMemoryFlatModeS0S5S0Windows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeS0S5S0Windows, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeS0S5S0Windows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeS0S5S0Windows.main() else Framework.TEST_RESULT_FAIL)

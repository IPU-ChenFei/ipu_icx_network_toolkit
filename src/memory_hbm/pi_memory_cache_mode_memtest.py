...
class PIMemoryCacheModeMemtest(MemoryHbmCommon):
    """
    Phoenix ID:16014741011 - PI_Memory_Cache_Mode_Memtest_L
    """

    TEST_CASE_ID = ["16014741011", "PI_Memory_Cache_Mode_Memtest_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PIMemoryCacheModeMemtest object.
        ...
        super(PIMemoryCacheModeMemtest, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PIMemoryCacheModeMemtest, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PIMemoryCacheModeMemtest, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PIMemoryCacheModeMemtest.main() else Framework.TEST_RESULT_FAIL)

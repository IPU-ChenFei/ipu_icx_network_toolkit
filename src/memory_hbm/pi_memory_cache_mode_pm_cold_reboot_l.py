...
class PiMemoryCacheModeColdRebootL(MemoryHbmCommon):
    """
    HP QC ID:H109174, Pheonix ID:16014741008 - PI_Memory_Cache_Mode_PM_ColdReboot_L

    """

    TEST_CASE_ID = ["16014741001", "PI_Memory_Cache_Mode_PM_ColdReboot_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryCacheModeColdRebootL, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeColdRebootL, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeColdRebootL, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeColdRebootL.main() else Framework.TEST_RESULT_FAIL)

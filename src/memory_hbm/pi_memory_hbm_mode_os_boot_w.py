...
class PiMemoryHBMModeOSBootWindows(MemoryHbmCommon):
    """
    Pheonix ID:16014743988 - PI_Memory_HBM_Mode_OS_Boot_W

    """

    TEST_CASE_ID = ["16014743988", "PI_Memory_HBM_Mode_OS_Boot_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryHBMModeOSBootWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryHBMModeOSBootWindows, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryHBMModeOSBootWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryHBMModeOSBootWindows.main() else Framework.TEST_RESULT_FAIL)

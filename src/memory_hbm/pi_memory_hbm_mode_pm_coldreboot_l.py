...
class PiMemoryHBMModeColdRebootL(MemoryHbmCommon):
    """
    Pheonix ID:16014742794 - PI_Memory_HBM_Mode_PM_ColdReboot_L

    """

    TEST_CASE_ID = ["16014742794", "PI_Memory_HBM_Mode_PM_ColdReboot_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryHBMModeColdRebootL, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryHBMModeColdRebootL, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryHBMModeColdRebootL, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryHBMModeColdRebootL.main() else Framework.TEST_RESULT_FAIL)

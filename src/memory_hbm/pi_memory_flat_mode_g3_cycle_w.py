...
class PiMemoryFlatModeG3CycleWindows(MemoryHbmCommon):
    """
    Pheonix ID:16014743702 -PI_Memory_Flat_Mode_G3_Cycle_W

    """

    TEST_CASE_ID = ["16014743702", "PI_Memory_Flat_Mode_G3_Cycle_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryFlatModeG3CycleWindows object.
        ...
        super(PiMemoryFlatModeG3CycleWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeG3CycleWindows, self).prepare()
    ...
    def cleanup(self, return_status):        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeG3CycleWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeG3CycleWindows.main() else Framework.TEST_RESULT_FAIL)

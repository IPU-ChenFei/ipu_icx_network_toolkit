...
class PiMemoryFlatSncIwvss(MemoryHbmCommon):
    """
    pheonix id : 16014744314 - 	PI_Memory_Flat_Mode_SNC_Mode_Iwvss_W

    """

    TEST_CASE_ID = ["16014744314", "	PI_Memory_Flat_Mode_SNC_Mode_Iwvss_W"]
    ...
    step_data_dict = {1: {'step_details': 'To verify SUT has 1DPC or 2DPC memory configuration and '
                      ...
                      2: {'step_details': 'To Install Iwvss tool and Run Iwvss Tool for 1hour',
                          'expected_results': 'Iwvss ran with out errors ...'}}

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryHbmSncIwvss object.
        ...
        super(PiMemoryFlatSncIwvss, self).__init__(test_log, arguments, cfg_opts)
    ...
    def execute(self):
        ...
        2. run the Iwvss tool for 2 Hours.
    ...
    def cleanup(self, return_status):
        ...
        super(PiMemoryFlatSncIwvss, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatSncIwvss.main() else Framework.TEST_RESULT_FAIL)

...
class PiMemoryHBMModeSncStressAppLinux(MemoryHbmCommon):
    """
    Phoenix id : 16014743246 - PI_Memory_HBM_Mode_SNC_Mode_Stressapp_L
    """

    TEST_CASE_ID = ["16014743246", "PI_Memory_HBM_Mode_SNC_Mode_Stressapp_L"]
    ...
    # Same bios knob change as cache mode, so using the same cfg file
    ...
    step_data_dict = {1: {'step_details': 'To Install Stressapptest',
                      ...
                      3: {'step_details': 'To Load default bios, Set & verify SNC (Sub NUMA) bios knob to SNC4, '
                      ...
                      4: {'step_details': 'Run StressAppTest Tool for 1 hours',
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryHBMModeSncStressAppLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def cleanup(self, return_status):
        ...
        """DTAF cleanup"""
        self._stress_provider.kill_stress_tool(StressAppTestConstants.STRESS_APP_TOOL_NAME, self.STRESS_APP_COMMAND)
        super(PiMemoryHBMModeSncStressAppLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryHBMModeSncStressAppLinux.main() else Framework.TEST_RESULT_FAIL)

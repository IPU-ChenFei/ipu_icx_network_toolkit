...
class PiMemoryFlatModeWarmRebootL(MemoryHbmCommon):
    """
    HP QC ID:H109173, Pheonix ID:16014741577 - PI_Memory_Flat_Mode_PM_WarmReboot_L

    """

    TEST_CASE_ID = ["16014741577", "PI_Memory_Flat_Mode_PM_WarmReboot_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryFlatModeWarmRebootL, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeWarmRebootL, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeWarmRebootL, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeWarmRebootL.main() else Framework.TEST_RESULT_FAIL)

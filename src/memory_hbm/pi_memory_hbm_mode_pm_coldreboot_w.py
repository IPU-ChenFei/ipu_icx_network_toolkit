...
class PiMemoryHBMModeColdRebootWindows(MemoryHbmCommon):
    """
    Pheonix ID:1601474406 - PI_Memory_HBM_Mode_PM_ColdReboot_W

    """

    TEST_CASE_ID = ["1601474406", "PI_Memory_HBM_Mode_PM_ColdReboot_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryHBMModeColdRebootWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryHBMModeColdRebootWindows, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryHBMModeColdRebootWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryHBMModeColdRebootWindows.main() else Framework.TEST_RESULT_FAIL)

...
class PIMemoryHBMModeMemtest(MemoryHbmCommon):
    """
    Phoenix ID:16014742545 - PI_Memory_HBM_Mode_Memtest_L
    """

    TEST_CASE_ID = ["16014742545", "PI_Memory_HBM_Mode_Memtest_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PIMemoryHBMModeMemtest object.
        ...
        super(PIMemoryHBMModeMemtest, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PIMemoryHBMModeMemtest, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PIMemoryHBMModeMemtest, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PIMemoryHBMModeMemtest.main() else Framework.TEST_RESULT_FAIL)

...
class PiHbmQuadIwvssWindows(MemoryHbmCommon):
    """
    pheonix id : 16014744355 - PI_Memory_HBM_Mode_Quad_Mode_Iwvss_W

    """

    TEST_CASE_ID = ["16014744355", "PI_Memory_HBM_Mode_Quad_Mode_Iwvss_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiHbmQuadIwvssWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiHbmQuadIwvssWindows, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(PiHbmQuadIwvssWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiHbmQuadIwvssWindows.main() else Framework.TEST_RESULT_FAIL)

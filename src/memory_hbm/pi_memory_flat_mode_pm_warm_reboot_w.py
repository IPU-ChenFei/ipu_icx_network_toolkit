...
class PiMemoryFlatModeWarmRebootWindows(MemoryHbmCommon):
    """
    Pheonix ID:16014743846 - PI_Memory_Flat_Mode_PM_WarmReboot_W

    """

    TEST_CASE_ID = ["16014743846", "PI_Memory_Flat_Mode_PM_WarmReboot_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryFlatModeWarmRebootL object.
        ...
        super(PiMemoryFlatModeWarmRebootWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeWarmRebootWindows, self).prepare()
    ...
    def execute(self):
        ...
        for cycle_number in range(1, self.NUMBER_OF_CYCLES + 1):
            ...
            self._warm_reboot_obj.warm_reset()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeWarmRebootWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeWarmRebootWindows.main() else Framework.TEST_RESULT_FAIL)

...
class PiMemoryCacheModeSncModeMLCLinux(MemoryHbmCommon):
    """
    Phoenix id : 16014741214 - PI_Memory_Cache_Mode_SNC_Mode_MLC_L
    """

    TEST_CASE_ID = ["16014741214", "PI_Memory_Cache_Mode_SNC_Mode_MLC_L"]
    ...
    step_data_dict = {1: {'step_details': 'To verify SUT has 1DPC or 2DPC memory configuration and '
                      ...
                      2: {'step_details': 'To Install MLC tool and Run MLC Tool for 1 hours',
                          'expected_results': 'MLC ran with out errors ...'}}

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiCacheSncCheckMLCLinux object.
        ...
        super(PiMemoryCacheModeSncModeMLCLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def cleanup(self, return_status):
        ...
        """DTAF cleanup"""
        self._stress_provider.kill_stress_tool(MLCToolConstants.MLC_TOOL_NAME, self.MLC_COMMAND)
        super(PiMemoryCacheModeSncModeMLCLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeSncModeMLCLinux.main() else Framework.TEST_RESULT_FAIL)

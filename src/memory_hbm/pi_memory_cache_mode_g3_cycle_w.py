...
class PiMemoryCacheModeG3CycleWindows(MemoryHbmCommon):
    """
    HP QC ID:H109182, Pheonix ID:16014741008 -PI_Memory_Cache_Mode_G3_Cycle_L

    """

    TEST_CASE_ID = ["16014743312", "PI_Memory_Cache_Mode_G3_Cycle_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryCacheModeG3CycleWindows object.
        ...
        super(PiMemoryCacheModeG3CycleWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeG3CycleWindows, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeG3CycleWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeG3CycleWindows.main() else Framework.TEST_RESULT_FAIL)

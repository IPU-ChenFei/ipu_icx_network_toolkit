...
class PiFlatModeQuadModeMemStreamLinux(MemoryHbmCommon):
    """
    Phoenix id : 16014741298 - PI_Memory_Flat_Mode_Quad_Mode_HBM_Stream_L
    """

    TEST_CASE_ID = ["16014741298", "PI_Memory_Flat_Mode_Quad_Mode_HBM_Stream_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiFlatModeQuadModeMemStreamLinux object.
        ...
        super(PiFlatModeQuadModeMemStreamLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiFlatModeQuadModeMemStreamLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(PiFlatModeQuadModeMemStreamLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiFlatModeQuadModeMemStreamLinux.main() else Framework.TEST_RESULT_FAIL)

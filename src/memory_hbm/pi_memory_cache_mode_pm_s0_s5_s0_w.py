...
class PiMemoryCacheModeS0S5S0Windows(MemoryHbmCommon):
    """
    Pheonix ID:16014743605 - PI_Memory_Cache_Mode_PM_S0_S5_S0_W

    """

    TEST_CASE_ID = ["16014743605", "PI_Memory_Cache_Mode_PM_S0_S5_S0_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryCacheModeS0S5S0Windows object.
        ...
        super(PiMemoryCacheModeS0S5S0Windows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeS0S5S0Windows, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeS0S5S0Windows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeS0S5S0Windows.main() else Framework.TEST_RESULT_FAIL)

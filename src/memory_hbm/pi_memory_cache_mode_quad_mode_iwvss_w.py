...
class PiCacheModeQuadModeIwvssWindows(MemoryHbmCommon):
    """
    Phoenix id : 16014744184 - PI_Memory_Cache_Mode_Quad_Mode_Iwvss_W
    """

    TEST_CASE_ID = ["16014744184", "PI_Memory_Cache_Mode_Quad_Mode_Iwvss_W"]
    ...
    step_data_dict = {1: {'step_details': 'To verify SUT has 1DPC or 2DPC memory configuration and '
                      ...
                      3: {'step_details': 'Install iwvss tool and Run iwvss Tool for 1hour',
                          'expected_results': 'iwvss ran with out errors ...'}}

    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiCacheModeQuadModeIwvssWindows object.
        ...
        super(PiCacheModeQuadModeIwvssWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiCacheModeQuadModeIwvssWindows, self).prepare()
    ...
    def execute(self):
        ...
        2. Install iwvss and run the iwvss tool for 2 Hours.
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiCacheModeQuadModeIwvssWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiCacheModeQuadModeIwvssWindows.main() else Framework.TEST_RESULT_FAIL)

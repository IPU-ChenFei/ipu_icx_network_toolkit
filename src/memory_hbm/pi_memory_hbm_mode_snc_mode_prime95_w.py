...
class PiMemoryHbmSncPrime95Windows(MemoryHbmCommon):
    """
    pheonix id : 16014744423 - 	PI_Memory_HBM_Mode_SNC_Mode_Prime95_W

    """

    TEST_CASE_ID = ["16014744423", "	PI_Memory_HBM_Mode_SNC_Mode_Prime95_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryHbmSncPrime95Windows, self).__init__(test_log, arguments, cfg_opts)
    ...
    def cleanup(self, return_status):
        ...
        super(PiMemoryHbmSncPrime95Windows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryHbmSncPrime95Windows.main() else Framework.TEST_RESULT_FAIL)

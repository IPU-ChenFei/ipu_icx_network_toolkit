...
class PiMemoryHBMModeWarmRebootWindows(MemoryHbmCommon):
    """
    Pheonix ID:16014744158 - PI_Memory_HBM_Mode_PM_WarmReboot_W

    """

    TEST_CASE_ID = ["16014744158", "PI_Memory_HBM_Mode_PM_WarmReboot_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryHBMModeWarmRebootWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryHBMModeWarmRebootWindows, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryHBMModeWarmRebootWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryHBMModeWarmRebootWindows.main() else Framework.TEST_RESULT_FAIL)

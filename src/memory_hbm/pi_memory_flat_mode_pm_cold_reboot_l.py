...
class PiMemoryFlatModeColdRebootL(MemoryHbmCommon):
    """
    HP QC ID:H109175, Pheonix ID:16014741506 - PI_Memory_Flat_Mode_PM_ColdReboot_L

    """

    TEST_CASE_ID = ["16014741506", "PI_Memory_Flat_Mode_PM_ColdReboot_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryFlatModeColdRebootL object.
        ...
        super(PiMemoryFlatModeColdRebootL, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeColdRebootL, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeColdRebootL, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeColdRebootL.main() else Framework.TEST_RESULT_FAIL)

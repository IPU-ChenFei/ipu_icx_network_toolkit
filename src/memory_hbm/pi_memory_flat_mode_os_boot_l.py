...
class PiMemoryFlatModeOSBootLinux(MemoryHbmCommon):
    """
    HP QC ID: H109169, Pheonix ID:16014741365 - PI_Memory_Flat_Mode_OS_Boot_L

    """

    TEST_CASE_ID = ["16014741365", "PI_Memory_Flat_Mode_OS_Boot_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryFlatModeOSBootLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeOSBootLinux, self).prepare()
    ...
    def execute(self):
        ...
        # To verify nodes
        self.verify_number_of_nodes(memory_mode=MemoryTopology.ONE_LM, cluster_mode=cluster_mode)
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeOSBootLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeOSBootLinux.main() else Framework.TEST_RESULT_FAIL)

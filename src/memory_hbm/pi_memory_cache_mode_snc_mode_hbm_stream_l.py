...
class PiCacheModeSNCModeMemStreamLinux(MemoryHbmCommon):
    """
    Phoenix id : 16014741226 - PI_Memory_Cache_Mode_SNC_Mode_HBM_Stream_L
    """

    TEST_CASE_ID = ["16014741226", "PI_Memory_Cache_Mode_SNC_Mode_HBM_Stream_L"]
    SNC4_EXPECTED_VALUE = "0xf"
    SNC4_BIOS_CONFIG_FILE = "two_lm_snc_mode_bios_knob.cfg"

    step_data_dict = {1: {'step_details': 'To verify SUT has 1DPC or 2DPC memory configuration and '
                                          'To Load default bios settings and snc mode bios knobs',
                          'expected_results': 'SUT has 1DPC or 2DPC memory configuration and '
                                              'Default Bios and snc mode bios setting done.'},
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiCacheModesncModeMemStreamLinux object.
        ...
        super(PiCacheModeSNCModeMemStreamLinux, self).__init__(test_log, arguments, cfg_opts)
    ...
    def prepare(self):
        ...
        super(PiCacheModeSNCModeMemStreamLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(PiCacheModeSNCModeMemStreamLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiCacheModeSNCModeMemStreamLinux.main() else Framework.TEST_RESULT_FAIL)

...
class PiCacheModeQuadModeMemStreamLinux(MemoryHbmCommon):
    """
    Phoenix id : 16014741187 - PI_Memory_Cache_Mode_Quad_Mode_HBM_Stream_L
    """

    TEST_CASE_ID = ["16014741187", "PI_Memory_Cache_Mode_Quad_Mode_HBM_Stream_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiCacheModeQuadModeMemStreamLinux object.
        ...
        super(PiCacheModeQuadModeMemStreamLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiCacheModeQuadModeMemStreamLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        super(PiCacheModeQuadModeMemStreamLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiCacheModeQuadModeMemStreamLinux.main() else Framework.TEST_RESULT_FAIL)

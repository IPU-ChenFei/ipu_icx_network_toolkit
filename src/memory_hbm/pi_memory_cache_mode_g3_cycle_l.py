...
class PiMemoryCacheModeG3CycleLinux(MemoryHbmCommon):
    """
    HP QC ID:H109182, Pheonix ID:16014741008 -PI_Memory_Cache_Mode_G3_Cycle_L

    """

    TEST_CASE_ID = ["16014741001", "PI_Memory_Cache_Mode_G3_Cycle_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryCacheModeG3CycleLinux object.
        ...
        super(PiMemoryCacheModeG3CycleLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeG3CycleLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeG3CycleLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeG3CycleLinux.main() else Framework.TEST_RESULT_FAIL)

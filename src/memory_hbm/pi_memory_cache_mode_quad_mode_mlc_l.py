...
class PiMemoryCacheQuadMlcLinux(MemoryHbmCommon):
    """
    PI_Memory_Cache_Mode_Quad_Mode_MLC_L and pheonix id : 16014741172

    """

    TEST_CASE_ID = ["16014741172", "PI_Memory_Cache_Mode_Quad_Mode_MLC_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryCacheQuadMlcLinux object.
        ...
        super(PiMemoryCacheQuadMlcLinux, self).__init__(test_log, arguments, cfg_opts, bios_config_file)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheQuadMlcLinux, self).prepare()
    ...
    def cleanup(self, return_status):
        ...
        """DTAF cleanup"""
        self._stress_provider.kill_stress_tool(MLCToolConstants.MLC_TOOL_NAME, self.MLC_COMMAND)
        super(PiMemoryCacheQuadMlcLinux, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheQuadMlcLinux.main() else Framework.TEST_RESULT_FAIL)

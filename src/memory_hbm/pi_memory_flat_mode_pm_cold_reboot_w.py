...
class PiMemoryFlatModeColdRebootWindows(MemoryHbmCommon):
    """
    Phoenix ID:16014743846 - PI_Memory_Flat_Mode_PM_ColdReboot_W

    """

    TEST_CASE_ID = ["16014743846", "PI_Memory_Flat_Mode_PM_ColdReboot_W"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryFlatModeColdRebootWindows object.
        ...
        super(PiMemoryFlatModeColdRebootWindows, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryFlatModeColdRebootWindows, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryFlatModeColdRebootWindows, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryFlatModeColdRebootWindows.main() else Framework.TEST_RESULT_FAIL)

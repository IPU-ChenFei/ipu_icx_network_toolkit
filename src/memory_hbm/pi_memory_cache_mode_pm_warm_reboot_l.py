...
class PiMemoryCacheModeWarmRebootL(MemoryHbmCommon):
    """
    HP QC ID:H109177, Pheonix ID:16014741153 - PI_Memory_Cache_Mode_PM_WarmReboot_L

    """

    TEST_CASE_ID = ["16014741153", "PI_Memory_Cache_Mode_PM_WarmReboot_L"]
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        ...
        super(PiMemoryCacheModeWarmRebootL, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeWarmRebootL, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeWarmRebootL, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeWarmRebootL.main() else Framework.TEST_RESULT_FAIL)

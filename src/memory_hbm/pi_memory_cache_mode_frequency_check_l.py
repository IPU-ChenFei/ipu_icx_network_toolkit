...
class PiMemoryCacheModeDdrFrequencyCheck(MemoryHbmCommon):
    """
    HP QC ID:H109184, Pheonix ID:16014741001 -PI_Memory_Cache_Mode_Frequency_Check_L

    Description: To change the memory frequency knob value, and check whether the change works both in BIOS and
    OS level.
    """

    TEST_CASE_ID = ["16014741001", "PI_Memory_Cache_Mode_Frequency_Check_L"]
    REG_EX = r'0x[0-9A-F]+'
    ...
    def __init__(self, test_log, arguments, cfg_opts):
        """
        Create a new PiMemoryCacheModeDdrFrequencyCheck object.
        ...
        super(PiMemoryCacheModeDdrFrequencyCheck, self).__init__(test_log, arguments, cfg_opts, bios_config_file_path)
    ...
    def prepare(self):
        ...
        super(PiMemoryCacheModeDdrFrequencyCheck, self).prepare()
    ...
    def cleanup(self, return_status):
        # type: (bool) -> None
        """DTAF cleanup"""
        super(PiMemoryCacheModeDdrFrequencyCheck, self).cleanup(return_status)


if __name__ == "__main__":
    sys.exit(Framework.TEST_RESULT_PASS if PiMemoryCacheModeDdrFrequencyCheck.main() else Framework.TEST_RESULT_FAIL)

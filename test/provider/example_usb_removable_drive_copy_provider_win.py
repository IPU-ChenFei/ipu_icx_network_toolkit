...
class TestUsbRemovableDriveCopyProvider(BaseTestCase):
    ...
    def execute(self):  # type: () -> bool
        ...
        zip_file_path = self._common_content_lib.copy_zip_file_to_sut(self.HELLO_TXT_FILE.split(".")[0],
                                                                      self.HELLO_TXT_FILE)
        ...
        host_file_path = self._common_content_lib.copy_log_files_to_host("Test_folder", str(sut_file_path), ".txt")

...
DLB_DRIVER_H = os.path.join(Accelerator_LOCAL_TOOL_PATH, 'release_ver_7.7.0_v3.zip')
...
KERNEL_INTERNAL_H = os.path.join(Accelerator_LOCAL_TOOL_PATH, 'kernel-spr-bkc-pc-modules-internal-8.8-5.el8.x86_64.rpm')
...
DLB_DRIVER_V_H = os.path.join(Accelerator_LOCAL_TOOL_PATH, 'dlb-0.9.4.56.zip')
...
DLB_DRIVER_NAME = 'release_ver_7.7.0_v3.zip'
...
KERNEL_INTERNAL_NAME = "kernel-spr-bkc-pc-modules-internal-8.8-5.el8.x86_64.rpm"
